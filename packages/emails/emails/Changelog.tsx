...
export function Changelog({
  ...
  changelogUrl = "https://unkey.dev/changelog",
}: Props) {
  return (
    <Tailwind>
        ...
        <Body className="bg-white">
          <Container className="container mx-auto">
            ...
            <Section>
              <ul>
                {changelog?.item?.map((change) => (
                  <li className="my-4" key={change.id}>
            ...
            <Section className="my-4 text-center">
              <Button
                className="px-8 py-4 font-medium text-white bg-gray-900 rounded"
                href={changelogUrl}
              >
                View Changelog
              </Button>
            ...
            <Text>
              If you have any questions, feedback or suggestions, please don't hesitate to reply to
              this email, I would love to hear from you.
            </Text>
            <Section className="mt-2 text-gray-400">
              <Section className="mt-4">
                <Img src="https://unkey.dev/unkey.png" width="32" height="32" alt="Unkey Logo" />
              </Section>
              ...
              <Section className="flex flex-row justify-center mt-8">
                ...
                <Link rel="noreferrer" href="https://discord.gg/qzTNdg3EVs" target="_blank">
                  <svg
