...
// @generated from file pkg/proto/key/v1/service.proto (package v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class CreateKeyRequest extends Message<CreateKeyRequest> {
  ...
  /**
   * @generated from field: optional int32 byte_length = 4;
   */
  byteLength?: number;

  /**
   * @generated from field: optional string owner_id = 5;
   */
  ownerId?: string;

  /**
   * @generated from field: optional google.protobuf.Struct meta = 6;
   */
  meta?: Struct;
   ...
   *
   * @generated from field: optional int64 expires = 7;
   */
  expires?: bigint;

  /**
   * @generated from field: optional int64 remaining = 8;
   */
  remaining?: bigint;

  /**
   * @generated from field: optional v1.Ratelimit ratelimit = 9;
   */
  ratelimit?: Ratelimit;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "byte_length", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
    { no: 5, name: "owner_id", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 6, name: "meta", kind: "message", T: Struct, opt: true },
    { no: 7, name: "expires", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 8, name: "remaining", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 9, name: "ratelimit", kind: "message", T: Ratelimit, opt: true },
  ]);
...
/**
 * @generated from message v1.UpdateKeyRequest
 */
export class UpdateKeyRequest extends Message<UpdateKeyRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.UpdateKeyRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message v1.UpdateKeyResponse
 */
export class UpdateKeyResponse extends Message<UpdateKeyResponse> {
  constructor(data?: PartialMessage<UpdateKeyResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.UpdateKeyResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UpdateKeyResponse {
    return new UpdateKeyResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UpdateKeyResponse {
    return new UpdateKeyResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UpdateKeyResponse {
    return new UpdateKeyResponse().fromJsonString(jsonString, options);
  }

  static equals(a: UpdateKeyResponse | PlainMessage<UpdateKeyResponse> | undefined, b: UpdateKeyResponse | PlainMessage<UpdateKeyResponse> | undefined): boolean {
    return proto3.util.equals(UpdateKeyResponse, a, b);
  }
}
