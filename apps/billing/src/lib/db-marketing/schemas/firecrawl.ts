import { mysqlTable, int, text, varchar, timestamp, unique, boolean, index } from 'drizzle-orm/mysql-core';
import { serperOrganicResults } from './serper';
import { relations } from 'drizzle-orm';

export const firecrawlResponses = mysqlTable('firecrawl_responses', {
