...
const FeatureGrid = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(() => (
  <div className="grid grid-rows gap-4 rounded-3xl border-[0.75px] border-[rgba(255,255,255,0.15)] p-10 lg:w-[1192px] md:mx-4">
    <div className="grid md:grid-cols-3 p-[16px,0px,0px,0px] m-0">
      <Feature>
        <FeatureHeader>
        ...
        <FeatureContent>
          Seamlessly scale and distribute your services with multi-cloud support, allowing you to
          use unkey with any cloud provider effortlessly.
        </FeatureContent>
      </Feature>
      <Feature>
        <FeatureHeader>
        ...
        <FeatureContent>
          Align data storage with compliance goals, customize retention for regulatory requirements,
          and effortlessly maintain data integrity.
        </FeatureContent>
      </Feature>
      <Feature>
        <FeatureHeader>
        ...
        <FeatureContent>
          Enjoy flexibility and control with both API and user-friendly UI access, ensuring a smooth
    ...
    <div className="grid md:grid-cols-3 space-x-2">
      <Feature>
        ...
        <FeatureContent>
          Fine-tune access privileges with role-based control per key, enabling precise management
          and ensuring security at every level.
        </FeatureContent>
      </Feature>
      <Feature>
        <FeatureHeader>
        ...
        <FeatureContent>
          ...
          access keys, providing swift response to potential threats.
        </FeatureContent>
      </Feature>
      <Feature>
        <FeatureHeader>
        ...
        <FeatureContent>
          Accelerate development with Software Development Kits (SDKs), providing tools for seamless
