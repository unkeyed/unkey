...
function FrameworkSwitcher({
  ...
  return (
    <div className="flex flex-col justify-between sm:w-[216px] text-white text-sm pt-6 px-4 font-mono md:border-r md:border-white/10">
      ...
      <GithubLink className="hidden sm:flex" label="View on Github" />
    </div>
  );
}

const GithubLink = ({ className, label }: { className?: string; label: string }) => {
  return (
    <div className={className}>
      <Link href="https://github.com/unkeyed/unkey">
        <div className="flex items-center py-4 pl-2">
          ...
          {label && (
            <p className="ml-2 text-sm transition-all text-white/20 hover:text-white">{label}</p>
          )}
        </div>
      </Link>
    </div>
...
const HighlightAbove: React.FC<{ className: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      d="M1054.5 210V642H1055.5V210H1054.5ZM31.5 642V210H30.5V642H31.5Z"
      fill="url(#paint1_linear_830_9506)"
      mask="url(#path-1-inside-1_830_9506)"
    />
    <mask id="path-3-inside-2_830_9506" fill="white">
      <path d="M0 0H1086V432H0V0Z" />
    </mask>
    <path
      d="M1085.5 0V432H1086.5V0H1085.5ZM0.5 432V0H-0.5V432H0.5Z"
      fill="url(#paint2_linear_830_9506)"
      mask="url(#path-3-inside-2_830_9506)"
    />
    <mask id="path-5-inside-3_830_9506" fill="white">
      <path d="M15 100H1071V532H15V100Z" />
    </mask>
    <path
      d="M1070.5 100V532H1071.5V100H1070.5ZM15.5 532V100H14.5V532H15.5Z"
      fill="url(#paint3_linear_830_9506)"
      mask="url(#path-5-inside-3_830_9506)"
    />
    <defs>
      <radialGradient
