...
export const Hero: React.FC = () => {
  return (
    <div className="flex min-h-[100vh] items-center justify-between container mx-auto">
      <div>
      ...
      <div className="rounded-[38px] bg-white/5 border border-gray-800 z-10 relative">
