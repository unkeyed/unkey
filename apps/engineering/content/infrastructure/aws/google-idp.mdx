...
<Steps>
    ...
    ![Image](./gw-custom-attributes.png)
    </Step>
...
<Steps>
    <Step>Navigate to [IAM Identity Center settings](https://us-east-1.console.aws.amazon.com/singlesignon/home?region=us-east-1#!/instances/72236d640511c7aa/settings)</Step>
...
Navigate to the start URL and sign in with Google Workspace, and you will be presented with a list of accounts and the roles you may assume. Celebrate your success!
