...
The Empty component is composed of several sub-components that work together:
...
- **Clear Context**: Use descriptive titles and explanations
- **Actionable Content**: Provide clear next steps in the actions area
- **Consistent Usage**: Use the same empty state pattern across your application
- **Filter Context**: When showing empty states due to filters, provide options to clear filters
- **Helpful Actions**: Include relevant actions that help users resolve the empty state
- **Visual Hierarchy**: Use the title for emphasis and description for explanation
