...
- **Contextual Usage**: Use appropriate sizes for different contexts
- **Duration Selection**: Choose animation duration that feels responsive
- **Variant Selection**: Use spinner for general loading, dots for text contexts
- **Consistent Placement**: Position loading indicators consistently across your app
- **Accessibility**: Ensure loading states are announced to screen readers
- **Performance**: Consider using loading states for operations longer than 200ms 