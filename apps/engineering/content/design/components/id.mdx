...
export default function MyComponent() {
  return (
    <div>
      ...
      <ID value="user_987654321" truncate={true} />
...
- **Consistent Formatting**: Use the same ID component pattern across your application
- **Truncation Usage**: Use truncation for long IDs that don't need full display
- **Width Selection**: Choose appropriate widths for different contexts
- **Accessibility**: Ensure ID values are announced clearly to screen readers
- **Performance**: Consider truncation for very long ID values
- **Security**: Be mindful of displaying sensitive ID values
