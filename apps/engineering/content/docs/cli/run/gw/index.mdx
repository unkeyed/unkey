...
MySQL connection string for primary database. Required. Example: user:pass@host:3306/unkey?parseTime=true
...
MySQL connection string for read-replica. Format same as database-primary.
