...
Krane pulls desired state from ctrl and ensures the actual cluster state matches. It handles deployment and gateway lifecycle operations (create, update, delete) by translating high-level events into Kubernetes resources.
