...
<Property name="--database-primary | UNKEY_DATABASE_PRIMARY" type="string" required={true}>
  ...
  **Examples:**
  ...
  - `--database-primary=username:pscale_pw_...@aws.connect.psdb.cloud/unkey?sslmode=require` - PlanetScale connection
</Property>
...
<Property name="--database-replica | UNKEY_DATABASE_REPLICA" type="string" required={false}>
  ...
  **Examples:**
  ...
  - `--database-replica=username:pscale_pw_...@aws.connect.psdb.cloud/unkey?sslmode=require` - PlanetScale connection
</Property>
