...
export const WorkspaceSwitcherTanStack: React.FC<Props> = (props): JSX.Element => {
  ...
  const { data: memberships, isLoading: isUserMembershipsLoading } = useUserWorkspaces({
  ...
  return (
    <DropdownMenu>
      ...
      >
        <DropdownMenuLabel>
          Workspaces
          <span className="ml-2 text-xs text-content-subtle font-normal">(TanStack DB)</span>
        </DropdownMenuLabel>
        <DropdownMenuGroup>
