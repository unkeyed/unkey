...
export const HelpButton: React.FC = () => {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger className="w-8 h-8 rounded-lg flex justify-center items-center hover:bg-grayA-4">
        <CircleQuestion className="text-gray-9 hover:text-gray-12 size-5" />
      </DropdownMenuTrigger>
