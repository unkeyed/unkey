...
export const QueriesOverflow = ({ list }: QueriesOverflowProps) => {
  return list?.length ? (
    <Tooltip>
      ...
      <TooltipContent
        className="flex h-full bg-white text-gray-12 ßrounded-lg font-500 text-[12px] justify-center items-center leading-6 shadow-[0_12px_32px_-16px_rgba(0,0,0,0.3),0_12px_60px_1px_rgba(0,0,0,0.15),0_0px_0px_1px_rgba(0,0,0,0.1)]"
        side="bottom"
      >
