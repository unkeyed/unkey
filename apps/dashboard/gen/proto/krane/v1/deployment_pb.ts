...
export type DeploymentRequest = Message<"krane.v1.DeploymentRequest"> & {
   ...
   *
   * @generated from field: bytes encrypted_environment_variables = 8;
   */
