...
export function createRatelimitOverridesCollection() {
  const collection = createCollection<RatelimitOverride>(
  ...
  collection.createIndex((row) => [row.namespaceId, row.identifier], {
