import { rolesQueryPayload } from "@/app/(app)/[workspaceId]/authorization/roles/components/table/query-logs.schema";
import type { RolesFilterOperator } from "@/app/(app)/[workspaceId]/authorization/roles/filters.schema";
