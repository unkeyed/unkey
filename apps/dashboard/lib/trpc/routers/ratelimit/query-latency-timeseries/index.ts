import { ratelimitOverviewQueryTimeseriesPayload } from "@/app/(app)/[workspaceId]/ratelimits/[namespaceId]/_overview/components/charts/bar-chart/query-timeseries.schema";
