...
export const PermissionToggle: React.FC<PermissionToggleProps> = ({
  ...
  return (
    <div className="flex flex-row items-center justify-evenly gap-4 transition-all pl-3 h-full mb-1 ml-2 pb-1 w-full hover:bg-grayA-3 rounded-lg">
      <Checkbox
        size="lg"
        checked={checked}
      ...
      />
      <div className="flex flex-col text-left min-w-48 w-full mr-2 gap-1">
        ...
        <InfoTooltip content={description} className="w-full text-left">
          <p className="text-xs text-gray-10 text-left max-w-[245px] truncate mr-2">
            {description}
          </p>
        </InfoTooltip>
      </div>
