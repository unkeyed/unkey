...
export default async function ApiPageLayout(props: Props) {
  ...
  const navigation = [
    {
      label: "Overview",
      href: `/keys/${props.params.keyAuthId}/${props.params.keyId}`,
      segment: null,
    },
    {
      label: "Settings",
      href: `/keys/${props.params.keyAuthId}/${props.params.keyId}/settings`,
      segment: "settings",
    },
    {
      label: "Permissions",
      href: `/keys/${props.params.keyAuthId}/${props.params.keyId}/permissions`,
      segment: "permissions",
    },
    { label: "API", href: `/apis/${api.id}`, segment: api.id },
  ];
