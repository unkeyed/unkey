...
export const ProjectDetails = ({ projectId }: ProjectDetailsProps) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="absolute top-14 left-4 rounded-xl bg-gray-1 border border-grayA-4 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.1)] overflow-y-auto  pb-4  pointer-events-auto min-w-[360px]">
