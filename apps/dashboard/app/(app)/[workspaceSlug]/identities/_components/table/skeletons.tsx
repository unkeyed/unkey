...
export const ExternalIdColumnSkeleton = () => (
  <div className="h-2 w-32 bg-grayA-3 rounded animate-pulse" />
);

export const CountColumnSkeleton = () => (
  <div className="h-2 w-8 bg-grayA-3 rounded animate-pulse" />
);

export const CreatedColumnSkeleton = () => (
  <div className="h-2 w-24 bg-grayA-3 rounded animate-pulse" />
);
