...
export default function ApisOverviewPage({params}: {params: {workspace: string}}) {
        ...
        <div>
            <Navbar>
                <Navbar.Breadcrumbs icon={<Nodes />}>
                    <Navbar.Breadcrumbs.Link href={`/${params.workspace}/apis`} active>
                        APIs
            ...
            <ApiListClient workspace={params.workspace} />
        </div>
    );
}
