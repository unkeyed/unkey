...
export const STATUS_DEFINITIONS: Record<StatusType, StatusInfo> = {
  "low-credits": {
    ...
    icon: <CircleCaretRight size="sm-regular" />,
  ...
  "rate-limited": {
    ...
    label: "Ratelimited",
    color: "bg-errorA-3 text-errorA-11",
    icon: <TriangleWarning2 size="sm-regular" />,
    tooltip:
  ...
  "expires-soon": {
    ...
    icon: <CircleHalfDottedClock size="sm-regular" className="text-orange-11" />,
    tooltip:
  ...
  "validation-issues": {
    ...
    icon: <ShieldKey size="sm-regular" className="text-warning-11" />,
