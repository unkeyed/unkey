  ...
  const columns = (): Column<KeysOverviewLog>[] => {
    return [
            ...
            <div className="flex items-center font-mono">
              <div
                className={cn(
                  ...
                  isCreditSpendMode ? "max-w-[200px]" : "max-w-[150px]",
                )}
                title={name}
              >
                {name}
      ...
      ...(isCreditSpendMode
        ? [
            {
              key: "spent_credits" as keyof KeysOverviewLog,
              header: "Credits Spent",
              width: "18%",
              sort: {
                direction: getSortDirection("spent_credits"),
                sortable: true,
                onSort() {
                  toggleSort("spent_credits", false);
                },
              },
              render: (log: KeysOverviewLog) => (
                <div className="flex items-center font-mono">
      ...
      emptyState={
        <div className="w-full flex justify-center items-center h-full">
          <Empty className="w-[400px] flex items-start">
            ...
            <Empty.Title>
              {isCreditSpendMode ? "Credit Spend Logs" : "Key Verification Logs"}
            </Empty.Title>
            <Empty.Description className="text-left">
              {isCreditSpendMode
                ? "No credit spend data to show. Once API keys with credit tracking are used, you'll see a summary of credit consumption."
                : "No key verification data to show. Once requests are made with API keys, you'll see a summary of successful and failed verification attempts."}
            </Empty.Description>{" "}
