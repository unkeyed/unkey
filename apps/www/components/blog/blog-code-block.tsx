...
import { type ReactElement, useState, type ClassAttributes,type HTMLAttributes } from "react";
...
export function BlogCodeBlock({ className, children }:  JSX.IntrinsicAttributes & ClassAttributes<HTMLElement> & HTMLAttributes<HTMLElement>) {
