  ...
  try {
    ...
    if (!template) {
      return new ImageResponse(
        <img src="https://unkey.com/images/landing/og.png" alt="Unkey" />,
        {
          width: 1280,
          height: 720,
        }
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              <p>
                {template.authors ? `by ${template?.authors.join(", ")}` : null}
              </p>
            </div>
    ...
    console.error(
      `Error generating image using fallback for blog route ${params.slug}`,
      e
    );
    return new ImageResponse(
      <img src="https://unkey.com/images/landing/og.png" alt="Unkey" />,
