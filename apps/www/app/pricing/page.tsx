          ...
          <PricingCardFooter>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-white/60">
                ...
                providng access to your service. Requests may be invalid due to exceeding limits,
        ...
        <PricingCard color={Color.Yellow} className="col-span-2 md:col-span-1">
          ...
          <PricingCardFooter>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-white/60">
                We want you to succeed, and not be afraid of surprise charges. If you go over the
                limits of your plan, we won't shut you down, nor will we charge you extra. If your
                usage is consistently exceeding the limits, you should upgrade to the next higher
                plan.
              </p>
            </div>
          </PricingCardFooter>
