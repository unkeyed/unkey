...
allowing you to ratelimit based on different metrics. The most common way of limiting is setting a limit on how many requests they may do in a certain timeframe, but you can also limit based on requested tokens for LLMs, or
