...
*The most request feature for Unkey has finally arrived.*

Until now we only stored a one way hash of the key, enough to verify it, but nobody was able to show the original key again. Recovering, that means showing the key after it was created, was not possible.
