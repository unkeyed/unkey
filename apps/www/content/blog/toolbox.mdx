...
Getting started with the Unkey Toolbox is easy! Just use `npx create-open-api` from your terminal and following the CLI prompts. Once you run the CLI you’ll have a fully functioning API with a variety of endpoints and documentation.
