...
As you can see we really simplified the code and remove additional looks ups via databases, allowing your API to be performant and scalable. You can get started for free today! 