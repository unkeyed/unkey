...
var file_proto_vault_v1_service_proto_rawDesc = []byte{
	...
	0x70, 0x70, 0x73, 0x2f, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x72,
...
func file_proto_vault_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_vault_v1_service_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_vault_v1_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_vault_v1_service_proto_msgTypes[10].OneofWrappers = []interface{}{}
	type x struct{}
