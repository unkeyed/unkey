...
Let's dive straight in. The minimal setup looks like this. All you need is your api id. Go to [/app/api](https://unkey.dev/app/apis), select your API and copy the id.
