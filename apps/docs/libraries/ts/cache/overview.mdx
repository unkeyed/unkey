...
import { CloudflareStore, MemoryStore } from "@unkey/cahce/stores";
...
```
  ...
  <ParamField path="domain" type="string">
   ...
   <ParamField path="cacheBuster" type="string">
    The version of the cache store determines which version to use. If changes occur on your cached data, incrementing this value ensures the old cached structure is not utilized. This field is optional and defaults to 'v1' if not specified.
