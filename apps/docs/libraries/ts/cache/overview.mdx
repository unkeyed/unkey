...
```
  ...
  <ParamField path="domain" type="string">
   ...
   <ParamField path="cacheBuster" type="string">
    The version of the cache store schema. If changes occur on your cache schema, incrementing this value ensures the old cached schema is not utilized. This field is optional and defaults to 'v1' if not specified.
  </ParamField>
