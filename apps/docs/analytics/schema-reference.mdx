...
|-------|----------------|-------------|
| `key_verifications_v1` | `default.key_verifications_raw_v2` | Raw verification events |
| `key_verifications_per_minute_v1` | `default.key_verifications_per_minute_v2` | Aggregated by minute |
| `key_verifications_per_hour_v1` | `default.key_verifications_per_hour_v2` | Aggregated by hour |
| `key_verifications_per_day_v1` | `default.key_verifications_per_day_v2` | Aggregated by day |
| `key_verifications_per_month_v1` | `default.key_verifications_per_month_v2` | Aggregated by month |
...
`key_verifications_per_hour_v1` - Aggregated by hour

Same columns as per-minute table, with `hour` instead of `minute`.

### Per Day Table

`key_verifications_per_day_v1` - Aggregated by day

Same columns as per-minute table, with `day` instead of `minute`.

### Per Month Table

`key_verifications_per_month_v1` - Aggregated by month
