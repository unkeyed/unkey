...
- **`api_id`** - Your Unkey API IDs (e.g., `api_1234`) that we provide to you
...
- `default.key_verifications_raw_v2` (alias: `key_verifications`)
- `default.key_verifications_per_minute_v2` (alias: `key_verifications_per_minute`)
- `default.key_verifications_per_hour_v2` (alias: `key_verifications_per_hour`)
- `default.key_verifications_per_day_v2` (alias: `key_verifications_per_day`)
- `default.key_verifications_per_month_v2` (alias: `key_verifications_per_month`)
...
4. **Use your own IDs** - Filter with `api_id` and `external_id` for cleaner queries
