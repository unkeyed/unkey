...
The first step to using Unkey is to create an account. You can do this by visiting [unkey.dev](https://app.unkey.com) or by clicking the Dashboard button in the top right of your screen.
