...
Unkey v2 represents a major infrastructure upgrade from Cloudflare Workers to AWS servers with enhanced caching and cache invalidation systems. While the core functionality remains the same, there are important changes to request and response structures that require updates to your integration.
...
The v2 SDK automatically points to the new AWS infrastructure and guides you through all request/response changes via its types.

## Why Migrate to v2?

### Proven Performance Improvements

Our infrastructure upgrade to AWS servers has delivered measurable latency improvements across all regions:
