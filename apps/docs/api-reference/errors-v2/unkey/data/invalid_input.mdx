---
title: "err:unkey:data:invalid_input"
...
```json Example
{
  ...
  "error": {
    ...
    "status": 400,
    "title": "Bad Request",
    "type": "https://unkey.com/docs/api-reference/errors-v2/unkey/data/invalid_input",
    "errors": [
      {
        "location": "body.limit",
...
## Related Errors
- [err:unkey:data:assertion_failed](./assertion_failed) - When a runtime assertion or invariant check fails
- [err:unkey:data:protected_resource](./protected_resource) - When attempting to modify a protected resource
