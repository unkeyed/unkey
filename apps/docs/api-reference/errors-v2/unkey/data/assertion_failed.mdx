---
title: "err:unkey:data:assertion_failed"
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/api-reference/errors-v2/unkey/data/assertion_failed"
  }
}
```
...
## Related Errors
- [err:unkey:data:unexpected_error](./unexpected_error) - A more general internal error
- [err:unkey:data:service_unavailable](./service_unavailable) - When a service is temporarily unavailable
