...
<Info>
We're currently only offering a Typescript SDK but you can check out the [api reference](/api-reference/v2/ratelimit/apply-rate-limiting) and do the network call manually if you are using another language.
