...
<Note>
  It's a good practice to provide as few permissions as possible, to 
</Note>
...
Go to [https://unkey.dev/app/settings/root-keys/new](https://unkey.dev/app/settings/root-keys/new) 
