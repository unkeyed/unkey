...
Select "Settings" from the sidebar and click the "Create New Key" button.
...
The rest of the options are optional however we'd advise filing in the Owner field, this is an id of your tenant or user in your system. This allows you to both identify the owner of the API Key, and also to validate the API Key when it is used.
