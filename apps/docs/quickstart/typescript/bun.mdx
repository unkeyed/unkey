...
<Steps>
<Step titleSize="h2" title="Install">
...
<Step titleSize="h2" title="Creating the server">
...
<Step titleSize="h2" title="Running the server">
...
<Step titleSize="h2" title="Try it out">
