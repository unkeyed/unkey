...
You should get to know our [API reference](/api-reference/v2/ratelimit/apply-rate-limiting), as you can add additonal fields to your request when ratelimiting endpoints.
