...
1. Go to [/app/authorization/roles](https://unkey.dev/app/authorization/roles)
...
1. Go to [/app/authorization/permissions](https://unkey.dev/app/authorization/permissions)
...
1. Go to [/app/authorization/permisions](https://unkey.dev/app/authorization/permisions)
