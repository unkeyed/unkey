...
<Tip>
 Identities are in in private beta, please contact [support](mailto:support@unkey.dev) to get access.
</Tip>
...
Let's say you are building an app that uses a under the hood and you want to limit your customers to 500 requests per hour, but also ensure that they don't blow up your bill by using too many tokens.
