...
SELECT * FROM key_verifications_v1_v1 WHERE api_id = 'api_123
```
...
<Note>
For more examples and available columns, check out our [Analytics Schema Documentation](https://unkey.com/docs/analytics/schema).
</Note>
