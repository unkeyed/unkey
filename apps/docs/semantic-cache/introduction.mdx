...
<Steps>
  ...
  <Step title="Set the baseURL of your OpenAI constructor to us the gateway">The code snippet will have been copied to your clipboard. Paste this into wherever you're calling OpenAI.</Step>
  <Step title="Test it out">Make a request to your new gateway. You will see new logs arrive at the [logs page](https://app.unkey.com/semantic-cache/logs). After the first new request, subsequent requests will be cached.</Step>
  <Step title="Monitor your savings">Visit the [analytics tab](https://app.unkey.com/semantic-cache/analytics) to monitor cache hits and misses and see your time and cost savings over time.</Step>
</Steps>
