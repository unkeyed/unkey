...
import (
	...
	handler "github.com/unkeyed/unkey/apps/api/routes/v2_ratelimit_multi_limit"
...
func TestWorkspacePermissions(t *testing.T) {
	...
	// This should return a 403 Forbidden - user is from different workspace and has no permissions
