...
export function withCache<TKey extends string, TValue>(c: Context, cache: Cache<TKey, TValue>, loadFromDatabase: (identifier: TKey) => Promise<TValue>): (identifier: TKey) => Promise<TValue> {
