...
import (
	...
	v1 "github.com/unkeyed/unkey/apps/agent/gen/proto/keys/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	KeysServiceName = "proto.keys.v1.KeysService"
)

// KeysServiceClient is a client for the proto.keys.v1.KeysService service.
...
func NewKeysServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) KeysServiceClient {
	...
	return &keysServiceClient{
		createKey: connect_go.NewClient[v1.CreateKeyRequest, v1.CreateKeyResponse](
			httpClient,
			baseURL+"/proto.keys.v1.KeysService/CreateKey",
			opts...,
		),
...
// SoftDeleteKey calls proto.keys.v1.KeysService.SoftDeleteKey.
...
func NewKeysServiceHandler(svc KeysServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/proto.keys.v1.KeysService/CreateKey", connect_go.NewUnaryHandler(
		"/proto.keys.v1.KeysService/CreateKey",
		svc.CreateKey,
		opts...,
	))
	mux.Handle("/proto.keys.v1.KeysService/SoftDeleteKey", connect_go.NewUnaryHandler(
		"/proto.keys.v1.KeysService/SoftDeleteKey",
		svc.SoftDeleteKey,
		opts...,
	))
...
func (UnimplementedKeysServiceHandler) CreateKey(context.Context, *connect_go.Request[v1.CreateKeyRequest]) (*connect_go.Response[v1.CreateKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("proto.keys.v1.KeysService.CreateKey is not implemented"))
}
