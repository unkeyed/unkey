...
<div classa="flex justify-center align-center">
...
To get started check out our [documentation](https://unkey.dev/integrations/vercel) that gives you a step by step guide to integrate or the video posted above. 
