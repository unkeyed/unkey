...
Our ratelimiting offering offers additional options to provide more advanced configurations, including cost, async requests, and resource audit logging. We also provide configurable overrides in the dashboard so specific resources with an identifier can have limits without adding additional code.
...
If you are ready to start with our ratelimiter built for the modern web, check out our documentation. If you want to see how we implemented this, check out our GitHub repository!
