...
1. Create an [Supabase account](https://supabase.com)
2. Create an [Unkey account](https://unkey.dev) and follow our [Quickstart guide](https://docs.unkey.dev/quickstart). So you have a API key to verify. 
...
In this post, we have covered how to use Unkey with Supabase functions to secure them. You can check out the code for this project here: https://github.com/unkeyed/unkey/tree/main/examples/supabase-functions