...
description: Traditonal marketing is dead, so lets talk about how to market and using product lead growth.
author: {
    name: 'James Perkins',
    role: 'Co-Founder / CEO',
    image: { src: '/james.jpg' },
...
If your devtool is "API Authentication", please don't make a "Getting Started with API Authentication video". Your docs already cover this. Make videos that focus on aspects of integrating your product somewhere, "How to secure Supabbase functions using X" is something some will search for. 
...
Is it still called tweeting? Xing? Either way, Social Media can bring in a large amount of traffic if used correctly. To put it in perspective, our launch of Unkey was a single tweet on my account. This brought over 700 users in the first week.

![Example launch tweet](/images/blog-images/how-to-market/tweet-example.png)
...
Finally, once your business account grows a following of around 1,000 people, you can start posting updates of the product... But don't stop meeting and quote posting/retweeting. 
...
- Colby Fayocks site launch giveaways
...
Product lead growth is super significant, and I like to do the following three things:
...
![Example onboarding email](/images/blog-images/how-to-market/welcome-unkey.png)
