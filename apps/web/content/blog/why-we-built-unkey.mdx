...
Once you have the key with the limits, we will return `json
"valid": true` if the rate limit has been hit, so you know that this user shouldn't be able to access your endpoints. 
