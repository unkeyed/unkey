...
![Unkey Funding 1.5 million](/images/blog-images/funding/funding-cover.png)

The Unkey pre-seed round was led by [Essence VC](http://essence.vc/) and joined by [Sunflower Capital](https://www.crunchbase.com/organization/sunflower-capital), [The Normal Fund](https://new-normal.ventures/), and some fantastic friends.
...
- Ant Wilson & Rory Wilson (Supabase Co Founder / Head of Growth at Supabase)
...
- George Perkins (James’ Dad)

## How it all started

Andreas and I started Unkey in the middle of June and launched on June 21st, the community loved Unkey and got some awesome feedback. Once we understood that this side project, which started as a way to solve an annoying problem we both had experienced, was needed by more and more people, we set our sights on building an entire business for it.

Andreas and I worked nights and weekends for months to ensure Unkey made scaling user-facing APIs more accessible than ever. Shout out to all the friends and family who supported us getting through the 16+ hour days.

## How's it going

Since the launch in June, we have had some success with the product:

- 1.1k stars on GitHub
- We have done over 12 million API key verifications.
- 1.4k users have signed up

## What's next?

Now that Unkey is funded and Andreas and I can focus on building the best developer experience in the API space, you are probably wondering what is next.
...
Talking about hiring, if you are interested in being part of the team. Check out the [job posting and apply](https://pentagonal-cuckoo-5c4.notion.site/Engineering-Role-50e4e486ff734ef4ad49e0956dd12921).
