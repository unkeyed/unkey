...
The documentation has been updated, we shortened the [quickstart flow](https://docs.unkey.dev/quickstart) and documented the [update key](https://docs.unkey.dev/libraries/js/keys/update) for the Unkey SDK. Look out for our new Next.js wrapper coming soon!