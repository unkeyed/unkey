---
  ...
  summary: [
    "You can now set a maximum usage for a key, allowing you have a token like system. Keys can now be updated, allow you to change any key property as needed"]
  changes: 4
  features: "Yes"
---
...
You can read about this in our documentation: https://docs.unkey.dev/api-reference/keys/update
