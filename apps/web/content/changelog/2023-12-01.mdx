...
Welcome to the Unkey changelog. It's been a month since our last changelog, so let's talk about what has changed.
...
We have started working on a11y issues across the landing and web application. This project will continue on every project, improvement, or change to our website and dashboard.
...
There are many more bug fixes, but we couldn't include them here.
