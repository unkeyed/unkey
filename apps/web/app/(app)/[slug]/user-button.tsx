...
export const UserButton: React.FC = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="absolute inset-x-0 bottom-0 z-20 flex items-center justify-between gap-2 px-6 py-3 hover:bg-gray-200 dark:hover:bg-gray-800 hover:cursor-pointer">
