  ...
  return (
    <div>
      <div className="flex flex-col mt-4 gap-8">
        <Skeleton className="h-[231px] w-full bg-transparent border border-round border-border">
        ...
        <Skeleton className="h-[122px] w-full p-6 bg-transparent border border-round border-border">
          <Skeleton className="w-[180px] h-6" />
          <Skeleton className="w-[410px] h-3 mt-8" />
        </Skeleton><Skeleton className="h-40 w-full p-6 bg-transparent border border-round border-border">
