    ...
    return (
        <div className="scrollbar-hide">
            <div className="flex flex-row mt-4 gap-4">
                <Skeleton className="h-[104px] w-full p-6 bg-transparent border border-round border-border">
            ...
            <div>
                <Skeleton className="w-full h-[526px] bg-transparent border border-round border-border pb-10 mt-4">
