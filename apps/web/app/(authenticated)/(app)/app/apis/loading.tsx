  ...
  return (
    <div>
      <div className="flex flex-col pt-2">
        ...
        <Skeleton className="w-full h-[1px] mt-[52px]" />
      </div>
      <div className="flex flex-row mt-6 gap-4">
        <Skeleton className="h-8 w-full" />
        <Skeleton className="basis-[168px] h-8" />
      </div>
      <div className="flex flex-row mt-4 gap-6">
        ...
        </Skeleton><Skeleton className="h-44 w-full p-6 bg-transparent border border-round border-border">
          <Skeleton className="w-[130px] h-6" />
          <Skeleton className="w-[215px] h-3 mt-4" />
          <div className="w-full h-full mt-11 flex flex-row">
            <Skeleton className="w-14 h-3" />
