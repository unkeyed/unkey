export const changelog = {
  ...
  summary: [
    'We are thrilled to introduce support of teams. This feature allows you to collaborate more effectively with your team members and keeps your personal side projects separate from your work projects.',
    'We support whitelisting IP addresses so you can add an extra layer of security to your application',
    'Daily usage analytics, means you can track per key and per API usage',
    'Nuxt, Elixir, Python SDKs'
  ],
  changes: 6,
  features: "Yes"
}
...
![Usage Example from the Unkey dashboard](./usage-example.png)
