          ...
          <div className="flex flex-wrap">
            <div className="mb-6 w-full shrink-0 grow-0 basis-auto px-3">
              <h2 className="mb-6 text-3xl font-bold">
                What is <u className="text-primary dark:text-primary-400">Unkey?</u>
              </h2>
            </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4 grow">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-300">
                        We are globally remote and were founded that way too. We believe that the
                        best talent is not always in the same place and that we can build a better
                        product by hiring the best talent, no matter where they are.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4 w-full shrink-0 grow-0 basis-auto lg:w-5/12 lg:px-3 border border-gray-600 rounded-md p-3">
                  <div className="flex">
                    ...
                    <div className="ml-4 grow">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-300">
                        Unkey is a fully open source project, we believe that open source leads to
                        better products and better communities. We are committed to building a great
                        open source community around Unkey and providing the ability to self host
                ...
                <div className="mb-4 w-full shrink-0 grow-0 basis-auto lg:w-5/12 mx-4 lg:px-3 border border-gray-600 rounded-md p-3">
                  <div className="flex">
                    ...
                    <div className="ml-4 grow">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-300">
                        We are serial builders who love to innovate. We are always looking for new
                        ways to improve our product and our community. If we aren't working on
                        Unkey, we are probably learning about something new.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mb-4 w-full shrink-0 grow-0 basis-auto lg:w-5/12 lg:px-3 border border-gray-600 rounded-md p-3">
                  <div className="flex">
                    ...
                    <div className="ml-4 grow">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-300">
                        We believe that transparency is the key to building a great company, whether
                        you are a customer, a contributor, or a team member, you should know what we
                        are working on and how Unkey is doing. Our roadmap, metrics, revenue and
                        code are all open for you to see.
                      </p>
                    </div>
                  </div>
                </div>
