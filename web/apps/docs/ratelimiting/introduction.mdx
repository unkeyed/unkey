...
|----------|----------|--------------|
| **Standalone** | Any endpoint, public or private | You call `ratelimit.limit()` with any identifier |
...
<AccordionGroup>
  ...
  <Accordion title="Global edge performance" icon="globe">
    Requests are processed at 300+ edge locations. Your rate limits are checked close to your users, not in a single region.
  </Accordion>
