...
func main() {
	...
	// Monthly refill: 10,000 credits reset on the 1st of each month
	...
	res, err := client.Keys.CreateKey(ctx, components.V2KeysCreateKeyRequestBody{
		...
		Credits: &components.KeyCreditsData{
			Remaining: &remaining,
			Refill: &components.CreditsRefillData{
				Interval: components.CreditsRefillDataIntervalMonthly.Pointer(),
				Amount:   &amount,
			},
		},
	})
...
func main() {
	...
	// Daily refill: 100 credits reset every night at midnight UTC
	remaining := int64(100)
	amount := int64(100)
	...
	res, err := client.Keys.CreateKey(ctx, components.V2KeysCreateKeyRequestBody{
		...
		Credits: &components.KeyCreditsData{
			Remaining: &remaining,
			Refill: &components.CreditsRefillData{
				Interval: components.CreditsRefillDataIntervalDaily.Pointer(),
				Amount:   &amount,
			},
		},
	})
