...
| **Edge** | Requests are processed at 300+ global edge locations, with DDoS protection. |
...
We're actively working toward SOC 2 Type II certification. If you have specific compliance requirements, [contact us](mailto:support@unkey.dev) to discuss.
