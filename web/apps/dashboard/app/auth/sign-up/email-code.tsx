  ...
  return (
    <div className="flex flex-col max-w-sm mx-auto text-left">
      ...
      >
        ...
        <button
          type="submit"
          className="flex items-center cursor-pointer disabled:cursor-not-allowed justify-center h-10 gap-2 px-4 mt-8 text-sm font-medium text-black duration-200 bg-white border border-white rounded-lg hover:border-white/30 hover:bg-black hover:text-white"
