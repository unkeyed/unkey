      ...
      >
        ...
        <div className="bg-grayA-2 py-10 flex flex-col items-center justify-center w-full min-w-0 px-[120px]">
          ...
          <div className="mt-5 flex flex-col gap-2 items-center">
            <div className="font-semibold text-gray-12 text-base leading-[24px]">{copy.title}</div>
            <div className="text-gray-10 text-sm leading-[24px] text-center" ref={popoverAnchorRef}>
              {copy.body}
            </div>
          </div>
