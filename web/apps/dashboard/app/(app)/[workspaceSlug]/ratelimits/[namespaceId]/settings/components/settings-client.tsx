      ...
      <SettingsShell>
        ...
        <div className="w-full">
          <SettingCardGroup>
            ...
            >
              <div className="flex flex-row justify-end items-center pl-2 pr-2 py-2 w-full border border-gray-5 hover:border-gray-8 bg-gray-2 dark:bg-gray-2 rounded-lg min-w-[327px]">
