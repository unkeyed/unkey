...
export function ProjectCard({ name, projectId, appCount, apps, actions }: ProjectCardProps) {
  ...
  return (
    <div className="relative p-5 flex flex-col justify-between dark:bg-gray-2 border border-grayA-4 hover:border-grayA-7 rounded-lg w-full h-full gap-6 group transition-all duration-300 [&_a]:z-10 [&_button]:z-10">
      <Link
        href={projectPath}
