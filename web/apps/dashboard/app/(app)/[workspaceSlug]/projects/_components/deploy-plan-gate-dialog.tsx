 ...
 * Stripe Checkout even with a card on file, so Stripe can show the selected
 * plan and handle CVC recollection, card replacement, or 3DS. /success returns
 * to the projects landing after the paid subscription is linked. ctrl-api
 * remains the real gate, so the non-admin lockout here is UX only.
 */
