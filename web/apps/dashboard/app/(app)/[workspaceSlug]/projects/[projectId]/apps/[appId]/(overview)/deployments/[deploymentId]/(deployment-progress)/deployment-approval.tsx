    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <div className="flex flex-col items-center p-10">
          <div className="size-12 rounded-[14px] bg-gray-12 dark:bg-white flex items-center justify-center mb-4 shadow-[0_0_0_6px_var(--color-gray-2),0_0_0_8px_var(--color-gray-4)]">
