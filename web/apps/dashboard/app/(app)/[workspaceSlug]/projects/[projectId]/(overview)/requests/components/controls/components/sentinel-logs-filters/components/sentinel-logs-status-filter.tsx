      ...
      <div className="flex flex-col gap-2 font-mono px-2 py-2">
        ...
        <div className="flex gap-[18px] items-center py-1">
          ...
          <input
            ...
            placeholder="418"
            className="text-accent-9 text-xs bg-transparent border-b border-gray-6 outline-none w-[3ch] font-mono placeholder:text-accent-9/40 focus:border-accent-9 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
          {codeError ? (
