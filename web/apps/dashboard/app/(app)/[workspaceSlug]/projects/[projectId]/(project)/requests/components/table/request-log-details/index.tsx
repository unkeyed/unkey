...
const formatLatencyMetrics = (log: RequestLogsResponse): React.ReactNode => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        ...
        <span className="font-mono font-normal">{formatLatency(log.total_latency)}</span>
      </div>
      <div className="flex items-center justify-between">
...
const formatMetaInfo = (log: RequestLogsResponse): React.ReactNode => {
