            ...
            >
              ...
              <div className="p-4 pt-0">
                <Button
                  onClick={reset}
                  variant="outline"
                  className="w-full h-8 px-3 bg-grayA-3 hover:bg-grayA-4 border text-gray-12 text-xs font-medium rounded-lg transition-all duration-200 ease-out hover:ring-1 hover:ring-gray-7 flex items-center justify-center gap-2"
                >
                  <IconArrowDottedRotateAnticlockwiseOutline18 />
                  Retry Layout
                </Button>
