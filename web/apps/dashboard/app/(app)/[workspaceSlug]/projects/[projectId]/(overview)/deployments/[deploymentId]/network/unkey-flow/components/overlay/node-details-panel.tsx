...
export function NodeDetailsPanel({ node, deploymentId, onClose }: Props) {
  ...
  return (
    <div className="fixed top-40 right-0 bottom-14 z-20 flex flex-col gap-2 pointer-events-none">
      <div
        className={cn(
          "rounded-l-xl bg-white dark:bg-black border-l border-t border-b border-grayA-4 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.1)] pointer-events-auto min-w-[360px] max-h-[calc(100vh-300px)] flex flex-col pb-6",
