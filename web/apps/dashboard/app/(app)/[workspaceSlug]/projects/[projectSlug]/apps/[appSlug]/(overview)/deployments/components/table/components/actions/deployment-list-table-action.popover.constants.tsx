  ...
  const menuItems = useMemo((): MenuItem[] => {
    ...
    return [
      ...
      },
      {
        ...
        onClick: () => {
          router.push(
            `/${workspace.slug}/projects/${projectSlug}/requests?since=6h&deploymentId=contains:${selectedDeployment.id}`,
          );
        },
      },
      {
        ...
        onClick: () => {
          router.push(
            `/${workspace.slug}/projects/${projectSlug}/logs?appId=${selectedDeployment.appId}`,
          );
        },
      },
      {
