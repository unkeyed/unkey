...
import { grantCellLabels } from "../../lib/grant-label";
...
export function PermissionsCell({ permissions }: PermissionsCellProps) {
  const labels = grantCellLabels(permissions.map((permission) => permission.name));
  ...
  return (
    <div className="flex min-w-0 items-center gap-2">
      <span className="truncate text-[13px] leading-5 text-gray-11">
