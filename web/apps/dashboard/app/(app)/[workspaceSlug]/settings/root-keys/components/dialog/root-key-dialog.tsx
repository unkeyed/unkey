      ...
      <div className="flex flex-col p-6 gap-4">
        ...
        <div className="flex flex-col gap-2 mr-0">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="rounded-lg font-light text-grayA-8 text-[13px] border border-gray-5 hover:border-gray-8 bg-gray-2 dark:bg-gray-2 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gray-5 focus-visible:ring-offset-0"
            disabled={isBusy}
