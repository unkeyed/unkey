import { type IconProps, sizeMap } from "@unkey/icons";

/**
 * Nucleo's phone (outline), local to this page — @unkey/icons doesn't ship one
 * yet. Same shape as the generated icons so it sizes and strokes like its
 * neighbours.
 */
