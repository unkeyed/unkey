...
/**
 * The Compute spend-budget row: a bordered block under the meter grid showing
 ...
 * percentages of it, stopping workloads is a toggle). Unset budget renders a
 * one-line invitation instead.
 */
export const SpendBudget: React.FC<SpendBudgetProps> = ({ isAdmin, usageCents }) => {
  ...
  return (
    <>
      <div className="rounded-lg border border-grayA-3 px-4 py-3">
        {hasBudget ? (
