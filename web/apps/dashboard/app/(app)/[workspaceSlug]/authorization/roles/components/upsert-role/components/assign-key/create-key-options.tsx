              ...
              <div className="flex w-full text-accent-8 text-xs gap-4 py-0.5 items-center group flex-row">
                ...
                <div className="flex gap-1 flex-col truncate">
                  <div className="flex gap-2 items-center">
                    <span className="font-normal text-accent-12 text-left">
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="flex flex-col px-4 py-3 gap-3">
                <div>
                  <div className="text-xs font-normal text-gray-11 mb-1">Key ID</div>
                ...
                {key.roles.length > 0 && (
                  <div>
                    <div className="text-xs font-normal text-gray-11 mb-2">Roles</div>
