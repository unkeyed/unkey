...
// @generated from file frontline/policies/v1/match.proto (package frontline.v1, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message frontline.v1.MatchExpr
 */
export type MatchExpr = Message<"frontline.v1.MatchExpr"> & {
  /**
   * @generated from oneof frontline.v1.MatchExpr.expr
   */
  expr: {
    /**
     * @generated from field: frontline.v1.PathMatch path = 1;
     */
    value: PathMatch;
    case: "path";
  } | {
    /**
     * @generated from field: frontline.v1.MethodMatch method = 2;
     */
    value: MethodMatch;
    case: "method";
  } | {
    /**
     * @generated from field: frontline.v1.HeaderMatch header = 3;
     */
    value: HeaderMatch;
    case: "header";
  } | {
    /**
     * @generated from field: frontline.v1.QueryParamMatch query_param = 4;
     */
 ...
 * pattern.
 *
 * @generated from message frontline.v1.StringMatch
 */
export type StringMatch = Message<"frontline.v1.StringMatch"> & {
  /**
  ...
  /**
   * @generated from oneof frontline.v1.StringMatch.match
   */
  match: {
    /**
 ...
 *
 * @generated from message frontline.v1.PathMatch
 */
export type PathMatch = Message<"frontline.v1.PathMatch"> & {
  /**
   * @generated from field: frontline.v1.StringMatch path = 1;
   */
  path?: StringMatch;
};

/**
 * Describes the message frontline.v1.PathMatch.
 * Use `create(PathMatchSchema)` to create a new message.
 */
export const PathMatchSchema: GenMessage<PathMatch> = /*@__PURE__*/
  messageDesc(file_frontline_policies_v1_match, 2);
 ...
 *
 * @generated from message frontline.v1.MethodMatch
 */
export type MethodMatch = Message<"frontline.v1.MethodMatch"> & {
  /**
 ...
 *
 * @generated from message frontline.v1.HeaderMatch
 */
export type HeaderMatch = Message<"frontline.v1.HeaderMatch"> & {
  /**
  ...
  /**
   * @generated from oneof frontline.v1.HeaderMatch.match
   */
  match: {
    /**
     ...
     *
     * @generated from field: frontline.v1.StringMatch value = 3;
     */
    value: StringMatch;
    case: "value";
  } | { case: undefined; value?: undefined };
 ...
 * condition.
 *
 * @generated from message frontline.v1.QueryParamMatch
 */
export type QueryParamMatch = Message<"frontline.v1.QueryParamMatch"> & {
  /**
  ...
  /**
   * @generated from oneof frontline.v1.QueryParamMatch.match
   */
  match: {
    /**
...
/**
 * Describes the message frontline.v1.QueryParamMatch.
