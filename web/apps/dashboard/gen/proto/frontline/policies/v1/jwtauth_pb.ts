...
// @generated from file frontline/policies/v1/jwtauth.proto (package frontline.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file frontline/policies/v1/jwtauth.proto.
 */
export const file_frontline_policies_v1_jwtauth: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 */
export type JWTAuth = Message<"frontline.v1.JWTAuth"> & {
  /**
   * The source of signing keys for token verification. Exactly one must
   * be set.
   *
   * @generated from oneof frontline.v1.JWTAuth.jwks_source
   */
  jwksSource: {
    /**
