...
import { file_policies_v1_firewall } from "./firewall_pb";
...
export const file_policies_v1_policy: GenFile = /*@__PURE__*/
  fileDesc("", [file_policies_v1_basicauth, file_policies_v1_firewall, file_policies_v1_jwtauth, file_policies_v1_keyauth, file_policies_v1_match, file_policies_v1_openapi, file_policies_v1_ratelimit]);
...
export type Policy = Message<"sentinel.v1.Policy"> & {
  ...
  config: {
    ...
    /**
     * @generated from field: sentinel.v1.Firewall firewall = 9;
     */
    value: Firewall;
    case: "firewall";
  } | {
