      ...
      return (
        <div className="flex items-center justify-center w-full h-full bg-error-2">
          <div className="max-w-md p-6 bg-base-1 border border-error-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-medium text-error-11 mb-2">Something went wrong</h2>
            <p className="text-sm text-gray-11 mb-4">{this.state.error.message}</p>
            <button
              type="button"
              onClick={this.reset}
              className="px-4 py-2 bg-error-9 hover:bg-error-10 text-white text-sm font-normal rounded-sm transition-colors"
            >
              Try again
            </button>
          </div>
