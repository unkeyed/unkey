      ...
      return (
        <div className="flex items-center justify-center w-full h-full bg-error-2">
          <div className="max-w-md p-6 bg-raised border border-error-6 rounded-lg shadow-lg">
            ...
            <p className="text-base text-gray-11 mb-4">{this.state.error.message}</p>
            <button
              type="button"
              onClick={this.reset}
              className="px-4 py-2 bg-error-9 hover:bg-error-10 text-white text-base font-medium rounded-sm transition-colors"
            >
              Try again
            </button>
          </div>
