...
export function MultiboxChips({ className, ...props }: ComboboxPrimitive.Chips.Props) {
  return (
    <ComboboxPrimitive.Chips
      className={cn(
        "relative flex min-h-9 w-full flex-wrap items-center gap-1.5 rounded-lg border border-gray-5 bg-white px-1.5 py-1 pr-8 text-[13px] leading-5 text-grayA-12 transition-colors duration-300 dark:bg-gray-2",
        "hover:border-gray-8",
