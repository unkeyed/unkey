      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-gray-1 p-0 text-sidebar-foreground [&>button]:hidden border-grayA-4"
            style={
              {
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="footer"
        className={cn("mx-4 border-t border-grayA-4 flex flex-col gap-4 py-4", className)}
        {...props}
      />
    );
  },
...
>(({ className, depth = 0, maxDepth = 2, ...props }, ref) => {
  ...
  return (
    <ul
      ...
      data-depth={depth}
      className={cn(
        "mx-6 flex min-w-0 translate-x-px flex-col gap-1 border-l border-grayA-5 px-1 py-0.5 mt-2 mr-0",
        "group-data-[collapsible=icon]:hidden",
