  ...
  (
    ...
    return (
      <div
        ...
        role="tooltip"
        className={cn(
          "grid sm:w-fit md:w-fit md:max-w-[360px] items-start gap-2 rounded-lg border border-gray-6 bg-background-overlay pt-4 pb-2 text-xs shadow-2xl select-none",
          className,
        )}
      >
