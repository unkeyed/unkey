...
export const getButtonStyles = (isActive?: boolean, showLoader?: boolean) => {
  return cn(
    "flex items-center group text-[13px] font-medium text-gray-12 cursor-pointer hover:bg-grayA-3 hover:text-gray-12 justify-start active:border focus:ring-2 w-full text-left",
    ...
    "focus:border-grayA-12 focus:ring-gray-6 focus-visible:outline-hidden focus:ring-offset-0",
    isActive ? "bg-grayA-3 text-gray-12" : "[&_svg]:text-gray-9",
    showLoader ? "bg-grayA-3 [&_svg]:text-gray-12" : "",
  );
};
