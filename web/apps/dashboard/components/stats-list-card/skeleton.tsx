...
// Mirrors StatsListCard's layout exactly (same paddings, header line heights, and the
// h-12 chart well) so swapping a list-loading skeleton for real cards causes no
// layout shift.
