...
export const QueriesToast = ({ children, message, undoBookmarked }: QueriesToastProps) => {
  return (
    <div className="flex items-center w-full gap-4 px-1">
      ...
      <span className="flex-1 text-sm font-medium leading-6 text-left bg-raised w-full">
        {message}
      </span>
      <Button
        variant="ghost"
        className="shrink-0 px-[10px] py-[2px] m-0 w-[54px] h-[28px] rounded-[8px] border bg-raised text-gray-12"
