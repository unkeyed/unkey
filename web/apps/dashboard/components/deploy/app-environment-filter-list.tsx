...
type Props<TFilter extends FilterLike> = {
  apps: AppOption[];
...
const LOADING_APP_IDS = ["first", "second"];

export function AppEnvironmentFilterList<TFilter extends FilterLike>({
  apps,
  environments,
  isLoading,
  filters,
  ...
  const applyFilter = () => {
    const appEnvironmentFilters = createAppEnvironmentUnionFilters(
      draft,
      environmentIdsByApp,
      createFilter,
    );
