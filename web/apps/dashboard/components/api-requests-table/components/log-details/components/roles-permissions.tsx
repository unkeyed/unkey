    ...
    return (
      <div className="flex flex-col gap-1 mt-4 px-4">
        <div className="border bg-gray-2 border-gray-4 rounded-[10px]">
          ...
          <div className="border-gray-4 border-t rounded-[10px] bg-white dark:bg-background px-4 py-2">
  ...
  return (
    <div className="flex flex-col gap-1 mt-4 px-4">
      <div className="border bg-gray-2 border-gray-4 rounded-[10px]">
        ...
        <div className="flex flex-col border-gray-4 border-t rounded-[10px] bg-white dark:bg-background px-3.5 py-2 gap-2">
          {roles.map((role) => (
            <div
              key={role.name}
