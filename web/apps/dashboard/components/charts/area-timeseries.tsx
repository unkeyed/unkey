        ...
        <ChartTooltip
          ...
          content={({ active, payload }) => {
            ...
            return (
              <div
                role="tooltip"
                className="grid w-max max-w-[300px] animate-in items-start gap-1.5 rounded-xl border border-border/50 bg-gray-1/80 px-3 py-2.5 text-xs shadow-2xl backdrop-blur-md duration-150 fade-in-0 zoom-in-95 select-none"
              >
