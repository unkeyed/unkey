import type { HealthStatus } from "@/app/(app)/[workspaceSlug]/projects/[projectSlug]/apps/[appSlug]/(overview)/deployments/[deploymentId]/network/unkey-flow/components/nodes/types";
