    ...
    const namespace = await db.query.ratelimitNamespaces
      ...
      .catch((_err) => {
        throw new TRPCError({
          ...
          message:
            "We are unable to create an override for this namespace. Please try again or contact support@unkey.com",
        });
      });
    if (!namespace) {
      throw new TRPCError({
    ...
    await db
      ...
      .catch((_err) => {
        throw new TRPCError({
          code: "INTERNAL_SERVER_ERROR",
          message:
            "We are unable to create the override. Please try again or contact support@unkey.com",
        });
      });
