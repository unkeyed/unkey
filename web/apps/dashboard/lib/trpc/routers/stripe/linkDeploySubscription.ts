...
import {
  linkApiSubscription as linkApiSubscriptionCore,
  linkDeploySubscription as linkDeploySubscriptionCore,
} from "@/lib/stripe/linkDeploySubscription";
...
/** Persists a paid API Checkout subscription when the user returns from
 * Stripe. The completed webhook calls the same idempotent core as a backstop. */
