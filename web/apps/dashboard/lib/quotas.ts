...
export const freeTierLimits: Omit<InsertLimits, "workspaceId" | "pk"> = {
  ...
  computeCpuMax: Math.ceil(freeTierQuotas.allocatedCpuMillicoresTotal / 1_000),
  computeCpuMaxPerInstance: Math.ceil(freeTierQuotas.maxCpuMillicoresPerInstance / 1_000),
  computeMemoryMibMax: freeTierQuotas.allocatedMemoryMibTotal,
  computeMemoryMibMaxPerInstance: freeTierQuotas.maxMemoryMibPerInstance,
  computeDiskEphemeralMibMax: freeTierQuotas.allocatedStorageMibTotal,
  computeDiskEphemeralMibMaxPerInstance: freeTierQuotas.maxStorageMibPerInstance,
  computeBuildsConcurrentCountMax: freeTierQuotas.maxConcurrentBuilds,
  computeCustomDomainsCountMax: 0,
};
