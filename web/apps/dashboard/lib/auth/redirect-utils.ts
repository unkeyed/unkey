 ...
 *
 * Lives in lib/auth (not app/) so auth providers can validate redirect
 * targets without importing app code; app/auth/sign-in/redirect-utils
 * re-exports it for client-side consumers.
 */
