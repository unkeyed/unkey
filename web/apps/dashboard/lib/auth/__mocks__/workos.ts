...
export const createMockWorkOSInstance = (viFn: typeof import("vitest").vi) => ({
  userManagement: {
    ...
    authenticateWithTotp: viFn.fn(),
    authenticateWithRadarEmailChallenge: viFn.fn(),
    sendRadarSmsChallenge: viFn.fn(),
    authenticateWithRadarSmsChallenge: viFn.fn(),
    ...
    getInvitation: viFn.fn(),
    revokeInvitation: viFn.fn(),
    acceptInvitation: viFn.fn(),
    getAuthorizationUrl: viFn.fn(),
  },
  multiFactorAuth: {
    createUserAuthFactor: viFn.fn(),
    listUserAuthFactors: viFn.fn(),
    challengeFactor: viFn.fn(),
    verifyChallenge: viFn.fn(),
    deleteFactor: viFn.fn(),
  },
  organizations: {
