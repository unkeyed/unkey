...
CREATE INDEX `workspace_idx` ON `extension_installations` (`workspace_id`);--> statement-breakpoint
CREATE INDEX `project_idx` ON `extension_installations` (`project_id`);--> statement-breakpoint
