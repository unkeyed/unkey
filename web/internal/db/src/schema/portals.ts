...
export const portals = mysqlTable(
  "portals",
  {
    ...
    // The project of whatever the portal maps to. A portal is authorized as
    // projects/{project_id}/portals/{portal_id}, and an empty project id would
    // produce a resource name nothing can parse, so the column is non-nullable
    // with no default.
