...
export function projectsCreateProject(
  ...
  Result<
    components.V2ProjectsCreateProjectResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2ProjectsCreateProjectRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects.createProject")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2ProjectsCreateProjectResponseBody$inboundSchema),
