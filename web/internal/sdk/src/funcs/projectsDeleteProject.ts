...
export function projectsDeleteProject(
  ...
  Result<
    components.V2ProjectsDeleteProjectResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2ProjectsDeleteProjectRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects.deleteProject")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2ProjectsDeleteProjectResponseBody$inboundSchema),
