...
export function projectsListProjects(
  ...
  PageIterator<
    Result<
      operations.ProjectsListProjectsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2ProjectsListProjectsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects.listProjects")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ProjectsListProjectsResponse$inboundSchema, {
      key: "Result",
    }),
