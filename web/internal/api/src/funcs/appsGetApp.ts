 ...
 */
export function appsGetApp(
  client: UnkeyCore,
  request: components.V2AppsGetAppRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2AppsGetAppResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2AppsGetAppRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/apps.getApp")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2AppsGetAppResponseBody$inboundSchema),
