...
export function projectsGetProject(
  ...
  Result<
    components.V2ProjectsGetProjectResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2ProjectsGetProjectRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects.getProject")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2ProjectsGetProjectResponseBody$inboundSchema),
