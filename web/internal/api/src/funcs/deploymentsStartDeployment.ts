 ...
 */
export function deploymentsStartDeployment(
  client: UnkeyCore,
  request: components.V2DeploymentsStartDeploymentRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2DeploymentsStartDeploymentResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2DeploymentsStartDeploymentRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/deployments.startDeployment")();
  ...
  >(
    M.json(
      202,
      components.V2DeploymentsStartDeploymentResponseBody$inboundSchema,
    ),
