...
export function projectsUpdateProject(
  ...
  Result<
    components.V2ProjectsUpdateProjectResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2ProjectsUpdateProjectRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects.updateProject")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2ProjectsUpdateProjectResponseBody$inboundSchema),
