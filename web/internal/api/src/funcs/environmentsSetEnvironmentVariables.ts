 ...
 */
export function environmentsSetEnvironmentVariables(
  client: UnkeyCore,
  request: components.V2EnvironmentsSetEnvironmentVariablesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2EnvironmentsSetEnvironmentVariablesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2EnvironmentsSetEnvironmentVariablesRequestBody$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v2/environments.setEnvironmentVariables")();
  ...
  >(
    M.json(
      200,
      components
        .V2EnvironmentsSetEnvironmentVariablesResponseBody$inboundSchema,
    ),
