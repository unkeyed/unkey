 ...
 */
export function analyticsGetGatewayRequests(
  client: UnkeyCore,
  request: components.V2AnalyticsGetGatewayRequestsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2AnalyticsGetGatewayRequestsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2AnalyticsGetGatewayRequestsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/analytics.getGatewayRequests")();
  ...
  >(
    M.json(
      200,
      components.V2AnalyticsGetGatewayRequestsResponseBody$inboundSchema,
    ),
