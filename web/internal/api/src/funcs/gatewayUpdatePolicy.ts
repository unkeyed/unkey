 ...
 */
export function gatewayUpdatePolicy(
  client: UnkeyCore,
  request: components.V2GatewayUpdatePolicyRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2GatewayUpdatePolicyResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2GatewayUpdatePolicyRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/gateway.updatePolicy")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2GatewayUpdatePolicyResponseBody$inboundSchema),
