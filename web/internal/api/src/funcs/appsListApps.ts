...
export function appsListApps(
  ...
  PageIterator<
    Result<
      operations.AppsListAppsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2AppsListAppsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/apps.listApps")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppsListAppsResponse$inboundSchema, {
      key: "Result",
    }),
