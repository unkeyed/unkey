...
export function appsDeleteApp(
  ...
  Result<
    components.V2AppsDeleteAppResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2AppsDeleteAppRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/apps.deleteApp")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, components.V2AppsDeleteAppResponseBody$inboundSchema),
