...
export function portalGetVerifications(
  ...
  Result<
    components.V2PortalGetVerificationsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PortalGetVerificationsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/portal.getVerifications")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2PortalGetVerificationsResponseBody$inboundSchema),
