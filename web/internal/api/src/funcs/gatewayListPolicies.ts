 ...
 */
export function gatewayListPolicies(
  client: UnkeyCore,
  request: components.V2GatewayListPoliciesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2GatewayListPoliciesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2GatewayListPoliciesRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/gateway.listPolicies")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2GatewayListPoliciesResponseBody$inboundSchema),
