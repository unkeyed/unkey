 ...
 */
export function portalGetPortal(
  client: UnkeyCore,
  request: components.V2PortalGetPortalRequestBodyUnion,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2PortalGetPortalResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PortalGetPortalRequestBodyUnion$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/portal.getPortal")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2PortalGetPortalResponseBody$inboundSchema),
