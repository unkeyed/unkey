 ...
 */
export function portalCreateConfiguration(
  client: UnkeyCore,
  request: components.V2PortalCreateConfigurationRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2PortalCreateConfigurationResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PortalCreateConfigurationRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/portal.createConfiguration")();
  ...
  const context = {
    ...
    operationID: "portal.createConfiguration",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      components.V2PortalCreateConfigurationResponseBody$inboundSchema,
    ),
