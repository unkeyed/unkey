 ...
 */
export function environmentsUpdateSettings(
  client: UnkeyCore,
  request: components.V2EnvironmentsUpdateSettingsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2EnvironmentsUpdateSettingsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2EnvironmentsUpdateSettingsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/environments.updateSettings")();
  ...
  >(
    M.json(
      200,
      components.V2EnvironmentsUpdateSettingsResponseBody$inboundSchema,
    ),
