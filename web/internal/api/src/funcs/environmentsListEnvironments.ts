...
export function environmentsListEnvironments(
  ...
  Result<
    components.V2EnvironmentsListEnvironmentsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2EnvironmentsListEnvironmentsRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/environments.listEnvironments")();
  ...
  >(
    M.json(
      200,
      components.V2EnvironmentsListEnvironmentsResponseBody$inboundSchema,
    ),
