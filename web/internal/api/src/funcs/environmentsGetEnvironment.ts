...
export function environmentsGetEnvironment(
  ...
  Result<
    components.V2EnvironmentsGetEnvironmentResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2EnvironmentsGetEnvironmentRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/environments.getEnvironment")();
  ...
  >(
    M.json(
      200,
      components.V2EnvironmentsGetEnvironmentResponseBody$inboundSchema,
    ),
