...
const baseVariant =
  "px-3 py-2 text-xs font-normal shadow-md rounded-lg focus:border focus:border-accent-12 focus:ring-2 focus:ring-grayA-4 focus-visible:outline-hidden focus:ring-offset-0";
const variants = {
