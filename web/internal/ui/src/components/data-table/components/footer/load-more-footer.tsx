...
export function LoadMoreFooter({
  ...
  return (
    ...
    >
      <div
        className={`w-[740px] border bg-background-overlay border-gray-6 min-h-[60px] flex items-center justify-center rounded-[10px] drop-shadow-lg transform-gpu shadow-sm mb-5 transition-all duration-200 hover:shadow-lg ${
