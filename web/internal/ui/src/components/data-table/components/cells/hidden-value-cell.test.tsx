...
describe("HiddenValueCell", () => {
  it("shows four dots between the stored start and end", () => {
    render(<HiddenValueCell start="unkey_abcd" end="9xY2" title="Key" selected={false} />);
  ...
  it("keeps the middle masked for keys with long prefixes", () => {
