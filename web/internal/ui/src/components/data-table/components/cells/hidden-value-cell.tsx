...
export const HiddenValueCell = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "rounded-lg border bg-white dark:bg-base-12 border-accent-4 text-grayA-11 w-max min-w-[150px] whitespace-nowrap px-2 py-1 flex gap-2 items-center cursor-pointer h-[28px] group-hover:border-grayA-3 font-mono",
