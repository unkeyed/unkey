...
export const HiddenValueCell = ({
  ...
  return (
    ...
    <div
      className={cn(
        "rounded-lg border bg-raised border-gray-4 text-grayA-11 w-[264px] whitespace-nowrap px-2 py-1 flex gap-2 items-center cursor-pointer h-[28px] group-hover:border-grayA-3 font-mono",
