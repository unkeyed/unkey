  ...
  return (
    <div className="flex gap-0.5 font-mono group" data-pill-index={index}>
      {formatFieldName(field) === "" ? null : (
        <div className="bg-gray-3 px-2 rounded-l-md text-gray-12 font-medium py-[2px]">
          {formatFieldName(field)}
        </div>
      )}
      <div
        className={cn(
          "bg-gray-3 px-2 text-gray-12 font-medium py-[2px] flex gap-1 items-center",
      ...
      <div className="bg-gray-3 px-2 text-gray-12 font-medium py-[2px] flex gap-1 items-center">
        ...
        {field === "endTime" || field === "startTime" ? (
          ...
          <span className="text-gray-12 text-xs font-mono">{formatValue(value, field)}</span>
        )}
      </div>
      <div ref={pillRef} className="contents">
        <Button
          ...
          tabIndex={0}
          className={cn(
            "bg-gray-3 rounded-none rounded-r-md py-[2px] px-2 [&_svg]:stroke-[2px] [&_svg]:size-3 flex items-center border-none h-auto focus:ring-2 focus:ring-offset-1 focus:ring-gray-9 focus:outline-hidden hover:bg-gray-4 focus:hover:bg-gray-4",
            isFocused && "bg-gray-4",
          )}
        >
