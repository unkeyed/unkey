...
const inputVariants = cva(
  "flex h-9 w-full rounded-lg text-sm leading-5 transition-colors duration-300 disabled:cursor-not-allowed disabled:opacity-50 placeholder:text-grayA-8 text-grayA-12",
  {
    variants: {
      variant: {
        default: [
        ...
        ghost: [
          "border border-transparent bg-transparent focus:border focus:border-accent-12 focus:ring-3 focus:ring-gray-5 focus-visible:outline-hidden focus:ring-offset-0",
        ],
        success: [
