...
const textareaVariants = cva(
  "flex min-h-9 w-full rounded-lg text-sm leading-5 transition-colors duration-300 disabled:cursor-not-allowed disabled:opacity-50 placeholder:text-grayA-8 text-grayA-12",
  {
    variants: {
      variant: {
        default: [
