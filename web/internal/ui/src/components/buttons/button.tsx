...
const buttonVariants = cva(
  "inline-flex group relative duration-150 items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition active:not-disabled:not-aria-disabled:scale-97 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-gray-6 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:cursor-not-allowed cursor-pointer",
  {
    variants: {
      variant: {
        default: "",
...
const keyboardIconVariants = cva(
  "items-center transition duration-150 text-center justify-center shadow-none flex justify-center font-mono text-xs font-medium border rounded-sm h-5 px-1.5 min-w-[24px]",
  {
    variants: {
      variant: {
