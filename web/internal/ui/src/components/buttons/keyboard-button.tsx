...
const KeyboardButton = ({
  ...
  return (
    <span
      tabIndex={-1}
      className={cn(
        "flex items-center justify-center h-5 px-1 min-w-[24px] rounded-sm bg-gray-3 text-gray-9 dark:text-gray-10 border-gray-8 dark:border-gray-9 border text-xs",
