...
const KeyboardButton = ({
  ...
  return (
    <span
      tabIndex={-1}
      className={cn(
        "flex items-center justify-center h-5 px-1 min-w-[24px] text-xs",
        "bg-gray-3 text-gray-12 border border-strong rounded-md hover:bg-grayA-4 focus:hover:bg-transparent",
        "focus:border-grayA-12 focus:ring-4 focus:ring-gray-6 focus-visible:outline-hidden focus:ring-offset-0",
