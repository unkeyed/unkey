-- +goose up
CREATE MATERIALIZED VIEW ratelimits.ratelimits_identifier_latency_stats_per_hour_mv_v1
TO ratelimits.ratelimits_identifier_latency_stats_per_hour_v1
AS
SELECT 
...
-- +goose down
DROP VIEW ratelimits.ratelimits_identifier_latency_stats_per_hour_mv_v1;
