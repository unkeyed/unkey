...
export const clickhouseWorkspaceSettings = mysqlTable(
  "clickhouse_workspace_settings",
  {
    ...
    maxExecutionTimePerWindow: int("max_execution_time_per_window")
      .notNull()
      .default(1_800), // 30 min total
    ...
    maxRowsToRead: bigint("max_rows_to_read", { mode: "number" })
      .notNull()
      .default(10_000_000), // 10M rows
