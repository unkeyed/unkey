...
// NewVerifier constructs a KeyVerifier from explicit parts. It exists so
// tests and synthetic call sites outside this package can build verifiers
// without reaching into unexported fields. Production code paths must use
// Service.Get or Service.GetRootKey, which load from the database and
// attach the runtime services this constructor leaves unset.
