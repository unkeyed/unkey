...
import { DateRange, DayPicker, IconLeft, IconRight, CaptionProps, useNavigation } from "react-day-picker";
...
const styleClassNames = {
    ...
    day_today: "hover:aria-selected:bg-gray-3 hover:aria-selected:border-gray-8 bg-gray-12 text-gray-3 hover:text-gray-12 aria-selected:border aria-selected:border-2 aria-selected:border-gray-12 aria-selected:bg-gray-4 aria-selected:text-gray-12",
    day_outside:
...
const Calendar: React.FC<CalendarProps> = ({ className, classNames, mode, showOutsideDays = true, ...props }) => {
    ...
    const handleSingleChange = (newDate: Date | undefined) => {
        onDateChange({ from: newDate, to: newDate });
