...
//     const [sTime, setSTime] = useState(startTime ?? {HH: dateNow.getHours().toString(), mm: dateNow.getMinutes().toString(), ss: dateNow.getSeconds().toString()});
//     const [eTime, setETime] = useState(endTime ?? { HH: dateNow.getHours().toString(), mm: dateNow.getMinutes().toString(), ss: dateNow.getSeconds().toString() });
...
//             if (type === "start" && compareTimeUnits(normalizedTime, endDate) > 0) {
