...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/unkeyed/unkey/go/deploy/assetmanagerd/gen/asset/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AssetManagerServiceName = "asset.v1.AssetManagerService"
)
...
var (
	assetManagerServiceServiceDescriptor              = v1.File_deploy_assetmanagerd_proto_asset_v1_asset_proto.Services().ByName("AssetManagerService")
...
// GetAsset calls asset.v1.AssetManagerService.GetAsset.
...
// ListAssets calls asset.v1.AssetManagerService.ListAssets.
...
// AcquireAsset calls asset.v1.AssetManagerService.AcquireAsset.
...
// ReleaseAsset calls asset.v1.AssetManagerService.ReleaseAsset.
...
// DeleteAsset calls asset.v1.AssetManagerService.DeleteAsset.
...
// GarbageCollect calls asset.v1.AssetManagerService.GarbageCollect.
...
// PrepareAssets calls asset.v1.AssetManagerService.PrepareAssets.
...
func (UnimplementedAssetManagerServiceHandler) GetAsset(context.Context, *connect.Request[v1.GetAssetRequest]) (*connect.Response[v1.GetAssetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.GetAsset is not implemented"))
}
...
func (UnimplementedAssetManagerServiceHandler) ListAssets(context.Context, *connect.Request[v1.ListAssetsRequest]) (*connect.Response[v1.ListAssetsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.ListAssets is not implemented"))
}
...
func (UnimplementedAssetManagerServiceHandler) AcquireAsset(context.Context, *connect.Request[v1.AcquireAssetRequest]) (*connect.Response[v1.AcquireAssetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.AcquireAsset is not implemented"))
}
...
func (UnimplementedAssetManagerServiceHandler) ReleaseAsset(context.Context, *connect.Request[v1.ReleaseAssetRequest]) (*connect.Response[v1.ReleaseAssetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.ReleaseAsset is not implemented"))
}
...
func (UnimplementedAssetManagerServiceHandler) DeleteAsset(context.Context, *connect.Request[v1.DeleteAssetRequest]) (*connect.Response[v1.DeleteAssetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.DeleteAsset is not implemented"))
}
...
func (UnimplementedAssetManagerServiceHandler) GarbageCollect(context.Context, *connect.Request[v1.GarbageCollectRequest]) (*connect.Response[v1.GarbageCollectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("asset.v1.AssetManagerService.GarbageCollect is not implemented"))
}
