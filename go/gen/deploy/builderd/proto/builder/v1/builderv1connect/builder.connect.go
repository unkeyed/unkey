...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/unkeyed/unkey/go/deploy/builderd/gen/builder/v1"
	http "net/http"
	strings "strings"
)
...
var (
	builderServiceServiceDescriptor               = v1.File_deploy_builderd_proto_builder_v1_builder_proto.Services().ByName("BuilderService")
