...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/unkeyed/unkey/go/deploy/billaged/gen/billing/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	BillingServiceSendMetricsBatchProcedure = "/billing.v1.BillingService/SendMetricsBatch"
	// BillingServiceSendHeartbeatProcedure is the fully-qualified name of the BillingService's
	// SendHeartbeat RPC.
	BillingServiceSendHeartbeatProcedure = "/billing.v1.BillingService/SendHeartbeat"
	// BillingServiceNotifyVmStartedProcedure is the fully-qualified name of the BillingService's
	// NotifyVmStarted RPC.
	BillingServiceNotifyVmStartedProcedure = "/billing.v1.BillingService/NotifyVmStarted"
	// BillingServiceNotifyVmStoppedProcedure is the fully-qualified name of the BillingService's
	// NotifyVmStopped RPC.
	BillingServiceNotifyVmStoppedProcedure = "/billing.v1.BillingService/NotifyVmStopped"
	// BillingServiceNotifyPossibleGapProcedure is the fully-qualified name of the BillingService's
	// NotifyPossibleGap RPC.
	BillingServiceNotifyPossibleGapProcedure = "/billing.v1.BillingService/NotifyPossibleGap"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	billingServiceServiceDescriptor                 = v1.File_deploy_billaged_proto_billing_v1_billing_proto.Services().ByName("BillingService")
...
// SendMetricsBatch calls billing.v1.BillingService.SendMetricsBatch.
...
// SendHeartbeat calls billing.v1.BillingService.SendHeartbeat.
...
// NotifyVmStarted calls billing.v1.BillingService.NotifyVmStarted.
...
// NotifyVmStopped calls billing.v1.BillingService.NotifyVmStopped.
...
// NotifyPossibleGap calls billing.v1.BillingService.NotifyPossibleGap.
...
func (UnimplementedBillingServiceHandler) SendMetricsBatch(context.Context, *connect.Request[v1.SendMetricsBatchRequest]) (*connect.Response[v1.SendMetricsBatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("billing.v1.BillingService.SendMetricsBatch is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) SendHeartbeat(context.Context, *connect.Request[v1.SendHeartbeatRequest]) (*connect.Response[v1.SendHeartbeatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("billing.v1.BillingService.SendHeartbeat is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) NotifyVmStarted(context.Context, *connect.Request[v1.NotifyVmStartedRequest]) (*connect.Response[v1.NotifyVmStartedResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("billing.v1.BillingService.NotifyVmStarted is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) NotifyVmStopped(context.Context, *connect.Request[v1.NotifyVmStoppedRequest]) (*connect.Response[v1.NotifyVmStoppedResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("billing.v1.BillingService.NotifyVmStopped is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) NotifyPossibleGap(context.Context, *connect.Request[v1.NotifyPossibleGapRequest]) (*connect.Response[v1.NotifyPossibleGapResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("billing.v1.BillingService.NotifyPossibleGap is not implemented"))
}
