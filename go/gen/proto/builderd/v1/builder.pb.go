...
const file_builderd_v1_builder_proto_rawDesc = "" +
	...
	"\rGetBuildStats\x12!.builderd.v1.GetBuildStatsRequest\x1a\".builderd.v1.GetBuildStatsResponseB>Z<github.com/unkeyed/unkey/go/gen/proto/builderd/v1;builderdv1b\x06proto3"

var (
	file_builderd_v1_builder_proto_rawDescOnce sync.Once
	file_builderd_v1_builder_proto_rawDescData []byte
)

func file_builderd_v1_builder_proto_rawDescGZIP() []byte {
	file_builderd_v1_builder_proto_rawDescOnce.Do(func() {
		file_builderd_v1_builder_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_builderd_v1_builder_proto_rawDesc), len(file_builderd_v1_builder_proto_rawDesc)))
	})
	return file_builderd_v1_builder_proto_rawDescData
}

var file_builderd_v1_builder_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_builderd_v1_builder_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_builderd_v1_builder_proto_goTypes = []any{
	(BuildState)(0),                 // 0: builderd.v1.BuildState
	(TenantTier)(0),                 // 1: builderd.v1.TenantTier
	(InitStrategy)(0),               // 2: builderd.v1.InitStrategy
	(*BuildSource)(nil),             // 3: builderd.v1.BuildSource
	(*DockerImageSource)(nil),       // 4: builderd.v1.DockerImageSource
	(*DockerAuth)(nil),              // 5: builderd.v1.DockerAuth
	(*GitRepositorySource)(nil),     // 6: builderd.v1.GitRepositorySource
	(*GitAuth)(nil),                 // 7: builderd.v1.GitAuth
	(*ArchiveSource)(nil),           // 8: builderd.v1.ArchiveSource
	(*BuildTarget)(nil),             // 9: builderd.v1.BuildTarget
	(*MicroVMRootfs)(nil),           // 10: builderd.v1.MicroVMRootfs
	(*ContainerImage)(nil),          // 11: builderd.v1.ContainerImage
	(*RuntimeConfig)(nil),           // 12: builderd.v1.RuntimeConfig
	(*OptimizationSettings)(nil),    // 13: builderd.v1.OptimizationSettings
	(*BuildStrategy)(nil),           // 14: builderd.v1.BuildStrategy
	(*DockerExtractStrategy)(nil),   // 15: builderd.v1.DockerExtractStrategy
	(*GoApiStrategy)(nil),           // 16: builderd.v1.GoApiStrategy
	(*SinatraStrategy)(nil),         // 17: builderd.v1.SinatraStrategy
	(*NodejsStrategy)(nil),          // 18: builderd.v1.NodejsStrategy
	(*BuildConfig)(nil),             // 19: builderd.v1.BuildConfig
	(*BuildIsolation)(nil),          // 20: builderd.v1.BuildIsolation
	(*ImageMetadata)(nil),           // 21: builderd.v1.ImageMetadata
	(*BuildMetrics)(nil),            // 22: builderd.v1.BuildMetrics
	(*BuildJob)(nil),                // 23: builderd.v1.BuildJob
	(*StreamBuildLogsResponse)(nil), // 24: builderd.v1.StreamBuildLogsResponse
	(*CreateBuildRequest)(nil),      // 25: builderd.v1.CreateBuildRequest
	(*CreateBuildResponse)(nil),     // 26: builderd.v1.CreateBuildResponse
	(*GetBuildRequest)(nil),         // 27: builderd.v1.GetBuildRequest
	(*GetBuildResponse)(nil),        // 28: builderd.v1.GetBuildResponse
	(*ListBuildsRequest)(nil),       // 29: builderd.v1.ListBuildsRequest
	(*ListBuildsResponse)(nil),      // 30: builderd.v1.ListBuildsResponse
	(*CancelBuildRequest)(nil),      // 31: builderd.v1.CancelBuildRequest
	(*CancelBuildResponse)(nil),     // 32: builderd.v1.CancelBuildResponse
	(*DeleteBuildRequest)(nil),      // 33: builderd.v1.DeleteBuildRequest
	(*DeleteBuildResponse)(nil),     // 34: builderd.v1.DeleteBuildResponse
	(*StreamBuildLogsRequest)(nil),  // 35: builderd.v1.StreamBuildLogsRequest
	(*GetBuildStatsRequest)(nil),    // 36: builderd.v1.GetBuildStatsRequest
	(*GetBuildStatsResponse)(nil),   // 37: builderd.v1.GetBuildStatsResponse
	nil,                             // 38: builderd.v1.RuntimeConfig.EnvironmentEntry
	nil,                             // 39: builderd.v1.SinatraStrategy.RackConfigEntry
	nil,                             // 40: builderd.v1.BuildConfig.LabelsEntry
	nil,                             // 41: builderd.v1.ImageMetadata.LabelsEntry
	nil,                             // 42: builderd.v1.ImageMetadata.EnvEntry
	nil,                             // 43: builderd.v1.StreamBuildLogsResponse.MetadataEntry
	(*timestamppb.Timestamp)(nil),   // 44: google.protobuf.Timestamp
}
var file_builderd_v1_builder_proto_depIdxs = []int32{
	4,  // 0: builderd.v1.BuildSource.docker_image:type_name -> builderd.v1.DockerImageSource
