...
type DeploymentRequest struct {
	...
	EncryptedEnvironmentVariables []byte `protobuf:"bytes,8,opt,name=encrypted_environment_variables,json=encryptedEnvironmentVariables,proto3" json:"encrypted_environment_variables,omitempty"`
...
func (x *DeploymentRequest) GetEncryptedEnvironmentVariables() []byte {
	if x != nil {
...
const file_krane_v1_deployment_proto_rawDesc = "" +
	...
	"\x10environment_slug\x18\a \x01(\tR\x0fenvironmentSlug\x12F\n" +
	"\x1fencrypted_environment_variables\x18\b \x01(\fR\x1dencryptedEnvironmentVariables\x12%\n" +
	"\x0eenvironment_id\x18\t \x01(\tR\renvironmentId\x12\x19\n" +
	"\bbuild_id\x18\n" +
	" \x01(\tR\abuildId\"V\n" +
