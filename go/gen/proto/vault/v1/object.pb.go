...
const file_proto_vault_v1_object_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/vault/v1/object.proto\x12\bvault.v1\"T\n" +
...
var (
	...
	file_proto_vault_v1_object_proto_rawDescData []byte
)

func file_proto_vault_v1_object_proto_rawDescGZIP() []byte {
	file_proto_vault_v1_object_proto_rawDescOnce.Do(func() {
		file_proto_vault_v1_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_vault_v1_object_proto_rawDesc), len(file_proto_vault_v1_object_proto_rawDesc)))
	})
...
func file_proto_vault_v1_object_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_vault_v1_object_proto_rawDesc), len(file_proto_vault_v1_object_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
