...
func (x *VMMetrics) Reset() {
	*x = VMMetrics{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[0]
...
func (*VMMetrics) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{0}
}
...
func (x *SendMetricsBatchRequest) Reset() {
	*x = SendMetricsBatchRequest{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendMetricsBatchRequest) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{1}
}
...
func (x *SendMetricsBatchResponse) Reset() {
	*x = SendMetricsBatchResponse{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendMetricsBatchResponse) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{2}
}
...
func (x *SendHeartbeatRequest) Reset() {
	*x = SendHeartbeatRequest{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendHeartbeatRequest) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{3}
}
...
func (x *SendHeartbeatResponse) Reset() {
	*x = SendHeartbeatResponse{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendHeartbeatResponse) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{4}
}
...
func (x *NotifyVmStartedRequest) Reset() {
	*x = NotifyVmStartedRequest{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyVmStartedRequest) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{5}
}
...
func (x *NotifyVmStartedResponse) Reset() {
	*x = NotifyVmStartedResponse{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyVmStartedResponse) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{6}
}
...
func (x *NotifyVmStoppedRequest) Reset() {
	*x = NotifyVmStoppedRequest{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyVmStoppedRequest) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{7}
}
...
func (x *NotifyVmStoppedResponse) Reset() {
	*x = NotifyVmStoppedResponse{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyVmStoppedResponse) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{8}
}
...
func (x *NotifyPossibleGapRequest) Reset() {
	*x = NotifyPossibleGapRequest{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyPossibleGapRequest) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{9}
}
...
func (x *NotifyPossibleGapResponse) Reset() {
	*x = NotifyPossibleGapResponse{}
	mi := &file_proto_deploy_billaged_v1_billing_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyPossibleGapResponse) Descriptor() ([]byte, []int) {
	return file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP(), []int{10}
}
...
var File_proto_deploy_billaged_v1_billing_proto protoreflect.FileDescriptor

const file_proto_deploy_billaged_v1_billing_proto_rawDesc = "" +
	"\n" +
	"&proto/deploy/billaged/v1/billing.proto\x12\x12deploy.billaged.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbf\x02\n" +
	"\tVMMetrics\x128\n" +
	...
	"\x10network_tx_bytes\x18\a \x01(\x03R\x0enetworkTxBytes\"\x88\x01\n" +
	"\x17SendMetricsBatchRequest\x12\x13\n" +
	"\x05vm_id\x18\x01 \x01(\tR\x04vmId\x12\x1f\n" +
	"\vcustomer_id\x18\x02 \x01(\tR\n" +
	"customerId\x127\n" +
	"\ametrics\x18\x03 \x03(\v2\x1d.deploy.billaged.v1.VMMetricsR\ametrics\"N\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xaf\x04\n" +
	"\x0eBillingService\x12m\n" +
	"\x10SendMetricsBatch\x12+.deploy.billaged.v1.SendMetricsBatchRequest\x1a,.deploy.billaged.v1.SendMetricsBatchResponse\x12d\n" +
	"\rSendHeartbeat\x12(.deploy.billaged.v1.SendHeartbeatRequest\x1a).deploy.billaged.v1.SendHeartbeatResponse\x12j\n" +
	"\x0fNotifyVmStarted\x12*.deploy.billaged.v1.NotifyVmStartedRequest\x1a+.deploy.billaged.v1.NotifyVmStartedResponse\x12j\n" +
	"\x0fNotifyVmStopped\x12*.deploy.billaged.v1.NotifyVmStoppedRequest\x1a+.deploy.billaged.v1.NotifyVmStoppedResponse\x12p\n" +
	"\x11NotifyPossibleGap\x12,.deploy.billaged.v1.NotifyPossibleGapRequest\x1a-.deploy.billaged.v1.NotifyPossibleGapResponseBEZCgithub.com/unkeyed/unkey/go/gen/proto/deploy/billaged/v1;billagedv1b\x06proto3"

var (
	file_proto_deploy_billaged_v1_billing_proto_rawDescOnce sync.Once
	file_proto_deploy_billaged_v1_billing_proto_rawDescData []byte
)

func file_proto_deploy_billaged_v1_billing_proto_rawDescGZIP() []byte {
	file_proto_deploy_billaged_v1_billing_proto_rawDescOnce.Do(func() {
		file_proto_deploy_billaged_v1_billing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_deploy_billaged_v1_billing_proto_rawDesc), len(file_proto_deploy_billaged_v1_billing_proto_rawDesc)))
	})
	return file_proto_deploy_billaged_v1_billing_proto_rawDescData
}

var file_proto_deploy_billaged_v1_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_deploy_billaged_v1_billing_proto_goTypes = []any{
	(*VMMetrics)(nil),                 // 0: deploy.billaged.v1.VMMetrics
	(*SendMetricsBatchRequest)(nil),   // 1: deploy.billaged.v1.SendMetricsBatchRequest
	(*SendMetricsBatchResponse)(nil),  // 2: deploy.billaged.v1.SendMetricsBatchResponse
	(*SendHeartbeatRequest)(nil),      // 3: deploy.billaged.v1.SendHeartbeatRequest
	(*SendHeartbeatResponse)(nil),     // 4: deploy.billaged.v1.SendHeartbeatResponse
	(*NotifyVmStartedRequest)(nil),    // 5: deploy.billaged.v1.NotifyVmStartedRequest
	(*NotifyVmStartedResponse)(nil),   // 6: deploy.billaged.v1.NotifyVmStartedResponse
	(*NotifyVmStoppedRequest)(nil),    // 7: deploy.billaged.v1.NotifyVmStoppedRequest
	(*NotifyVmStoppedResponse)(nil),   // 8: deploy.billaged.v1.NotifyVmStoppedResponse
	(*NotifyPossibleGapRequest)(nil),  // 9: deploy.billaged.v1.NotifyPossibleGapRequest
	(*NotifyPossibleGapResponse)(nil), // 10: deploy.billaged.v1.NotifyPossibleGapResponse
	(*timestamppb.Timestamp)(nil),     // 11: google.protobuf.Timestamp
}
var file_proto_deploy_billaged_v1_billing_proto_depIdxs = []int32{
	11, // 0: deploy.billaged.v1.VMMetrics.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 1: deploy.billaged.v1.SendMetricsBatchRequest.metrics:type_name -> deploy.billaged.v1.VMMetrics
	1,  // 2: deploy.billaged.v1.BillingService.SendMetricsBatch:input_type -> deploy.billaged.v1.SendMetricsBatchRequest
	3,  // 3: deploy.billaged.v1.BillingService.SendHeartbeat:input_type -> deploy.billaged.v1.SendHeartbeatRequest
	5,  // 4: deploy.billaged.v1.BillingService.NotifyVmStarted:input_type -> deploy.billaged.v1.NotifyVmStartedRequest
	7,  // 5: deploy.billaged.v1.BillingService.NotifyVmStopped:input_type -> deploy.billaged.v1.NotifyVmStoppedRequest
	9,  // 6: deploy.billaged.v1.BillingService.NotifyPossibleGap:input_type -> deploy.billaged.v1.NotifyPossibleGapRequest
	2,  // 7: deploy.billaged.v1.BillingService.SendMetricsBatch:output_type -> deploy.billaged.v1.SendMetricsBatchResponse
	4,  // 8: deploy.billaged.v1.BillingService.SendHeartbeat:output_type -> deploy.billaged.v1.SendHeartbeatResponse
	6,  // 9: deploy.billaged.v1.BillingService.NotifyVmStarted:output_type -> deploy.billaged.v1.NotifyVmStartedResponse
	8,  // 10: deploy.billaged.v1.BillingService.NotifyVmStopped:output_type -> deploy.billaged.v1.NotifyVmStoppedResponse
	10, // 11: deploy.billaged.v1.BillingService.NotifyPossibleGap:output_type -> deploy.billaged.v1.NotifyPossibleGapResponse
...
func init() { file_proto_deploy_billaged_v1_billing_proto_init() }
func file_proto_deploy_billaged_v1_billing_proto_init() {
	if File_proto_deploy_billaged_v1_billing_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_deploy_billaged_v1_billing_proto_rawDesc), len(file_proto_deploy_billaged_v1_billing_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_deploy_billaged_v1_billing_proto_goTypes,
		DependencyIndexes: file_proto_deploy_billaged_v1_billing_proto_depIdxs,
		MessageInfos:      file_proto_deploy_billaged_v1_billing_proto_msgTypes,
	}.Build()
	File_proto_deploy_billaged_v1_billing_proto = out.File
	file_proto_deploy_billaged_v1_billing_proto_goTypes = nil
	file_proto_deploy_billaged_v1_billing_proto_depIdxs = nil
}
