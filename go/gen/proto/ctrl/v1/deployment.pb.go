...
type CreateDeploymentRequest struct {
	...
	ContextKey     *string `protobuf:"bytes,6,opt,name=context_key,json=contextKey,proto3,oneof" json:"context_key,omitempty"`               // S3 key for uploaded build context
...
const file_ctrl_v1_deployment_proto_rawDesc = "" +
	"\n" +
	"\x18ctrl/v1/deployment.proto\x12\actrl.v1\"\xe6\x04\n" +
	...
	"sourceType\x12$\n" +
	"\vcontext_key\x18\x06 \x01(\tH\x00R\n" +
	"contextKey\x88\x01\x01\x12-\n" +
	"\x10docker_file_path\x18\a \x01(\tH\x01R\x0edockerFilePath\x88\x01\x01\x12$\n" +
