...
func (BuildStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_ctrl_v1_build_proto_enumTypes[0].Descriptor()
}

func (BuildStatus) Type() protoreflect.EnumType {
	return &file_proto_ctrl_v1_build_proto_enumTypes[0]
}
...
func (BuildStatus) EnumDescriptor() ([]byte, []int) {
	return file_proto_ctrl_v1_build_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBuildRequest) Reset() {
	*x = CreateBuildRequest{}
	mi := &file_proto_ctrl_v1_build_proto_msgTypes[0]
...
func (x *CreateBuildResponse) Reset() {
	*x = CreateBuildResponse{}
	mi := &file_proto_ctrl_v1_build_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBuildResponse) Descriptor() ([]byte, []int) {
	return file_proto_ctrl_v1_build_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetBuildRequest) Reset() {
	*x = GetBuildRequest{}
	mi := &file_proto_ctrl_v1_build_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBuildRequest) Descriptor() ([]byte, []int) {
	return file_proto_ctrl_v1_build_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetBuildResponse) Reset() {
	*x = GetBuildResponse{}
	mi := &file_proto_ctrl_v1_build_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBuildResponse) Descriptor() ([]byte, []int) {
	return file_proto_ctrl_v1_build_proto_rawDescGZIP(), []int{3}
}
...
func (x *Build) Reset() {
	*x = Build{}
	mi := &file_proto_ctrl_v1_build_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Build) Descriptor() ([]byte, []int) {
	return file_proto_ctrl_v1_build_proto_rawDescGZIP(), []int{4}
}
...
var File_proto_ctrl_v1_build_proto protoreflect.FileDescriptor

const file_proto_ctrl_v1_build_proto_rawDesc = "" +
	"\n" +
	"\x19proto/ctrl/v1/build.proto\x12\actrl.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x98\x01\n" +
...
var (
	file_proto_ctrl_v1_build_proto_rawDescOnce sync.Once
	file_proto_ctrl_v1_build_proto_rawDescData []byte
)

func file_proto_ctrl_v1_build_proto_rawDescGZIP() []byte {
	file_proto_ctrl_v1_build_proto_rawDescOnce.Do(func() {
		file_proto_ctrl_v1_build_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_ctrl_v1_build_proto_rawDesc), len(file_proto_ctrl_v1_build_proto_rawDesc)))
	})
	return file_proto_ctrl_v1_build_proto_rawDescData
}

var file_proto_ctrl_v1_build_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_ctrl_v1_build_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_ctrl_v1_build_proto_goTypes = []any{
...
var file_proto_ctrl_v1_build_proto_depIdxs = []int32{
...
func init() { file_proto_ctrl_v1_build_proto_init() }
func file_proto_ctrl_v1_build_proto_init() {
	if File_proto_ctrl_v1_build_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_ctrl_v1_build_proto_rawDesc), len(file_proto_ctrl_v1_build_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_ctrl_v1_build_proto_goTypes,
		DependencyIndexes: file_proto_ctrl_v1_build_proto_depIdxs,
		EnumInfos:         file_proto_ctrl_v1_build_proto_enumTypes,
		MessageInfos:      file_proto_ctrl_v1_build_proto_msgTypes,
	}.Build()
	File_proto_ctrl_v1_build_proto = out.File
	file_proto_ctrl_v1_build_proto_goTypes = nil
	file_proto_ctrl_v1_build_proto_depIdxs = nil
}
