...
import (
	...
	v1 "github.com/unkeyed/unkey/go/deploy/builderd/gen/proto/builder/v1"
)
...
const (
	...
	BuilderServiceName = "builder.v1.BuilderService"
)
...
const (
	...
	// CreateBuild RPC.
	BuilderServiceCreateBuildProcedure = "/builder.v1.BuilderService/CreateBuild"
	// BuilderServiceGetBuildProcedure is the fully-qualified name of the BuilderService's GetBuild RPC.
	BuilderServiceGetBuildProcedure = "/builder.v1.BuilderService/GetBuild"
	// BuilderServiceListBuildsProcedure is the fully-qualified name of the BuilderService's ListBuilds
	// RPC.
	BuilderServiceListBuildsProcedure = "/builder.v1.BuilderService/ListBuilds"
	// BuilderServiceCancelBuildProcedure is the fully-qualified name of the BuilderService's
	// CancelBuild RPC.
	BuilderServiceCancelBuildProcedure = "/builder.v1.BuilderService/CancelBuild"
	// BuilderServiceDeleteBuildProcedure is the fully-qualified name of the BuilderService's
	// DeleteBuild RPC.
	BuilderServiceDeleteBuildProcedure = "/builder.v1.BuilderService/DeleteBuild"
	// BuilderServiceStreamBuildLogsProcedure is the fully-qualified name of the BuilderService's
	// StreamBuildLogs RPC.
	BuilderServiceStreamBuildLogsProcedure = "/builder.v1.BuilderService/StreamBuildLogs"
	// BuilderServiceGetTenantQuotasProcedure is the fully-qualified name of the BuilderService's
	// GetTenantQuotas RPC.
	BuilderServiceGetTenantQuotasProcedure = "/builder.v1.BuilderService/GetTenantQuotas"
	// BuilderServiceGetBuildStatsProcedure is the fully-qualified name of the BuilderService's
	// GetBuildStats RPC.
	BuilderServiceGetBuildStatsProcedure = "/builder.v1.BuilderService/GetBuildStats"
)

// BuilderServiceClient is a client for the builder.v1.BuilderService service.
type BuilderServiceClient interface {
	...
	StreamBuildLogs(context.Context, *connect.Request[v1.StreamBuildLogsRequest]) (*connect.ServerStreamForClient[v1.BuildLogEntry], error)
...
// NewBuilderServiceClient constructs a client for the builder.v1.BuilderService service. By
...
func NewBuilderServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BuilderServiceClient {
	...
	builderServiceMethods := v1.File_proto_builder_v1_builder_proto.Services().ByName("BuilderService").Methods()
	return &builderServiceClient{
		...
		streamBuildLogs: connect.NewClient[v1.StreamBuildLogsRequest, v1.BuildLogEntry](
			httpClient,
...
type builderServiceClient struct {
	...
	streamBuildLogs *connect.Client[v1.StreamBuildLogsRequest, v1.BuildLogEntry]
...
// CreateBuild calls builder.v1.BuilderService.CreateBuild.
...
// GetBuild calls builder.v1.BuilderService.GetBuild.
...
// ListBuilds calls builder.v1.BuilderService.ListBuilds.
...
// CancelBuild calls builder.v1.BuilderService.CancelBuild.
...
// DeleteBuild calls builder.v1.BuilderService.DeleteBuild.
...
// StreamBuildLogs calls builder.v1.BuilderService.StreamBuildLogs.
func (c *builderServiceClient) StreamBuildLogs(ctx context.Context, req *connect.Request[v1.StreamBuildLogsRequest]) (*connect.ServerStreamForClient[v1.BuildLogEntry], error) {
	return c.streamBuildLogs.CallServerStream(ctx, req)
}

// GetTenantQuotas calls builder.v1.BuilderService.GetTenantQuotas.
...
// GetBuildStats calls builder.v1.BuilderService.GetBuildStats.
...
// BuilderServiceHandler is an implementation of the builder.v1.BuilderService service.
type BuilderServiceHandler interface {
	...
	DeleteBuild(context.Context, *connect.Request[v1.DeleteBuildRequest]) (*connect.Response[v1.DeleteBuildResponse], error)
	// Stream build logs in real-time
	StreamBuildLogs(context.Context, *connect.Request[v1.StreamBuildLogsRequest], *connect.ServerStream[v1.BuildLogEntry]) error
	// Get tenant quotas and usage
	GetTenantQuotas(context.Context, *connect.Request[v1.GetTenantQuotasRequest]) (*connect.Response[v1.GetTenantQuotasResponse], error)
	// Get build statistics
	GetBuildStats(context.Context, *connect.Request[v1.GetBuildStatsRequest]) (*connect.Response[v1.GetBuildStatsResponse], error)
...
func NewBuilderServiceHandler(svc BuilderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/builder.v1.BuilderService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedBuilderServiceHandler) CreateBuild(context.Context, *connect.Request[v1.CreateBuildRequest]) (*connect.Response[v1.CreateBuildResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.CreateBuild is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) GetBuild(context.Context, *connect.Request[v1.GetBuildRequest]) (*connect.Response[v1.GetBuildResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.GetBuild is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) ListBuilds(context.Context, *connect.Request[v1.ListBuildsRequest]) (*connect.Response[v1.ListBuildsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.ListBuilds is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) CancelBuild(context.Context, *connect.Request[v1.CancelBuildRequest]) (*connect.Response[v1.CancelBuildResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.CancelBuild is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) DeleteBuild(context.Context, *connect.Request[v1.DeleteBuildRequest]) (*connect.Response[v1.DeleteBuildResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.DeleteBuild is not implemented"))
}

func (UnimplementedBuilderServiceHandler) StreamBuildLogs(context.Context, *connect.Request[v1.StreamBuildLogsRequest], *connect.ServerStream[v1.BuildLogEntry]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.StreamBuildLogs is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) GetTenantQuotas(context.Context, *connect.Request[v1.GetTenantQuotasRequest]) (*connect.Response[v1.GetTenantQuotasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.GetTenantQuotas is not implemented"))
}
...
func (UnimplementedBuilderServiceHandler) GetBuildStats(context.Context, *connect.Request[v1.GetBuildStatsRequest]) (*connect.Response[v1.GetBuildStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("builder.v1.BuilderService.GetBuildStats is not implemented"))
}
