...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/unkeyed/unkey/go/deploy/assetmanagerd/gen/proto/asset/v1"
	http "net/http"
	strings "strings"
)
...
var (
	assetManagerServiceServiceDescriptor              = v1.File_proto_asset_v1_asset_proto.Services().ByName("AssetManagerService")
