...
func (c *Client) genericToCloudHypervisorConfig(config *vmmv1.VmConfig) cloudHypervisorConfig {
...
func (c *Client) cloudHypervisorStateToGeneric(state string) vmmv1.VmState {
	switch state {
	case "Created":
