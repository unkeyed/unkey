...
import (
	...
	http "net/http"
	strings "strings"
	v1 "vmm-controlplane/gen/vmm/v1"
)
...
const (
	...
	VmServiceName = "vmm.v1.VmService"
)
...
// NewVmServiceClient constructs a client for the vmm.v1.VmService service. By default, it uses the
...
func NewVmServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VmServiceClient {
	...
	vmServiceMethods := v1.File_vmm_v1_vm_proto.Services().ByName("VmService").Methods()
...
// CreateVm calls vmm.v1.VmService.CreateVm.
...
// DeleteVm calls vmm.v1.VmService.DeleteVm.
...
// BootVm calls vmm.v1.VmService.BootVm.
...
// ShutdownVm calls vmm.v1.VmService.ShutdownVm.
...
// PauseVm calls vmm.v1.VmService.PauseVm.
...
// ResumeVm calls vmm.v1.VmService.ResumeVm.
...
// RebootVm calls vmm.v1.VmService.RebootVm.
...
// GetVmInfo calls vmm.v1.VmService.GetVmInfo.
...
// ListVms calls vmm.v1.VmService.ListVms.
...
// VmServiceHandler is an implementation of the vmm.v1.VmService service.
...
func NewVmServiceHandler(svc VmServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vmm.v1.VmService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVmServiceHandler) CreateVm(context.Context, *connect.Request[v1.CreateVmRequest]) (*connect.Response[v1.CreateVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.CreateVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) DeleteVm(context.Context, *connect.Request[v1.DeleteVmRequest]) (*connect.Response[v1.DeleteVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.DeleteVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) BootVm(context.Context, *connect.Request[v1.BootVmRequest]) (*connect.Response[v1.BootVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.BootVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) ShutdownVm(context.Context, *connect.Request[v1.ShutdownVmRequest]) (*connect.Response[v1.ShutdownVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.ShutdownVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) PauseVm(context.Context, *connect.Request[v1.PauseVmRequest]) (*connect.Response[v1.PauseVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.PauseVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) ResumeVm(context.Context, *connect.Request[v1.ResumeVmRequest]) (*connect.Response[v1.ResumeVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.ResumeVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) RebootVm(context.Context, *connect.Request[v1.RebootVmRequest]) (*connect.Response[v1.RebootVmResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.RebootVm is not implemented"))
}
...
func (UnimplementedVmServiceHandler) GetVmInfo(context.Context, *connect.Request[v1.GetVmInfoRequest]) (*connect.Response[v1.GetVmInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.GetVmInfo is not implemented"))
}
...
func (UnimplementedVmServiceHandler) ListVms(context.Context, *connect.Request[v1.ListVmsRequest]) (*connect.Response[v1.ListVmsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vmm.v1.VmService.ListVms is not implemented"))
}
