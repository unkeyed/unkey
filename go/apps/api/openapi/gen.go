...
// RatelimitGetOverrideResponseData defines model for RatelimitGetOverrideResponseData.
type RatelimitGetOverrideResponseData struct {
...
type RatelimitListOverridesResponseData = []RatelimitOverrideItem

// RatelimitOverrideItem defines model for RatelimitOverrideItem.
type RatelimitOverrideItem struct {
	// Duration The duration in milliseconds for the rate limit window.
	Duration int64 `json:"duration"`

	// Identifier Identifier of your user
	Identifier string `json:"identifier"`
...
type V2RatelimitGetOverrideResponseBody struct {
	Data RatelimitGetOverrideResponseData `json:"data"`
	Meta Meta                             `json:"meta"`
}
...
// Getter for additional properties for Pagination. Returns the specified
// element and whether it was found
func (a Pagination) Get(fieldName string) (value interface{}, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for Pagination
func (a *Pagination) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]interface{})
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for Pagination to handle AdditionalProperties
func (a *Pagination) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for Pagination to handle AdditionalProperties
func (a Pagination) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
