...
type V2RatelimitGetOverrideResponseBody = RatelimitOverride
...
// V2RatelimitListOverridesRequestBody List all overrides for a namespace
...
type V2RatelimitListOverridesResponseBody struct {
	Overrides []RatelimitOverride `json:"overrides"`
}
