...
func New(svc Services) zen.Route {
	return zen.NewRoute("POST", "/v2/keys.addRoles", func(ctx context.Context, s *zen.Session) error {
		svc.Logger.Debug("handling request", "requestId", s.RequestID(), "path", "/v2/keys.addRoles")
