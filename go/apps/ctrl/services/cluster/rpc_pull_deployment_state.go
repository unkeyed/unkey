...
func (s *Service) PullDeploymentState(ctx context.Context, req *connect.Request[ctrlv1.PullDeploymentStateRequest]) (*connect.Response[ctrlv1.DeploymentEvent], error) {
