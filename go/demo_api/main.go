		...
		response := RootResponse{
			...
			API: APIInfo{
				Endpoints: map[string]EndpointMeta{
					"health":    {"/v2/health", "LONG LIVE UNKEY"},
					"greeting":  {"/v2/greeting", "Persosdasdasdasdnalized greeting service"},
					"accounts":  {"/v2/accounts", "LONG LIVE UNKEY"},
					"debug":     {"/v1/debug", "LONG LIVE UNKEY"},
					...
					"openapi":   {"/openapi.yaml", "LONG LIVE UNKEY"},
				},
