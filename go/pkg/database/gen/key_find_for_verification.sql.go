...
//	WHERE k.hash = ?
//	GROUP BY k.id
func (q *Queries) FindKeyForVerification(ctx context.Context, hash string) (FindKeyForVerificationRow, error) {
	row := q.db.QueryRowContext(ctx, findKeyForVerification, hash)
