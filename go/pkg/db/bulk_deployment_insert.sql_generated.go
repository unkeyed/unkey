...
func (q *BulkQueries) InsertDeployments(ctx context.Context, db DBTX, args []InsertDeploymentParams) error {
	...
	for _, arg := range args {
		...
		allArgs = append(allArgs, arg.SecretsConfig)
