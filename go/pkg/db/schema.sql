...
CREATE TABLE `permissions` (
  ...
  UNIQUE KEY `unique_slug_per_workspace_idx` (`slug`,`workspace_id`),
  KEY `workspace_id_idx` (`workspace_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `ratelimits` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_name_per_key_idx` (`name`,`key_id`),
  UNIQUE KEY `unique_name_per_identity_idx` (`name`,`identity_id`),
  KEY `name_idx` (`name`),
  KEY `identity_id_idx` (`identity_id`),
