...
PRIMARY KEY (`workspace_id`, `time`, `key_space_id`, `identity_id`, `external_id`, `key_id`, `outcome`, `tags`) ORDER BY (`workspace_id`, `time`, `key_space_id`, `identity_id`, `external_id`, `key_id`, `outcome`, `tags`) TTL time + toIntervalDay(90) SETTINGS index_granularity = 8192;


INSERT INTO default.key_verifications_per_minute_v3 
SELECT time, workspace_id, key_space_id, identity_id,external_id,key_id,outcome,tags,count,spent_credits,latency_avg,latency_p75,latency_p99
FROM default.key_verifications_per_minute_v2
...
INSERT INTO default.key_verifications_per_hour_v3 
SELECT time, workspace_id, key_space_id, identity_id,external_id,key_id,outcome,tags,count,spent_credits,latency_avg,latency_p75,latency_p99
...
INSERT INTO default.key_verifications_per_day_v3 
SELECT time, workspace_id, key_space_id, identity_id,external_id,key_id,outcome,tags,count,spent_credits,latency_avg,latency_p75,latency_p99
...
SELECT time, workspace_id, key_space_id, identity_id,external_id,key_id,outcome,tags,count,spent_credits,latency_avg,latency_p75,latency_p99
FROM default.key_verifications_per_month_v2
