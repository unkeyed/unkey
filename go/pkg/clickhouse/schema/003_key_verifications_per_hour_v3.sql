CREATE TABLE key_verifications_per_hour_v3 (
  time DateTime,
  workspace_id String,
  key_space_id String,
  identity_id String,
...
CREATE MATERIALIZED VIEW key_verifications_per_hour_mv_v3 TO key_verifications_per_hour_v3 AS
SELECT
  workspace_id,
  key_space_id,
  identity_id,
...
FROM
  key_verifications_per_minute_v3
GROUP BY
  workspace_id,
  time,
  key_space_id,
