...
ORDER BY
  (
    ...
    tags,
    outcome
  ) TTL time + INTERVAL 7 DAY DELETE SETTINGS index_granularity = 8192;

CREATE MATERIALIZED VIEW key_verifications_per_minute_mv_v2 TO key_verifications_per_minute_v2 AS
SELECT
  workspace_id,
  key_space_id,
  identity_id,
