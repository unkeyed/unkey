...
func (s *Ratelimits) V1RatelimitsLimit(ctx context.Context, request operations.V1RatelimitsLimitRequestBody) (*operations.V1RatelimitsLimitResponse, error) {
	...
	res := &operations.V1RatelimitsLimitResponse{
