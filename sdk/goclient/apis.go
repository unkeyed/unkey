...
func (s *Apis) V1ApisGetAPI(ctx context.Context, apiID string) (*operations.V1ApisGetAPIResponse, error) {
	...
	res := &operations.V1ApisGetAPIResponse{
...
func (s *Apis) V1ApisListKeys(ctx context.Context, apiID string, limit *int64, cursor *string, ownerID *string) (*operations.V1ApisListKeysResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.V1ApisListKeysResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
