...
type V1KeysUpdateKeyResponse struct {
	HTTPMeta components.HTTPMetadata
	// The key was successfully updated, it may take up to 30s for this to take effect in all regions
	Object *V1KeysUpdateKeyResponseBody
}

func (o *V1KeysUpdateKeyResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *V1KeysUpdateKeyResponse) GetObject() *V1KeysUpdateKeyResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
