...
type V1ApisListKeysResponse struct {
	HTTPMeta components.HTTPMetadata
	// The configuration for an api
	Object *V1ApisListKeysResponseBody
}

func (o *V1ApisListKeysResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *V1ApisListKeysResponse) GetObject() *V1ApisListKeysResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
