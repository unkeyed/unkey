...
func extractKey(req *http.Request, locations []*frontlinev1.KeyLocation) string {
	if len(locations) == 0 {
...
func extractHeader(req *http.Request, loc *frontlinev1.HeaderKeyLocation) string {
	if loc == nil {
		return ""
	}
...
func extractQueryParam(req *http.Request, loc *frontlinev1.QueryParamKeyLocation) string {
	if loc == nil {
		return ""
	}
