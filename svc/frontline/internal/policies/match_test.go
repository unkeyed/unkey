	...
	exprs := []*frontlinev1.MatchExpr{
		{Expr: &frontlinev1.MatchExpr_Path{Path: &frontlinev1.PathMatch{
			Path: &frontlinev1.StringMatch{
				IgnoreCase: true,
				Match:      &frontlinev1.StringMatch_Exact{Exact: "/api/v1"},
			},
		}}},
	}
...
func TestMatchesRequest_HeaderValue(t *testing.T) {
	...
	exprs := []*frontlinev1.MatchExpr{
		{Expr: &frontlinev1.MatchExpr_Header{Header: &frontlinev1.HeaderMatch{
			Name: "Content-Type",
			Match: &frontlinev1.HeaderMatch_Value{Value: &frontlinev1.StringMatch{
				Match: &frontlinev1.StringMatch_Exact{Exact: "application/json"},
			}},
		}}},
	}
...
func TestMatchesRequest_QueryParamPresent(t *testing.T) {
	...
	exprs := []*frontlinev1.MatchExpr{
		{Expr: &frontlinev1.MatchExpr_QueryParam{QueryParam: &frontlinev1.QueryParamMatch{
			Name:  "debug",
			Match: &frontlinev1.QueryParamMatch_Present{Present: true},
		}}},
	}
	...
	exprs := []*frontlinev1.MatchExpr{
		{Expr: &frontlinev1.MatchExpr_QueryParam{QueryParam: &frontlinev1.QueryParamMatch{
			...
			Match: &frontlinev1.QueryParamMatch_Value{Value: &frontlinev1.StringMatch{
				Match: &frontlinev1.StringMatch_Prefix{Prefix: "v"},
			}},
		}}},
	}
