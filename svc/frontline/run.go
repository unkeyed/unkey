...
func Run(ctx context.Context, cfg Config) error {
	...
	// Start plain-HTTP server. Serves ACME HTTP-01 challenges and runs the
	// edge-redirect engine catchall (HTTP→HTTPS by default). See routes.RegisterHTTPServer.
	if cfg.HttpPort > 0 {
