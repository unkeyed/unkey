...
//	END
//	WHERE id = ?
func (q *Queries) UpdateKeyCreditsDecrement(ctx context.Context, arg UpdateKeyCreditsDecrementParams) error {
	_, err := q.db.ExecContext(ctx, updateKeyCreditsDecrement, arg.Credits, arg.Credits, arg.ID)
	return err
}
