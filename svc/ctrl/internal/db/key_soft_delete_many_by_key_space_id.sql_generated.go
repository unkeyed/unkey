...
//	WHERE key_auth_id = ?
//	AND deleted_at_m IS NULL
func (q *Queries) SoftDeleteManyKeysByKeySpaceID(ctx context.Context, arg SoftDeleteManyKeysByKeySpaceIDParams) error {
	_, err := q.db.ExecContext(ctx, softDeleteManyKeysByKeySpaceID, arg.Now, arg.KeySpaceID)
	return err
}
