...
//	ORDER BY id ASC
//	LIMIT ?
func (q *Queries) ListRatelimitOverridesByNamespaceID(ctx context.Context, arg ListRatelimitOverridesByNamespaceIDParams) ([]RatelimitOverride, error) {
	rows, err := q.db.QueryContext(ctx, listRatelimitOverridesByNamespaceID,
		arg.WorkspaceID,
		arg.NamespaceID,
		arg.CursorID,
		arg.Limit,
