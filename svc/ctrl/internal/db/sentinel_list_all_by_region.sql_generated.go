...
//	ORDER BY pk ASC
//	LIMIT ?
func (q *Queries) ListAllSentinelsByRegion(ctx context.Context, arg ListAllSentinelsByRegionParams) ([]Sentinel, error) {
	rows, err := q.db.QueryContext(ctx, listAllSentinelsByRegion, arg.RegionID, arg.AfterPk, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
