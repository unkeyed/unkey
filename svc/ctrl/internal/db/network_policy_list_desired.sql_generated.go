...
//	ORDER BY id ASC
//	LIMIT ?
func (q *Queries) ListDesiredNetworkPolicies(ctx context.Context, arg ListDesiredNetworkPoliciesParams) ([]CiliumNetworkPolicy, error) {
	rows, err := q.db.QueryContext(ctx, listDesiredNetworkPolicies,
		arg.RegionID,
		arg.RegionID,
