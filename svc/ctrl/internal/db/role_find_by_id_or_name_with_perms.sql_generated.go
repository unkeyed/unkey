...
//	    OR r.name = ?
//	)
func (q *Queries) FindRoleByIdOrNameWithPerms(ctx context.Context, arg FindRoleByIdOrNameWithPermsParams) (FindRoleByIdOrNameWithPermsRow, error) {
	row := q.db.QueryRowContext(ctx, findRoleByIdOrNameWithPerms, arg.WorkspaceID, arg.Search, arg.Search)
