...
//	FROM sentinels
//	WHERE k8s_name = ? LIMIT 1
func (q *Queries) FindSentinelDeployContextByK8sName(ctx context.Context, k8sName string) (FindSentinelDeployContextByK8sNameRow, error) {
	row := q.db.QueryRowContext(ctx, findSentinelDeployContextByK8sName, k8sName)
