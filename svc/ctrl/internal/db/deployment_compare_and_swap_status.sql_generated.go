...
//	WHERE id = ?
//	AND status = ?
func (q *Queries) CompareAndSwapDeploymentStatus(ctx context.Context, arg CompareAndSwapDeploymentStatusParams) (sql.Result, error) {
	return q.db.ExecContext(ctx, compareAndSwapDeploymentStatus,
		arg.NewStatus,
		arg.UpdatedAt,
		arg.ID,
		arg.ExpectedStatus,
