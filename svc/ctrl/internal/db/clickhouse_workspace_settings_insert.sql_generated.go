...
//	    ?
//	)
func (q *Queries) InsertClickhouseWorkspaceSettings(ctx context.Context, arg InsertClickhouseWorkspaceSettingsParams) error {
	_, err := q.db.ExecContext(ctx, insertClickhouseWorkspaceSettings,
		arg.WorkspaceID,
		arg.Username,
