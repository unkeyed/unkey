...
//	ORDER BY pk ASC
//	LIMIT ?
func (q *Queries) ListAllCiliumNetworkPoliciesByRegion(ctx context.Context, arg ListAllCiliumNetworkPoliciesByRegionParams) ([]CiliumNetworkPolicy, error) {
	rows, err := q.db.QueryContext(ctx, listAllCiliumNetworkPoliciesByRegion, arg.RegionID, arg.AfterPk, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
