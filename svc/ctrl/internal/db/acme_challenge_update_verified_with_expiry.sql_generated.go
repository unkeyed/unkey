...
//	SET status = ?, expires_at = ?, updated_at = ?
//	WHERE domain_id = ?
func (q *Queries) UpdateAcmeChallengeVerifiedWithExpiry(ctx context.Context, arg UpdateAcmeChallengeVerifiedWithExpiryParams) error {
	_, err := q.db.ExecContext(ctx, updateAcmeChallengeVerifiedWithExpiry,
		arg.Status,
		arg.ExpiresAt,
		arg.UpdatedAt,
		arg.DomainID,
