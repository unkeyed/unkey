...
func (q *BulkQueries) InsertAcmeChallenges(ctx context.Context, args []InsertAcmeChallengeParams) error {
	...
	bulkQuery := fmt.Sprintf(bulkInsertAcmeChallenge, strings.Join(valueClauses, ", "))
