...
//	WHERE key_id = ?
//	  AND role_id = ?
func (q *Queries) FindKeyRoleByKeyAndRoleID(ctx context.Context, arg FindKeyRoleByKeyAndRoleIDParams) ([]KeysRole, error) {
	rows, err := q.db.QueryContext(ctx, findKeyRoleByKeyAndRoleID, arg.KeyID, arg.RoleID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
