...
type Querier interface {
	...
	//      image = VALUES(image),
	//      updated_at = VALUES(updated_at)
	UpsertAppDockerSource(ctx context.Context, arg UpsertAppDockerSourceParams) error
