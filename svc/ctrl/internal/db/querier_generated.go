...
type Querier interface {
	...
	//
	//  SELECT
	//      gc.pk, gc.workspace_id, gc.project_id, gc.app_id, gc.installation_id, gc.repository_id, gc.repository_full_name, gc.provider, gc.access_token, gc.provider_host, gc.created_at, gc.updated_at,
