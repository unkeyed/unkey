...
//	  AND i.id != ?
//	  AND i.deleted = true
func (q *Queries) DeleteOldIdentityByExternalID(ctx context.Context, arg DeleteOldIdentityByExternalIDParams) error {
	_, err := q.db.ExecContext(ctx, deleteOldIdentityByExternalID, arg.WorkspaceID, arg.ExternalID, arg.CurrentIdentityID)
	return err
}
