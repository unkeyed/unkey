...
//	  updated_at = ?
//	WHERE k8s_name = ?
func (q *Queries) UpdateSentinelObservedState(ctx context.Context, arg UpdateSentinelObservedStateParams) error {
	_, err := q.db.ExecContext(ctx, updateSentinelObservedState,
