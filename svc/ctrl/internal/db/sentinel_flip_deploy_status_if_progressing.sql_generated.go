...
//	WHERE id = ?
//	  AND deploy_status = 'progressing'
func (q *Queries) FlipSentinelDeployStatusIfProgressing(ctx context.Context, arg FlipSentinelDeployStatusIfProgressingParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, flipSentinelDeployStatusIfProgressing, arg.DeployStatus, arg.UpdatedAt, arg.ID)
	if err != nil {
		return 0, err
	}
