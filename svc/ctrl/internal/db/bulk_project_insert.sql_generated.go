...
const bulkInsertProject = `INSERT INTO projects ( id, workspace_id, name, slug, delete_protection, created_at, updated_at ) VALUES %s`

// InsertProjects performs bulk insert in a single query

func (q *BulkQueries) InsertProjects(ctx context.Context, args []InsertProjectParams) error {
