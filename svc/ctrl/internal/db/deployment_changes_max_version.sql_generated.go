...
//	FROM `deployment_changes`
//	WHERE region_id = ?
func (q *Queries) GetDeploymentChangesMaxVersion(ctx context.Context, regionID string) (int64, error) {
	row := q.db.QueryRowContext(ctx, getDeploymentChangesMaxVersion, regionID)
