...
//	AND workspace_id = ?
//	LIMIT 1
func (q *Queries) FindRoleByNameAndWorkspaceID(ctx context.Context, arg FindRoleByNameAndWorkspaceIDParams) (Role, error) {
	row := q.db.QueryRowContext(ctx, findRoleByNameAndWorkspaceID, arg.Name, arg.WorkspaceID)
	var i Role
	err := row.Scan(
		&i.Pk,
		&i.ID,
