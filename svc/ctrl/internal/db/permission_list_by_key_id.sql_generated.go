...
//	    SELECT permission_slug FROM role_permissions
//	) all_permissions
func (q *Queries) ListPermissionsByKeyID(ctx context.Context, arg ListPermissionsByKeyIDParams) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listPermissionsByKeyID, arg.KeyID, arg.KeyID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
