...
//	  AND (i.id = ? OR i.external_id = ?)
//	  AND i.deleted = true
func (q *Queries) DeleteOldIdentityWithRatelimits(ctx context.Context, arg DeleteOldIdentityWithRatelimitsParams) error {
	_, err := q.db.ExecContext(ctx, deleteOldIdentityWithRatelimits, arg.WorkspaceID, arg.Identity, arg.Identity)
	return err
}
