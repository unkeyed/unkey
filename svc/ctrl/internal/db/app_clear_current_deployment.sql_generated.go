...
//	WHERE id = ?
//	  AND current_deployment_id = ?
func (q *Queries) ClearAppCurrentDeployment(ctx context.Context, arg ClearAppCurrentDeploymentParams) error {
	_, err := q.db.ExecContext(ctx, clearAppCurrentDeployment, arg.UpdatedAt, arg.AppID, arg.DeploymentID)
	return err
}
