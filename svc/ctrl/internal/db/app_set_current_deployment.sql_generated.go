...
//	WHERE id = ?
//	  AND current_deployment_id IS NULL
func (q *Queries) SetAppCurrentDeployment(ctx context.Context, arg SetAppCurrentDeploymentParams) error {
	_, err := q.db.ExecContext(ctx, setAppCurrentDeployment, arg.DeploymentID, arg.UpdatedAt, arg.AppID)
	return err
}
