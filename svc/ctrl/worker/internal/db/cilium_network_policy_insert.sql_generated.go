...
//	    ?
//	)
func (q *Queries) InsertCiliumNetworkPolicy(ctx context.Context, arg InsertCiliumNetworkPolicyParams) error {
	_, err := q.db.ExecContext(ctx, insertCiliumNetworkPolicy,
		arg.ID,
		arg.WorkspaceID,
		arg.ProjectID,
		arg.AppID,
