...
//	    updated_at = ?
//	WHERE domain = ?
func (q *Queries) ResetCustomDomainVerification(ctx context.Context, arg ResetCustomDomainVerificationParams) error {
	_, err := q.db.ExecContext(ctx, resetCustomDomainVerification,
