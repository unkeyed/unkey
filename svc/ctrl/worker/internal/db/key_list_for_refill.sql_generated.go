...
//	    LIMIT ?
//	) AS batch ON batch.pk = k.pk
func (q *Queries) ListKeysForRefill(ctx context.Context, arg ListKeysForRefillParams) ([]ListKeysForRefillRow, error) {
	rows, err := q.db.QueryContext(ctx, listKeysForRefill,
		arg.TodayDay,
