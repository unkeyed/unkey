...
//	  AND region_id = ?
//	  AND k8s_name = ?
func (q *Queries) UpdateCiliumNetworkPolicyByEnvironmentRegionAndName(ctx context.Context, arg UpdateCiliumNetworkPolicyByEnvironmentRegionAndNameParams) error {
	_, err := q.db.ExecContext(ctx, updateCiliumNetworkPolicyByEnvironmentRegionAndName,
		arg.Policy,
		arg.Version,
		arg.UpdatedAt,
		arg.EnvironmentID,
