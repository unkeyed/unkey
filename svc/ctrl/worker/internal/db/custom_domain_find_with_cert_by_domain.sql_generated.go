...
//	LEFT JOIN certificates c ON c.hostname = cd.domain
//	WHERE cd.domain = ?
func (q *Queries) FindCustomDomainWithCertByDomain(ctx context.Context, domain string) (FindCustomDomainWithCertByDomainRow, error) {
	row := q.db.QueryRowContext(ctx, findCustomDomainWithCertByDomain, domain)
