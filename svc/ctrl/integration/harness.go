...
func (h *Harness) CreateDeployment(ctx context.Context, req CreateDeploymentRequest) CreateDeploymentResult {
	...
	err = db.Query.InsertDeploymentTopology(ctx, h.DB.RW(), db.InsertDeploymentTopologyParams{
		...
		VpaUpdateMode:              db.NullDeploymentTopologyVpaUpdateMode{DeploymentTopologyVpaUpdateMode: "", Valid: false},
		VpaControlledResources:     db.NullDeploymentTopologyVpaControlledResources{DeploymentTopologyVpaControlledResources: "", Valid: false},
		VpaControlledValues:        db.NullDeploymentTopologyVpaControlledValues{DeploymentTopologyVpaControlledValues: "", Valid: false},
		VpaCpuMinMillicores:        sql.NullInt32{Int32: 0, Valid: false},
		VpaCpuMaxMillicores:        sql.NullInt32{Int32: 0, Valid: false},
		VpaMemoryMinMib:            sql.NullInt32{Int32: 0, Valid: false},
		VpaMemoryMaxMib:            sql.NullInt32{Int32: 0, Valid: false},
