...
var realisticCombinations = []TestCase{
	...
	// Higher limits representative of production API rate limits.
	// At these scales, absolute over-admission is roughly constant but the
	// percentage tolerance is comfortably met.
	{NodeCount: 3, Limit: 1000, Duration: 10000, LoadFactor: 0.9, WindowCount: 10},
	{NodeCount: 3, Limit: 1000, Duration: 10000, LoadFactor: 1.0, WindowCount: 10},
	{NodeCount: 3, Limit: 1000, Duration: 10000, LoadFactor: 2.0, WindowCount: 10},
	{NodeCount: 5, Limit: 1000, Duration: 10000, LoadFactor: 1.0, WindowCount: 10},
	{NodeCount: 5, Limit: 1000, Duration: 10000, LoadFactor: 2.0, WindowCount: 10},

	{NodeCount: 3, Limit: 10000, Duration: 60000, LoadFactor: 0.9, WindowCount: 5},
	{NodeCount: 3, Limit: 10000, Duration: 60000, LoadFactor: 1.0, WindowCount: 5},
	{NodeCount: 3, Limit: 10000, Duration: 60000, LoadFactor: 2.0, WindowCount: 5},
	{NodeCount: 5, Limit: 10000, Duration: 60000, LoadFactor: 1.0, WindowCount: 5},
	{NodeCount: 5, Limit: 10000, Duration: 60000, LoadFactor: 2.0, WindowCount: 5},
}
...
const testTemplate = `// Code generated by go generate; DO NOT EDID.
package {{ .PackageName }}
