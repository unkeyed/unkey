...
// TestGetDomainUnauthorized covers a well-formed bearer token that does not resolve to
// a key. A header that is absent or missing the 'Bearer ' prefix never reaches key
