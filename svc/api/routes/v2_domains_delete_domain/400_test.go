...
// TestDeleteDomainBadRequest covers the spec layer: the identifier carries only length
...
// TestDeleteDomainNotFound.
func TestDeleteDomainBadRequest(t *testing.T) {
