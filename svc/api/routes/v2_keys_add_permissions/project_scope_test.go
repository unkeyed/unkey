...
// TestAddPermissionsCreatesPermissionInKeyProject guarantees that a matching
// slug in another project does not prevent a project-local permission.
func TestAddPermissionsCreatesPermissionInKeyProject(t *testing.T) {
	...
	permissionSlug := "documents.read.add.shared-slug"
