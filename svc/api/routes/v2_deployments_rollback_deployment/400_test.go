...
func TestRollbackDeploymentValidationErrors(t *testing.T) {
	...
	rootKey := h.CreateRootKey(workspace.ID, "environment.*.rollback_deployment")
	...
	require.Empty(t, mock.RollbackCalls, "ctrl must not be called for invalid requests")
}
