...
type V2ProjectsCreateProjectRequestBody struct {
	...
	// This value is caller-defined (not generated by Unkey), stable over the project lifetime, and is the identifier used to reference this project in get, update, and delete operations.
...
type V2ProjectsCreateProjectResponseData struct {
	// Slug The workspace-scoped slug of the newly created project.
	// Use this value to reference the project in subsequent get, update, and delete operations.
	Slug string `json:"slug"`
}
