...
type Deployment struct {
	...
	// IsCurrent True when this is the production deployment currently serving traffic. Only
	// production deployments are ever current; a `ready` deployment is not current
	// if it was superseded, never promoted, or the app was rolled back to a
