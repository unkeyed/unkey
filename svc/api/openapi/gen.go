...
type App struct {
	...
	// Docker The configured Docker image source. Omitted when the app is not Docker-sourced.
...
// V2AppsCreateAppRequestBody Create an app with exactly one source: `git` or `docker`.
