...
// Defines values for PortalMappingType.
const (
	PortalMappingTypeApp      PortalMappingType = "app"
	PortalMappingTypeKeyspace PortalMappingType = "keyspace"
)
...
type Portal struct {
	...
	// Mapping The single resource a portal serves keys for.
	//
	...
	Mapping PortalMapping `json:"mapping"`
...
type PortalMapping struct {
	// Id The id of the app or keyspace this portal serves. Must belong to your
	// workspace.
	Id string `json:"id"`

	// Type Whether `id` names an app or a keyspace.
	Type PortalMappingType `json:"type"`
}

// PortalMappingType Whether `id` names an app or a keyspace.
type PortalMappingType string
...
type V2PortalGetPortalRequestBody struct {
	...
	// request shape: there is no way to express a portal with two mappings, and no
	// way to express one with none.
	Mapping *PortalMapping `json:"mapping,omitempty"`
...
type V2PortalUpdatePortalRequestBody struct {
	...
	// Mapping Re-point the portal at a different app or keyspace. Omit to leave the
