...
func (e DeploymentAction) Valid() bool {
	...
	case DeploymentActionRollback:
		return true
	case DeploymentActionStart:
		return true
	case DeploymentActionStop:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DeploymentErrorCode enum.
func (e DeploymentErrorCode) Valid() bool {
	switch e {
	case DeploymentErrorCodeBuildFailed:
		return true
	case DeploymentErrorCodeCpuQuotaExceeded:
		return true
	case DeploymentErrorCodeInvalidRuntimeSettings:
		return true
	case DeploymentErrorCodeMemoryQuotaExceeded:
		return true
	case DeploymentErrorCodeNoSchedulableRegions:
		return true
	case DeploymentErrorCodeStorageQuotaExceeded:
		return true
	case DeploymentErrorCodeUnknown:
		return true
	default:
		return false
	}
...
func (e DeploymentStatus) Valid() bool {
	switch e {
	case DeploymentStatusAwaitingApproval:
		return true
	...
	case DeploymentStatusFailed:
		return true
	case DeploymentStatusFinalizing:
		return true
	case DeploymentStatusNetwork:
		return true
	case DeploymentStatusPending:
		return true
	case DeploymentStatusReady:
		return true
	case DeploymentStatusSkipped:
		return true
	case DeploymentStatusStarting:
		return true
...
// Valid indicates whether the value is a known member of the EnvironmentHealthcheckMethod enum.
func (e EnvironmentHealthcheckMethod) Valid() bool {
	switch e {
	case EnvironmentHealthcheckMethodGET:
		return true
	case EnvironmentHealthcheckMethodPOST:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the EnvironmentShutdownSignal enum.
func (e EnvironmentShutdownSignal) Valid() bool {
	switch e {
	case SIGINT:
		return true
	case SIGKILL:
...
// Valid indicates whether the value is a known member of the EnvironmentUpstreamProtocol enum.
func (e EnvironmentUpstreamProtocol) Valid() bool {
	switch e {
	case H2c:
		return true
	case Http1:
...
// Valid indicates whether the value is a known member of the EnvironmentVariableKind enum.
func (e EnvironmentVariableKind) Valid() bool {
	switch e {
	case Recoverable:
		return true
	case Writeonly:
...
// Valid indicates whether the value is a known member of the FieldMatchPresent enum.
func (e FieldMatchPresent) Valid() bool {
	switch e {
	case True:
		return true
	default:
...
// Valid indicates whether the value is a known member of the FirewallPolicyAction enum.
func (e FirewallPolicyAction) Valid() bool {
	switch e {
	case ACTIONDENY:
		return true
	default:
...
// Valid indicates whether the value is a known member of the KeyCreditsRefillInterval enum.
func (e KeyCreditsRefillInterval) Valid() bool {
	switch e {
	case KeyCreditsRefillIntervalDaily:
		return true
	case KeyCreditsRefillIntervalMonthly:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MethodMatchMethods enum.
func (e MethodMatchMethods) Valid() bool {
	switch e {
	case MethodMatchMethodsDELETE:
		return true
	case MethodMatchMethodsGET:
		return true
	case MethodMatchMethodsHEAD:
		return true
	case MethodMatchMethodsOPTIONS:
		return true
	case MethodMatchMethodsPATCH:
		return true
	case MethodMatchMethodsPOST:
		return true
	case MethodMatchMethodsPUT:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UpdateKeyCreditsRefillInterval enum.
func (e UpdateKeyCreditsRefillInterval) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the V2DeployGetDeploymentResponseDataStatus enum.
func (e V2DeployGetDeploymentResponseDataStatus) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the V2KeysUpdateCreditsRequestBodyOperation enum.
func (e V2KeysUpdateCreditsRequestBodyOperation) Valid() bool {
	switch e {
	case Decrement:
		return true
	case Increment:
...
// Valid indicates whether the value is a known member of the V2KeysVerifyKeyResponseDataCode enum.
func (e V2KeysVerifyKeyResponseDataCode) Valid() bool {
	switch e {
	case DISABLED:
		return true
	case EXPIRED:
...
// Valid indicates whether the value is a known member of the V2PortalCreateSessionRequestBodyScopes enum.
func (e V2PortalCreateSessionRequestBodyScopes) Valid() bool {
	switch e {
	case AnalyticsRead:
		return true
	case KeysRead:
...
type App struct {
	...
	//
	// Example: d_1234abcd
	CurrentDeploymentId string `json:"currentDeploymentId,omitempty,omitzero"`
	...
	// Oci The configured OCI image source. Omitted when the app is not OCI-sourced.
	...
	//
	// Example: oci
	SourceType AppSourceType `json:"sourceType,omitempty,omitzero"`
	...
	UpdatedAt int64 `json:"updatedAt,omitempty,omitzero"`
}
...
type AppGit struct {
	...
	// Repository The connected GitHub repository, as "owner/repo".
	//
	// Example: unkeyed/unkey
...
type DeploymentError struct {
	...
	//
	//
	// Example: No schedulable regions configured. Please configure at least one schedulable region before deploying.
...
type DomainConnect struct {
	...
	//
	//
	// Example: https://dash.cloudflare.com/domainconnect/v2/domaintemplates/apply?domain=acme.com&host=api
	Url string `json:"url"`
}
...
type Environment struct {
	...
	// Kind The deployment lifecycle role of an environment.
	//
...
type FieldMatch struct {
	...
	//
	// Example: {"ignoreCase":true,"prefix":"/api/"}
...
type Identity struct {
	...
	Ratelimits []RatelimitResponse `json:"ratelimits,omitempty,omitzero"`
}
...
type KeyCreditsData struct {
	...
	Refill KeyCreditsRefill `json:"refill,omitempty,omitzero"`
...
type KeyCreditsRefill struct {
	...
	//
	// Example: 15
	RefillDay int `json:"refillDay,omitempty,omitzero"`
}
...
//
// Example: {"duration":60000,"limit":100,"name":"requests"}
...
type KeyResponseData struct {
	...
	Expires  int64    `json:"expires,omitempty,omitzero"`
	...
	//
	// Example: 1701425400000
	LastUsedAt int64 `json:"lastUsedAt,omitempty,omitzero"`
	...
	// Permissions Example: ["documents.read","documents.write"]
	...
	Plaintext  string              `json:"plaintext,omitempty,omitzero"`
	Ratelimits []RatelimitResponse `json:"ratelimits,omitempty,omitzero"`

	// Roles Example: ["editor","viewer"]
...
//
// Example: {"query":true,"requestBody":true,"requestHeaders":true,"responseBody":true,"responseHeaders":true}
...
// policy it stores.
//
// Example: {"enabled":true,"firewall":{"action":"ACTION_DENY"},"match":[{"path":{"path":{"prefix":"/internal/"}}}],"name":"Block internal paths"}
type Policy struct {
	...
	//
	// Example: {"identifiers":[{"remoteIp":{}}],"limit":100,"windowMs":60000}
...
//
// Example: {"enabled":true,"firewall":{"action":"ACTION_DENY"},"id":"pol_2gJbXhAr4","match":[{"path":{"path":{"prefix":"/internal/"}}}],"name":"Block internal paths"}
...
type PortalBranding struct {
	...
	//
	// Example: #6366f1
	PrimaryColor string `json:"primaryColor,omitempty,omitzero"`
}
...
type V2AnalyticsGetGatewayRequestsResponseBody struct {
	...
	//
	// Example: [{"path":"/v1/orders","total":1234}]
...
type V2AnalyticsGetRatelimitsResponseBody struct {
	...
	//
	// Example: [{"namespace_id":"rlns_123","total":1234}]
...
type V2AnalyticsGetRuntimeLogsRequestBody struct {
	...
	//
	//
	// Example: SELECT time, severity, message FROM runtime_logs_v1 WHERE lower(message) LIKE '%timeout%' ORDER BY time DESC LIMIT 100
	Query string `json:"query"`
}
...
type V2AnalyticsGetRuntimeLogsResponseBody struct {
	...
	//
	// Example: [{"message":"upstream timeout after 30s","severity":"error","time":1755000000000}]
...
type V2AnalyticsGetVerificationsResponseBody struct {
	...
	//
	// Example: [{"count":1234,"outcome":"VALID","time":1696118400000},{"count":56,"outcome":"RATE_LIMITED","time":1696118400000}]
...
// V2AppsCreateAppRequestBody0 defines model for V2AppsCreateAppRequestBody.0.
type V2AppsCreateAppRequestBody0 = interface{}

// V2AppsCreateAppRequestBody1 defines model for V2AppsCreateAppRequestBody.1.
...
// V2DeploymentsCreateDeploymentRequestBody0 defines model for V2DeploymentsCreateDeploymentRequestBody.0.
type V2DeploymentsCreateDeploymentRequestBody0 = interface{}

// V2DeploymentsCreateDeploymentRequestBody1 defines model for V2DeploymentsCreateDeploymentRequestBody.1.
type V2DeploymentsCreateDeploymentRequestBody1 = interface{}

// V2DeploymentsCreateDeploymentRequestBody2 defines model for V2DeploymentsCreateDeploymentRequestBody.2.
...
type V2DomainsListDomainsRequestBody struct {
	// App Match domains whose app ID or slug equals this value. This filter does not require a
	...
	// Environment Match domains whose environment ID or slug equals this value. This filter does not require
	...
	// Project Match domains whose project ID or slug equals this value. This filter does not require
...
type V2DomainsListDomainsResponseBody struct {
	// Data Domains that match every request filter and that you have permission to read, sorted by ID.
...
type V2GithubInstallAppResponseData struct {
	...
	//
	//
	// Example: https://github.com/apps/unkey/installations/new?state=eyJ...
	Url string `json:"url"`
}
...
type V2IdentitiesUpdateIdentityRequestBody struct {
	...
	//
	//
	// Example: {"email":"alice@example.com","name":"Alice Smith","plan":"premium"}
	Meta *map[string]interface{} `json:"meta,omitempty"`
	...
	//
	//
	// Example: [{"autoApply":true,"duration":3600000,"limit":1000,"name":"requests"}]
	Ratelimits *[]RatelimitRequest `json:"ratelimits,omitempty"`
}
...
type V2KeysCreateKeyRequestBody struct {
	...
	//
	//
	// Example: {"billing":{"renewal":"2024-12-31","tier":"premium"},"customerName":"Acme Corp","featureFlags":{"betaAccess":true,"concurrentConnections":10},"plan":"enterprise"}
	Meta *map[string]interface{} `json:"meta,omitempty"`
	...
	//
	//
	// Example: [{"autoApply":true,"duration":60000,"limit":100,"name":"requests"},{"autoApply":false,"duration":3600000,"limit":10,"name":"heavy_operations"}]
	Ratelimits *[]RatelimitRequest `json:"ratelimits,omitempty"`
...
type V2KeysUpdateKeyRequestBody struct {
	...
	//
	//
	// Example: {"billing":{"cycle":"monthly","next_billing":"2024-01-15"},"features":["analytics","exports","webhooks"],"hasAcceptedTerms":true,"lastBillingDate":"2023-10-15","limits":{"compute":"1000 minutes/month","storage":"500GB"},"plan":"enterprise","preferences":{"notifications":true,"timezone":"UTC"}}
	...
	// Permissions Example: ["documents.read","documents.write","settings.view"]
	Permissions *[]string `json:"permissions,omitempty"`
	...
	// Roles Example: ["api_admin","billing_reader"]
	Roles *[]string `json:"roles,omitempty"`
}
...
type V2KeysVerifyKeyRequestBody struct {
	...
	//
	//
	// Example: ["endpoint=/users/profile","method=GET","region=us-east-1","clientVersion=2.3.0","feature=premium"]
...
type V2KeysVerifyKeyResponseData struct {
	...
	KeyId string `json:"keyId,omitempty,omitzero"`
	...
	Permissions []string                 `json:"permissions,omitempty,omitzero"`
	Ratelimits  []VerifyKeyRatelimitData `json:"ratelimits,omitempty,omitzero"`
...
// V2PermissionsSetRolePermissionsRequestBody0 defines model for V2PermissionsSetRolePermissionsRequestBody.0.
type V2PermissionsSetRolePermissionsRequestBody0 = interface{}

// V2PermissionsSetRolePermissionsRequestBody1 defines model for V2PermissionsSetRolePermissionsRequestBody.1.
...
// V2PortalCreatePortalRequestBody0 defines model for V2PortalCreatePortalRequestBody.0.
type V2PortalCreatePortalRequestBody0 = interface{}

// V2PortalCreatePortalRequestBody1 defines model for V2PortalCreatePortalRequestBody.1.
...
type V2PortalCreateSessionResponseData struct {
	...
	//
	//
	// Example: https://portal.unkey.com/?code=pec_abc123def456
	Url string `json:"url"`
}
...
// V2PortalGetPortalRequestBody0 defines model for V2PortalGetPortalRequestBody.0.
type V2PortalGetPortalRequestBody0 = interface{}

// V2PortalGetPortalRequestBody1 defines model for V2PortalGetPortalRequestBody.1.
type V2PortalGetPortalRequestBody1 = interface{}

// V2PortalGetPortalRequestBody2 defines model for V2PortalGetPortalRequestBody.2.
...
type V2RatelimitLimitResponseData struct {
	...
	OverrideId string `json:"overrideId,omitempty,omitzero"`
