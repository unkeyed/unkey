...
// Defines values for EnvironmentRuntimeShutdownSignal.
const (
	SIGINT  EnvironmentRuntimeShutdownSignal = "SIGINT"
	SIGKILL EnvironmentRuntimeShutdownSignal = "SIGKILL"
	SIGQUIT EnvironmentRuntimeShutdownSignal = "SIGQUIT"
	SIGTERM EnvironmentRuntimeShutdownSignal = "SIGTERM"
)

// Defines values for EnvironmentRuntimeUpstreamProtocol.
const (
	H2c   EnvironmentRuntimeUpstreamProtocol = "h2c"
	Http1 EnvironmentRuntimeUpstreamProtocol = "http1"
)
...
type Environment struct {
	// AppId The unique identifier of the app this environment belongs to.
...
type EnvironmentRuntime struct {
	...
	ShutdownSignal EnvironmentRuntimeShutdownSignal `json:"shutdownSignal"`
	...
	UpstreamProtocol EnvironmentRuntimeUpstreamProtocol `json:"upstreamProtocol"`
}

// EnvironmentRuntimeShutdownSignal Signal sent to the container on shutdown.
type EnvironmentRuntimeShutdownSignal string

// EnvironmentRuntimeUpstreamProtocol Protocol used to reach the container.
type EnvironmentRuntimeUpstreamProtocol string
