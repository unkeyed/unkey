...
type V2ProjectsListProjectsResponseBody struct {
	...
	Data []V2ProjectsListProjectsResponseData `json:"data"`
...
// V2ProjectsListProjectsResponseData defines model for V2ProjectsListProjectsResponseData.
type V2ProjectsListProjectsResponseData struct {
