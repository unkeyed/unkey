...
type App struct {
	...
	// Git The connected GitHub repository and the branch deployments track, or null
	// when the app has no repository connected (for example a Docker-based app).
	Git nullable.Nullable[AppGit] `json:"git,omitempty"`
