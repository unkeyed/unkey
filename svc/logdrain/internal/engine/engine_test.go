...
func TestProcess_CatchesUpEmptyWindows(t *testing.T) {
	...
	reader := windowSource{read: func(_ context.Context, _ string, from source.Cursor, to int64, _ int) ([]sink.Event, source.Cursor, error) {
...
func TestProcess_DeliveryFailure(t *testing.T) {
	...
	reads := 0
	reader := windowSource{read: func(_ context.Context, _ string, from source.Cursor, to int64, limit int) ([]sink.Event, source.Cursor, error) {
		reads++
...
func TestProcess_ZeroCursor(t *testing.T) {
	...
	reader := windowSource{
		read: func(_ context.Context, _ string, from source.Cursor, _ int64, _ int) ([]sink.Event, source.Cursor, error) {
			return nil, from, nil
		},
	}
