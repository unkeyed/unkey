...
For full documentation, see https://www.unkey.com/docs/api-reference/v2/ratelimit/get-ratelimit-override` + util.Disclaimer,
		...
		Flags: []cli.Flag{
			...
			cli.String("identifier", "The exact identifier pattern of the override to retrieve.", cli.Required(), cli.MutuallyExclusive("body")),
		},
		Action: func(ctx context.Context, cmd *cli.Command) error {
			...
			if cmd.FlagIsSet("body") {
				...
				res, err := util.SendBody(ctx, client.Ratelimit.GetOverride, body)
				if err != nil {
					return err
				}
				return util.Output(cmd, res.V2RatelimitGetOverrideResponseBody)
			}
