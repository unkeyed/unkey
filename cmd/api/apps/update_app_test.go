...
func TestUpdateApp(t *testing.T) {
	tests := []struct {
		...
		"apps update-app --project=payments --app=app_1",
		components.V2AppsUpdateAppRequestBody{
			Project: "payments",
			App:     "app_1",
		},
	}, {
		"all options including false boolean",
		`apps update-app --project=payments --app=app_1 --name=Pay --slug=pay --git='{"repository":"unkeyed/api","defaultBranch":"trunk"}' --oci='{"image":"ghcr.io/acme/payments:v2"}' --delete-protection=false`,
		components.V2AppsUpdateAppRequestBody{
			Project: "payments",
			App:     "app_1",
			Name:    ptr.P("Pay"),
		...
		"disconnect git",
		"apps update-app --project=payments --app=app_1 --git=null",
		components.V2AppsUpdateAppRequestBody{
			Project: "payments",
			App:     "app_1",
			Git:     map[bool]*components.AppGitUpdateInput{true: nil},
		},
	}}
