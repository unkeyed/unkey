...
func createAppCmd() *cli.Command {
	return &cli.Command{
		Name:  "create-app",
		Usage: "Create an app within a project.",
		Description: `Create an app within a project. The app is created with default production and preview environments.
...
For full documentation, see https://www.unkey.com/docs/api-reference/apps/create-app` + util.Disclaimer,
		...
		Action: func(ctx context.Context, cmd *cli.Command) error {
			...
			if cmd.String("git") != "" {
				...
				req = components.CreateV2AppsCreateAppRequestBodyUnionV2AppsCreateAppRequestBody1(components.V2AppsCreateAppRequestBody1{
					Project: project,
					Name:    name,
					Slug:    slug,
					Git:     git,
				...
				req = components.CreateV2AppsCreateAppRequestBodyUnionV2AppsCreateAppRequestBody2(components.V2AppsCreateAppRequestBody2{
					Project: project,
					Name:    name,
					Slug:    slug,
					Git:     nil,
