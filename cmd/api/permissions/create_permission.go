...
Important: Permission slugs must be unique within the project. Once created, permissions are immediately available for assignment.
...
For full documentation, see https://www.unkey.com/docs/api-reference/v2/permissions/create-permission` + util.Disclaimer,
		...
		Flags: []cli.Flag{
			...
			cli.String("slug", "URL-safe identifier that is unique within the project.", cli.Required(), cli.MutuallyExclusive("body")),
