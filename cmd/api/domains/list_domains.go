...
func listDomainsCmd() *cli.Command {
	return &cli.Command{
		Name:  "list-domains",
		Usage: "List your custom domains with their verification status and DNS records.",
		Description: `List your custom domains with their verification status and DNS records.
...
For full documentation, see https://www.unkey.com/docs/networking/domains` + util.Disclaimer,
		...
		Action: func(ctx context.Context, cmd *cli.Command) error {
			...
			req := components.V2DomainsListDomainsRequestBody{
				Project:     nil,
				App:         nil,
				Environment: nil,
