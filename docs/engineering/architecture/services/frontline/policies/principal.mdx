...
The wire format is authoritative. For the full public reference, see the <a href="https://www.unkey.com/docs/platform/gateway/principal/overview" target="_blank">product docs</a>.
