...
<ResponseField name="identifiers" type="RateLimitIdentifier[]">
...
<ResponseField name="identifier" type="RateLimitIdentifier" deprecated>
...
<Tab title="Per subject and path">
```json
{
  "policies": [
    {
