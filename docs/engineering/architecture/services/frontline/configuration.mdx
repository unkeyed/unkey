...
<ResponseField name="http_port" type="int" default="7070">
  Plain-HTTP listener port. Serves ACME HTTP-01 challenges and 308-redirects everything else to https:// via the edge-redirect engine.
</ResponseField>

<ResponseField name="https_port" type="int" default="7443">
  HTTPS listener port. Terminates TLS, evaluates per-route edge-redirect rules, and forwards customer traffic to the sentinel.
</ResponseField>
