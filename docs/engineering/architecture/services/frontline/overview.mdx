...
Frontline also embeds runtime subsystems when policy execution needs them. Rate limit policies use [rate limiting](/architecture/ratelimiting) rather than a Frontline-owned counter implementation.
