...
- [`sentinel/deploy.go`](https://github.com/unkeyed/unkey/blob/main/svc/ctrl/worker/sentinel/deploy.go) — `SentinelService.Deploy` (sentinel config update + deployment_changes, used for image/resource changes and rollback).
