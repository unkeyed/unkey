...
Log Drains let a workspace forward its runtime logs (deployment stdout/stderr) and request logs (frontline access logs) to a third-party observability backend without operating a sidecar. v1 ships Axiom.
