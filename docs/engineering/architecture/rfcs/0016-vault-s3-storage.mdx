...
Until operators promote the replica, vault keeps using the unavailable primary bucket and requests fail. Operators then change vault configuration to point at the replica bucket and roll every vault instance.
