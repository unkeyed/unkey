...
new path shapes or change parsing rules, but `v1` URNs must keep the behavior
defined here. A permission attaches an action to a URN, but the URN itself
names only the resource.
...
Concrete URNs identify one resource. Pattern matching is defined by the
permission system, not by base URNs.
...
<CardGroup cols={2}>
  <Card title="Workspace" icon="building" href="#workspace">
    Workspace membership and settings.
  </Card>
  <Card title="Billing" icon="receipt" href="#billing">
    Billing state, invoices, and quota.
  </Card>
  <Card title="Keyspaces" icon="key" href="#keyspaces">
    Keyspaces and keys.
  </Card>
  <Card title="Identities" icon="fingerprint" href="#identities">
    Identity records.
  </Card>
  <Card title="Rate limits" icon="gauge" href="#rate-limits">
    Standalone namespaces and overrides.
  </Card>
  <Card title="RBAC" icon="shield" href="#rbac">
    Roles and custom permissions.
  </Card>
  <Card title="Deploy" icon="rocket" href="#deploy">
    Projects, apps, environments, deployments, domains, and variables.
  </Card>
  <Card title="Portal" icon="panel-top" href="#portal">
    Portals, sessions, and branding.
  </Card>
</CardGroup>
...
unkey:v1:ws_123:projects/proj_123/apps/app_456/environments/env_789/deployments/d_abc
unkey:v1:ws_123:projects/proj_123/apps/app_456/environments/env_789/deployments/d_abc/instances/inst_def
```
