...
Bazel uses `BUILD.bazel` files to define targets and dependencies. Gazelle generates these for Go code. Use mise tasks for common operations.
...
If you do not have Bazel installed, install the pinned toolchain with mise:
