...
| Bad | Good |
| --- | --- |
| <Frame><img src="/contributing/quality/screenshot-bad.png" alt="A cropped screenshot of an email input with no surrounding page" width="822" height="180" /></Frame> | <Frame><img src="/contributing/quality/screenshot-good.png" alt="A screenshot of the whole browser window on the sign-in page, with an arrow and a label that point at the email input" width="4264" height="2584" /></Frame> |
