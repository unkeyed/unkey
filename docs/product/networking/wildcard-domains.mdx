...
description: Learn about immutable and sticky wildcard domains that Unkey assigns automatically to every deployment for commit, branch, and environment URLs.
---
