...
description: What happens from the moment a request hits your URL to when your app receives it.
---
...
- [Rate limiting](/platform/sentinel/rate-limiting) enforces request quotas
