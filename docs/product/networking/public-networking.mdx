...
description: Follow the full request lifecycle through DNS resolution, Frontline TLS termination, and Sentinel policy enforcement before traffic reaches your app.
---
