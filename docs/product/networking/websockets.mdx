---
title: WebSockets
description: "Run WebSocket servers on Unkey with long-lived connections, no request timeouts, and automatic scaling for real-time chat, presence, and streaming apps."
---
