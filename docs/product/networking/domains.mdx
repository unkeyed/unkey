...
Custom domain limits are workspace-wide. Starter includes one custom domain,
while Pro and Business include unlimited custom domains. Enterprise limits are
custom. Support can increase the Starter limit for legitimate workloads. See
[Custom domain limits](/limits#plan-limits).
