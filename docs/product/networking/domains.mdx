...
Starter, Pro, and Business plans have a workspace-wide safety quota of 1,000
custom domains. Enterprise quotas are custom. Support can adjust the quota for
legitimate workloads. See [Custom domain limits](/limits#plan-limits).
