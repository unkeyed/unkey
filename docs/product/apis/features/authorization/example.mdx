...
As part of the API, your users will be able to create, read, update, and delete (CRUD) domains or individual DNS records.
...
1. In the sidebar, click one of your APIs.
2. Next, click **Keys** in the expanded API you selected.
    <Frame>
      <img src="/apis/features/authorization/api-keys-navigation.png" alt="Breadcrumb Navigation"/>
    </Frame>

3. On the key you want to use, click the action menu (`...`) at the end of that table row.
