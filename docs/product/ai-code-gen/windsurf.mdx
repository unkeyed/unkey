...
description: "Configure Windsurf AI editor to generate Unkey API key verification and rate limiting code with project-level rules and documentation context."
---
