...
<Step title="Create New Root Key" stepNumber={2}>
  Click "Create New Root Key" and select the permissions you need: - **API Key
  Management**: For creating, updating, and deleting API keys - **Rate
  Limiting**: For configuring rate limits - **Analytics**: For querying usage
  data
</Step>
...
- [Unkey API Reference](/api-reference/auth)
