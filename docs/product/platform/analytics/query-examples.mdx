...
description: "Common SQL query patterns for Unkey Analytics including daily verification counts, per-key usage, billing aggregations, and error rates."
---
...
**Use this for:** Complex analytical patterns, cohort analysis, moving averages, and advanced insights.

**Key patterns:** User retention, trend smoothing, complex joins, and window functions.
