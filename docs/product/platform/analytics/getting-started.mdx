---
title: Set Up Analytics and Run Your First Query
description: "Request access to Unkey Analytics, configure your root key permissions, and run your first SQL query against key verification data with examples."
---
