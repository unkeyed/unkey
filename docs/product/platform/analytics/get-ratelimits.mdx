...
EXCEPT, and joins are supported. The query must contain a positive literal filter
in one of these forms. You can optionally qualify `namespace_id` with a table
alias:
