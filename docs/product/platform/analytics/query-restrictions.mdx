...
description: "Understand the security restrictions for Unkey analytics queries, including allowed SQL statements, table access controls, and approved functions."
---
