...
2. Scroll to the **Danger zone** at the bottom and click **Delete this project**.
3. Type the project name to confirm.
4. Click **Delete project**.

You can also delete a project from the project actions menu (three-dot icon on the project card) in the workspace **Projects** list.
