...
Build settings, runtime configuration, and [gateway policies](/platform/gateways/overview) are configured per app. [Variables](/platform/variables/overview) and [custom domains](/networking/domains) are scoped to an app's environment.
...
| **Requests**    | HTTP request analytics processed by [the gateway](/platform/gateways/overview)                  |
