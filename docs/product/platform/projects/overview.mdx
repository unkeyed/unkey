---
title: Deploy Projects and App Hierarchy
description: "Create and manage deploy projects that map to a codebase. Organize apps, environments, and deployments within your workspace using Unkey Deploy."
---
