---
title: Policies
description: Policies are configurable rules the Sentinel evaluates on every request before forwarding it to your app. Combine multiple policies per route.
---
