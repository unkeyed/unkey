---
title: Sentinel Policy Configuration
description: "Configure Sentinel policies for authentication, rate limiting, IP rules, and request validation. Define match expressions and evaluation order for requests."
---
