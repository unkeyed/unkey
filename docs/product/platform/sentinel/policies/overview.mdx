...
If all matching policies pass, the Sentinel forwards the request to your service.
...
| ---------------------------------------------------------------------- | ----------- | ---------------------------------------------------------- |
| [API key authentication](/platform/sentinel/policies/api-key)          | Available   | Verify Unkey API keys and forward identity to your service  |
| [Logging](/platform/sentinel/policies/logging)                         | Available   | Record full HTTP requests and responses for debugging        |
| [JWT authentication](/platform/sentinel/policies/jwt)                  | Coming soon | Validate Bearer JWTs using JWKS, OIDC, or PEM public keys  |
| [Basic authentication](/platform/sentinel/policies/basic)              | Coming soon | Verify HTTP Basic credentials                               |
| [Rate limiting](/platform/sentinel/policies/rate-limiting)             | Coming soon | Enforce per-IP, per-key, or per-subject rate limits         |
| [IP rules](/platform/sentinel/policies/ip-rules)                       | Coming soon | Allow or deny requests based on CIDR ranges                 |
