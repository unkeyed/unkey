...
description: Use the Sentinel to validate incoming request paths, parameters, headers, and bodies against an OpenAPI 3.0 or 3.1 spec before reaching your app.
---
