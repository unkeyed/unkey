---
title: Rate limiting
description: Configure Sentinel rate limiting policies to enforce request quotas by IP, header, authenticated subject, or URL path with standard response headers.
---
