---
title: Logging
description: Enable the Sentinel logging policy to capture full HTTP request and response data with latency breakdowns for debugging and API observability.
---
