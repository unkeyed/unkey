...
description: Configure the Sentinel to verify Unkey API keys on every request and forward authenticated identity, metadata, roles, and permissions to your app.
---
