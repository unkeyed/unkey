---
title: Sentinel Reverse Proxy
description: "Learn how the Sentinel reverse proxy enforces authentication, rate limiting, and access policies on every request before it reaches your deployed app."
---
