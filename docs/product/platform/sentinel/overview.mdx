...
<Note>
  The Sentinel dashboard is still in development. Today you can configure API key authentication, rate limiting, firewall, and OpenAPI validation policies through the dashboard. For other policy types, contact [support@unkey.com](mailto:support@unkey.com).
</Note>

To configure policies:

1. Navigate to your project's **Sentinel Policies** page.
2. Create a new policy and select the policy type (API key authentication, rate limiting, firewall, or OpenAPI validation).
