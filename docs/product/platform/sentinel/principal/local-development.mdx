...
description: Test Principal-based authentication locally by setting the X-Unkey-Principal header in curl or HTTP clients without running a Sentinel instance.
---
