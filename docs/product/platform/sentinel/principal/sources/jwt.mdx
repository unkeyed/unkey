---
title: JWT
description: Reference for all Principal fields produced by JWT authentication, including decoded header, payload claims, and signature from WorkOS, Clerk, or Auth0.
---
