---
title: API key principal
description: Reference of all Principal fields produced when the Sentinel authenticates a request using an Unkey API key, including key ID and metadata.
---
