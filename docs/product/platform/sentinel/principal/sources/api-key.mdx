---
title: API key
description: Reference for all Principal fields produced by API key authentication, including key ID, keyspace, metadata, roles, permissions, and identity data.
---
