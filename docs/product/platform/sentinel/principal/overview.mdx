---
title: Principal Identity Object Reference
description: "Reference for the Principal JSON object the Sentinel sets on the X-Unkey-Principal header, including subject, identity, source fields, and versioning."
---
