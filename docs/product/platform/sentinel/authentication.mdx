---
title: Sentinel Authentication Flow
description: "Understand how the Sentinel authenticates requests using API keys or JWTs and forwards a verified Principal identity object to your application."
---
