...
Unkey offers multiple plan tiers. Every workspace starts on the Free plan. Paid API Management plans unlock higher monthly request allowances, longer data retention, and [team collaboration](/platform/workspaces/team-members). Compute plans provide usage credits and higher [Compute limits](/limits).
...
See [Compute limits](/limits) for resource limit scope, calculation, and enforcement behavior.
...
Cancellation takes effect at the end of your current billing period. Your workspace continues to operate with paid plan limits until that date. After the period ends, the workspace reverts to the [Free plan limits](#plans).
