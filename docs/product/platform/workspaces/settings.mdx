...
<Note>
  Team members require a paid plan. [Upgrade your plan](/platform/workspaces/billing/api#choose-or-change-a-plan) to access this tab.
</Note>
...
Manage your subscription, payment methods, and invoices. See [Billing](/platform/workspaces/billing/overview) for details on plans, upgrades, and the billing portal.
