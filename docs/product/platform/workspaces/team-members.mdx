...
<Note>
  Team members require a paid plan. Workspaces on the Free plan are limited to a single user. [Upgrade your plan](/platform/workspaces/billing/api#choose-or-change-a-plan) to invite team members.
</Note>
