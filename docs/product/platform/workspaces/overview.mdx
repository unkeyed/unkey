...
- **[Billing](/platform/workspaces/billing/overview)**: every workspace has its own Stripe subscriptions, payment method, and invoices. Usage in one workspace does not affect another.
