---
title: Identities for Grouping API Keys
description: "Group multiple API keys under a single user, organization, or entity. Share rate limits, metadata, and analytics across all keys with identities."
---
