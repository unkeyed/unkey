---
title: Overview
description: "Group multiple API keys under a single identity like a user, team, or organization. Manage shared configuration and rate limits in Unkey."
---
...
try {
  const { meta, data, error } = await unkey.identities.createIdentity({
...
<CardGroup cols={2}>
  <Card
    ...
    icon="gauge-high"
    href="/platform/identities/ratelimits"
  >
