---
title: Shared rate limits across identity keys
description: "Share rate limits across multiple API keys using Unkey identities. Enforce a single quota for all keys belonging to the same entity."
---
...
If _any_ specified limit is exceeded, verification fails.
...
<CardGroup cols={2}>
  <Card
    title="Quickstart"
    icon="rocket"
    href="/quickstart/identities/shared-ratelimits"
  >
  ...
  <Card
    ...
    icon="fingerprint"
    href="/platform/identities/overview"
  >
