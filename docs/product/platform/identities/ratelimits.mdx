...
description: "Enforce a single rate limit across all of a user's API keys by creating an identity, so multiple keys share one request quota instead of stacking."
---
