...
description: "Override default rate limits for specific users or wildcard patterns directly from the Unkey dashboard without code changes or new deployments."
---
...
<Frame>
  <img src="/platform/ratelimiting/new-override.png" alt="New override form" />
</Frame>
...
<Frame>
  <img
    src="/platform/ratelimiting/wildcard-override.png"
    alt="Wildcard override example"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card title="How it works" icon="bolt" href="/platform/ratelimiting/modes">
    Understand rate limiting architecture
  </Card>
  <Card
    title="Multi-ratelimits"
    icon="layer-group"
