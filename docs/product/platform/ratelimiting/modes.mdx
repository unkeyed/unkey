...
description: "Learn how Unkey's sliding window algorithm provides global, low-latency rate limiting without burst exploitation and consistent cross-region enforcement."
---
