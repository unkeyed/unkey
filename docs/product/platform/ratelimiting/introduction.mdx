---
title: Overview
description: "Protect any API endpoint from abuse with Unkey's serverless rate limiting. No Redis or infrastructure required — just a single API call."
---
...
<Steps>
  ...
  <Step title="Add to your code">
    See the [framework guides](/quickstart) for complete examples with Next.js,
    Bun, Express, or Hono.
  </Step>
</Steps>
