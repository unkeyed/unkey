...
description: "Protect any endpoint from abuse with globally distributed rate limiting. No Redis required — configure limits per user, IP, or custom identifier."
---
