...
description: Manage the full API key lifecycle with Unkey including creation, real-time verification, usage tracking, rate limiting, permissions, and revocation.
---
...
<Steps>
  <Step title="Create an API in Unkey">
    An "API" in Unkey is a container for keys. You might have separate APIs for
...
<CardGroup cols={2}>
  ...
  <Card
    title="Expiration"
    icon="clock"
    href="/platform/apis/features/temp-keys"
  >
