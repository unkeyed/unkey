---
title: Live and Test Key Environments
description: "Separate your API keys into live and test environments using prefixes and metadata. Configure different rate limits and sandbox access per environment."
---
