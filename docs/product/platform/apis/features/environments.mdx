---
title: Environments
description: "Separate your API keys into live and test environments so development and testing activity never affects your production key verification flow."
---
