---
title: API key environments (live and test)
description: "Separate your API keys into live and test environments in Unkey. Isolate production traffic from development with environment-scoped keys."
---
