---
title: "Key Rerolling"
description: "Generate a new API key token while preserving all permissions, metadata, rate limits, and credits from the original key with a configurable grace period."
---
