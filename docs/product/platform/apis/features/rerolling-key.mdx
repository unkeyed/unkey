---
title: "Key Rerolling"
description: "Rotate API keys in Unkey while preserving their configuration, permissions, and metadata. Set grace periods for seamless key transitions."
---
...
1. Open the API and navigate to its **Keys** tab.
