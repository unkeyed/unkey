...
description: "Configure multiple named rate limits per API key with auto-apply and manual modes to control request frequency across different operations."
---
