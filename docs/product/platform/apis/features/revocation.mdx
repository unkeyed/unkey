...
description: "Revoke API keys immediately by permanently deleting them or temporarily disabling them for security incidents, offboarding, or suspicious activity."
---
