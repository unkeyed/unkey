...
description: "Pass permission queries during key verification to enforce RBAC with support for single checks, AND/OR logic, and nested permission expressions."
---
