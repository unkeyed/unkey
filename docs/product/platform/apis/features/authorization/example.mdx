---
title: RBAC Example with Domain Management
description: "Walk through a real-world RBAC example creating permissions, roles, and key assignments for a domain management API with Unkey authorization."
---
...
<Frame>
  <img src="/platform/apis/features/authorization/domains-permissions.png" alt="Example permissions"/>
  </Frame>
</Step>
...
<Frame>
  <img src="/platform/apis/features/authorization/domains-roles.png" alt="Example roles"/>
</Frame>
...
<Frame>
  <img src="/platform/apis/features/authorization/domains-roles-admin.png" alt="Admin roles"/>
  </Frame>
</Tab>
...
<Frame>
  <img src="/platform/apis/features/authorization/domains-roles-dns.manager.png" alt="dns.manager roles"/>
  </Frame>
</Tab>
<Tab title="read-only">

<Frame>
  <img src="/platform/apis/features/authorization/domains-roles-read-only.png" alt="read-only roles"/>
  </Frame>
</Tab>
</Tabs>
...
<Frame>
  <img
    src="/platform/apis/features/authorization/api-key-screen.png"
    alt="Unconnected roles and permissions"
  />
</Frame>
...
<Frame>
  <img
    src="/platform/apis/features/authorization/role-add-example.png"
    alt="Unconnected roles and permissions"
  />
</Frame>
