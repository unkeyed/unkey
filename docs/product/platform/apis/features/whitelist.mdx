...
description: "Restrict API key usage to specific IPv4 and IPv6 addresses or CIDR ranges so requests from non-whitelisted IPs are rejected during verification."
---
