...
description: "Disable API keys temporarily to block verification without deleting them, then re-enable to restore access for payment issues or investigations."
---
