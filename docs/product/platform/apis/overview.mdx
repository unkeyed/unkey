---
title: API Resources and Keyspaces
description: "Learn how APIs group related keys, configuration, and analytics in your workspace. Create keyspaces, set prefixes, and manage API settings."
---
