...
description: "Migrate existing API keys to Unkey by importing hashed credentials from PostgreSQL, Auth0, or other systems using the key migration API endpoint."
---
...
<Step title="Create a workspace and API">
  ...
  <Frame>
    <img src="/platform/apis/migrations/your-api.png" alt="API page" />
  </Frame>
</Step>
