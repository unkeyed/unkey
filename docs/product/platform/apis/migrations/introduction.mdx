---
title: Migrate Existing API Keys to Unkey
description: "Move your existing API keys to Unkey without disrupting users. Import key hashes with metadata, roles, rate limits, and expiration settings intact."
---
