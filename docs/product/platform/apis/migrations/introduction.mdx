---
title: API key migration overview
description: "Move your existing API keys to Unkey without disrupting your users. Migrate hashed keys, metadata, and configuration in a single step."
---
