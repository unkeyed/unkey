---
title: Root key permissions
description: "Complete reference of all available root key permissions in Unkey. Scope API access by resource type and action for least-privilege keys."
---
