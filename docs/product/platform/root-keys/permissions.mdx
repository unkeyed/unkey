---
title: Root Key Permissions Reference
description: "Complete reference for root key permissions including API, key, rate limit, RBAC, identity, and deployment scopes with wildcard and resource-specific grants."
---
