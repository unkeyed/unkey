---
title: Root keys overview
description: "Create and manage root keys for programmatic access to the Unkey API. Control permissions, expiration, and scoping for each root key."
---
