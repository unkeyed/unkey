---
title: Root Keys for Unkey API Access
description: "Create, rotate, and manage root keys that authenticate your requests to the Unkey API. Learn permissions, security best practices, and leak response."
---
