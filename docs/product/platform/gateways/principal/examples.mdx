...
These examples show how to parse the [Principal](/platform/gateways/principal/overview) from the `X-Unkey-Principal` header in common frameworks using API key authentication.
