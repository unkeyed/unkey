...
description: "Code examples for reading the gateway Principal object in Hono, Next.js, Express, and Go. Parse the forwarded identity in your framework."
---

These examples show how to parse the [Principal](/platform/gateway/principal/overview) from the `X-Unkey-Principal` header in common frameworks using API key authentication.
...
type KeySource struct {
	...
	Credits     *int64         `json:"credits,omitempty"`   // remaining, nil when unlimited
	Meta        map[string]any `json:"meta"`
