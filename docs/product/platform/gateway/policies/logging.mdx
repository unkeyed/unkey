...
Set `x-unkey-redact: false` when this field does not need redaction. This value
does not disable other redaction rules. Frontline always redacts authorization
headers and credentials that a KeyAuth policy defines.
