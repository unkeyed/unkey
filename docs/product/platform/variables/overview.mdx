...
Variable names can contain up to 256 characters, and values can contain up to
16 KiB. You can submit up to 100 variables in one dashboard operation. See
[Environment variable limits](/limits#environment-variables).
