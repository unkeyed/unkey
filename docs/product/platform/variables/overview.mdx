---
title: Variables
description: "Manage encrypted environment variables scoped per environment with bulk import, search, filtering, and sensitive value protection in the dashboard."
---
