...
The maximum depends on your Compute plan:

| Plan          | Maximum instances per region |
| ------------- | ---------------------------- |
| Starter plan  | 4                            |
| Pro plan      | 8                            |
| Business plan | 16                           |
...
The Starter plan supports up to 2 vCPU per instance, the Pro plan supports up to 8 vCPU, and the Business plan supports up to 16 vCPU.
...
The Starter plan supports up to 2 GiB per instance, the Pro plan supports up to 8 GiB, and the Business plan supports up to 32 GiB.
