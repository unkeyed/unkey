...
CPU allocation for each instance. The dashboard can offer these options:
...
Available options depend on your workspace plan and any approved
workspace-specific limits. CPU billing uses measured usage over time. See
[Compute limits](/limits#plan-limits).

### Memory

Memory allocation for each instance. The dashboard can offer these options:
...
Available options depend on your workspace plan and any approved
workspace-specific limits. Memory billing uses measured usage over time. See
[Compute limits](/limits#plan-limits).
...
The dashboard can offer these options:
...
Available options depend on your workspace plan and any approved
workspace-specific limits. Ephemeral disk billing uses allocated capacity over
time. See [Compute limits](/limits#plan-limits).
