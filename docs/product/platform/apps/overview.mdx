...
A project can contain multiple apps. Each app has its own pair of default environments (production and preview), its own [build and runtime settings](/platform/apps/settings), and its own [gateway configuration](/platform/gateways/overview).
...
| Environment    | Purpose                                                        |
| -------------- | -------------------------------------------------------------- |
| **Production** | Serves live traffic. Gets three [gateway](/platform/gateways/overview) replicas for high availability. |
| **Preview**    | For testing branches before merging. Gets one gateway replica. |
