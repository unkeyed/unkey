---
title: Apps
description: Learn how apps represent deployable services within a project, each with its own environments, Dockerfiles, runtime settings, and Sentinel policies.
---
