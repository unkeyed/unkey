---
title: Log drains
description: "Send audit logs, key verifications, gateway HTTP requests, and runtime logs to HTTPS endpoints or Axiom."
---

A log drain sends workspace audit logs, key verifications, gateway HTTP requests, or runtime logs to a destination
...
one stream: audit logs, key verifications, gateway HTTP requests, or runtime logs.
...
6. Select **Audit logs**, **Key verifications**, **Gateway HTTP requests**, or **Runtime logs** in **Stream**.
