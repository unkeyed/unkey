...
| --- | --- | --- |
| HTTP | Send audit logs to an HTTP collector | Public HTTPS URL, encoding, and optional headers |
| Axiom | Send audit logs to an Axiom dataset | Dataset name and an API token with ingest permission |
...
6. Enter the destination settings.
7. Select **New audit logs** or **All retained audit logs**.
