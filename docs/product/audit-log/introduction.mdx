---
title: Audit Log for API Key Changes
description: "Track every mutation to your API keys, permissions, and workspace settings. Filter audit logs by actor, event type, and time range."
---
