---
title: Overview
description: "Track every change to your API keys, permissions, and workspace configuration with Unkey audit logs. Filter by actor, event type, and time."
---
...
<Frame>
  <img src="/audit-log/audit-log.png" alt="Audit log entries in the Unkey dashboard" />
</Frame>
...
<Frame>
  <img src="/audit-log/audit-workspace-details.png" alt="Audit log entry details showing request and response payloads" />
</Frame>
...
Need longer retention? [Contact support](mailto:support@unkey.com) to request
a workspace-specific increase. See [Retention limits](/limits#retention).
