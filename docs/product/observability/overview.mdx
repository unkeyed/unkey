...
- [Requests](/observability/requests). Every HTTP request that passes through the [gateway](/platform/gateways/overview) to your app, including method, path, status code, headers, bodies, and a full latency breakdown
