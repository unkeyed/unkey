---
title: Observability for Deployments
description: Monitor your Unkey deployments with built-in runtime logs, HTTP request tracing, and latency metrics without adding extra tooling.
---
