...
- [Logs](/observability/logs). Runtime output (stdout and stderr) from your app, with filtering by severity, deployment, environment, and message content. Container lifecycle events (crashes, OOM kills, `CrashLoopBackOff`) appear inline in the timeline and on each deployment's detail page
