---
title: "Nuxt Module"
description: "Integrate Unkey into your Nuxt application with the @unkey/nuxt module for zero-config API key verification, composables, and server middleware."
---
