---
title: "Ratelimit"
description: "Install and configure the @unkey/ratelimit TypeScript library for fast, global rate limiting in serverless functions with async and timeout options."
---
