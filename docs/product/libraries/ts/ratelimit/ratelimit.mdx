---
title: "Ratelimit"
description: "Use @unkey/ratelimit for fast global rate limiting in server-side TypeScript (Node.js, Deno, Bun, Cloudflare Workers, serverless functions). Protect API endpoints from abuse with no Redis or infrastructure required."
---
