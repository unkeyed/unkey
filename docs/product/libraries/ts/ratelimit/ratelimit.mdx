...
description: "Add serverless rate limiting to any TypeScript application with @unkey/ratelimit. No Redis infrastructure required, works globally at the edge."
---
