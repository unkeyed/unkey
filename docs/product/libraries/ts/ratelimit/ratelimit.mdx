---
title: "Ratelimit"
description: "Use @unkey/ratelimit for global rate limiting in Node.js, Deno, Bun, and Cloudflare Workers. Protect API endpoints from abuse with no Redis required."
---
