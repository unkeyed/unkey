---
title: "Ratelimit"
description: "Use @unkey/ratelimit for fast global rate limiting in TypeScript. Protect API endpoints from abuse with no Redis or infrastructure required."
---

`@unkey/ratelimit` is a library for fast global ratelimiting that runs in any JavaScript runtime.

<Card
  icon="github"
  title="github.com/unkeyed/sdks/tree/main/ratelimit/ts"
  href="https://github.com/unkeyed/sdks/tree/main/ratelimit/ts"
/>
