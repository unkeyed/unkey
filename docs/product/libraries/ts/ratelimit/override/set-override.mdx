---
title: "Set Override"
description: "Create or update a rate limit override for a specific identifier using the @unkey/ratelimit TypeScript library with custom limit and duration."
---
