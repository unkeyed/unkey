---
title: "Get Override"
description: "Retrieve a rate limit override for a specific identifier using the @unkey/ratelimit TypeScript library, including its limit, duration, and async setting."
---
