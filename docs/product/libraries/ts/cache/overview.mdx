---
title: "@unkey/cache"
description: "Use @unkey/cache for type-safe, multi-tier caching in TypeScript. Compose memory, Cloudflare, and custom stores with automatic tiering."
---

<Card
  icon="github"
  title="github.com/unkeyed/sdks/tree/main/cache"
  href="https://github.com/unkeyed/sdks/tree/main/cache"
/>
...
This library is the result of a rewrite of our own caching layer after some developers were starting to replicate it. It's used in production by Unkey and others.
...
<Expandable>
  ...
  <ParamField path="fresh" required type="number">
  ...
  <ParamField path="stale" required type="number">
