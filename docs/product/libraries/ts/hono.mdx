---
title: "@unkey/hono"
description: "Add API key authentication to your Hono.js app with @unkey/hono middleware for edge-compatible key verification across all JavaScript runtimes."
---
