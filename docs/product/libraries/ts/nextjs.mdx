---
title: "@unkey/nextjs"
description: "Protect your Next.js route handlers with @unkey/nextjs for type-safe API key verification, automatic error responses, and middleware integration."
---
