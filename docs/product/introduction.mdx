---
title: What is Unkey?
description: "Unkey is an API platform: ship a Dockerfile to a production API in seconds, with key issuance, rate limiting, and analytics built in. Globally distributed, no servers to manage."
---
