---
title: What is Unkey?
description: "Unkey is an API development platform for key management, rate limiting, and usage tracking. Deploy globally with zero infrastructure to manage."
---
