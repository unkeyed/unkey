...
Add glob patterns in your app's **Settings** under **Watch paths**. Unkey skips the deployment if none of the changed files match any pattern. See [App settings](/platform/apps/settings#watch-paths) for the supported pattern syntax.
