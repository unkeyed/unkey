---
title: Overview
description: "Build, deploy, and serve your applications on Unkey infrastructure. Learn about the deployment pipeline, regions, and rollback options."
---
...
Unkey takes your repository and gives you a running application with automatic domains, multi-region routing, rollbacks, and built-in API security through [the gateway](/platform/gateway/overview).
...
- A **GitHub repository** for automatic deployments, or a pre-built Docker image for CLI deploys. See [builds](/builds/overview) for how your source becomes an image.
