---
title: Rollbacks and Promotions
description: "Roll back to a previous deployment instantly or promote a specific version to production. Covers zero-downtime rollback and recovery flows."
---
