...
| **Build concurrency quota**      | Counts against workspace [`builds_concurrent_max`](/build-and-deploy/deployments#build-concurrency) | Does not count, the build happens outside Unkey            |
