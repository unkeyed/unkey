...
description: "Copy this prompt into Claude Code, Cursor, Windsurf, or any coding agent to generate a Dockerfile and .dockerignore that runs correctly on Unkey Deploy."
---
