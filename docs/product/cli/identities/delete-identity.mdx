...
description: "Use the delete-identity command to permanently remove an identity from your workspace for data cleanup, compliance, or entity removal purposes."
---
