---
title: "get-identity"
description: "Use the get-identity command to retrieve an identity by external ID or internal identity ID, returning its metadata and rate limit settings."
---
