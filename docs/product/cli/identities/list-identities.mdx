...
description: "Use the list-identities command to retrieve a paginated list of all identities in your workspace, including metadata and rate limit configs."
---
