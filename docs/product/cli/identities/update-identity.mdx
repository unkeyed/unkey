...
description: "Update an identity metadata, rate limit configuration, and associated properties using the Unkey CLI update-identity command with JSON input."
---
...
<Note>
See the [API reference](/api-reference/v2/identities/update-identity) for the full HTTP endpoint documentation.
</Note>
