...
description: "Update an identity's metadata and rate limit configuration using the Unkey CLI. Modify entity properties without affecting linked API keys."
---
...
unkey api identities update-identity --identity=user_123 --meta='{"plan":"enterprise"}' --output=json
```
</CodeGroup>
