...
The unique name for this role. Must be unique within your project and clearly indicate the role's purpose. Use a descriptive name like `admin`, `content.editor`, or `Billing Manager`. Must be 1-128 characters.
</ParamField>
