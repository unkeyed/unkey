---
title: "create-role"
description: "Use the create-role command to define a new role in your workspace for grouping related permissions and enabling consistent key assignments."
---
