...
Role ID (starting with `role_`) or role name to retrieve. An ID can identify a role in any project in your workspace. A name resolves in the default project. Must be 1-128 characters. Returns complete role information including all assigned permissions.
</ParamField>
