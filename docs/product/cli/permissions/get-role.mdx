---
title: "get-role"
description: "Use the get-role command to retrieve details about a specific role including its description, metadata, and all currently assigned permissions."
---
