...
description: "Use the list-permissions command to retrieve a paginated list of all permissions defined in your workspace, sorted by ID with cursor support."
---
...
<Note>
See the [API reference](/api-reference/v2/permissions/list-permissions) for the full HTTP endpoint documentation.
</Note>
