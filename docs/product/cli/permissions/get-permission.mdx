...
description: "Retrieve details about a specific permission in your Unkey workspace using the CLI including its name, description, and creation date."
---
...
The permission ID or slug to retrieve. An ID can identify a permission in any project in your workspace. A slug resolves in the default project.
</ParamField>
