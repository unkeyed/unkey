...
The ID or name of the role whose directly assigned permissions will be replaced. An ID can identify a role in any project in your workspace. A name resolves in the default project.
</ParamField>
