...
The role ID or name to permanently delete. An ID can identify a role in any project in your workspace. A name resolves in the default project. Must be 1-128 characters.
</ParamField>
