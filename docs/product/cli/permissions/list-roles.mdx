---
title: "list-roles"
description: "Use the list-roles command to retrieve a paginated list of all roles in your workspace along with their assigned permissions for RBAC auditing."
---
