---
title: "migrate-keys"
description: "Migrate pre-hashed API keys from an existing provider into Unkey without requiring your users to regenerate or update their existing credentials."
---
