---
title: "migrate-keys"
description: "Use the migrate-keys command to import pre-hashed API keys from another provider into Unkey so existing credentials continue working seamlessly."
---
