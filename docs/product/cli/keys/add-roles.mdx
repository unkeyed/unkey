---
title: "add-roles"
description: "Use the add-roles command to assign additional roles to an API key without affecting existing role assignments or direct permissions on the key."
---
