---
title: "set-roles"
description: "Replace all roles on an API key with the specified set in a single atomic operation using the Unkey CLI set-roles command for RBAC management."
---
