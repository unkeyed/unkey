---
title: "remove-roles"
description: "Remove specific roles from an API key without affecting direct permissions or other currently assigned roles using the Unkey CLI remove command."
---
