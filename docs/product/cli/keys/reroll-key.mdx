---
title: "reroll-key"
description: "Generate a new API key string while preserving the existing key's configuration, permissions, and metadata using the Unkey CLI reroll command."
---
...
<Note>
See the [API reference](/api-reference/keys/reroll-key) for the full HTTP endpoint documentation.
</Note>
...
Default output shows the request ID, followed by the new key details:
