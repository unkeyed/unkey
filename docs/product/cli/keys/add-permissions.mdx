...
description: "Add one or more permissions to an existing API key without overwriting the current permission set using the Unkey CLI add-permissions command."
---
