...
description: "Use the add-permissions command to grant additional permissions to an API key without removing any existing permissions or role assignments."
---
