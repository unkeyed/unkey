---
title: "update-key"
description: "Update key properties like name, metadata, expiration, rate limits, and enabled status in response to plan or subscription changes via the CLI."
---
