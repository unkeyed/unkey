...
description: "Replace all permissions on an API key with a new specified set in a single atomic operation using the Unkey CLI set-permissions terminal command."
---
