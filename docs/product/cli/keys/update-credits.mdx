...
description: "Update the remaining credit quota on an API key in response to plan changes, billing cycles, or usage-based purchases via the Unkey CLI tool."
---
