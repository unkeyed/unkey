---
title: "whoami"
description: "Look up detailed information about any API key by providing the full key string. Returns the associated key ID, API namespace, and current status."
---
