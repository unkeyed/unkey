---
title: "get-key"
description: "Use the get-key command to retrieve detailed API key information including status, permissions, roles, and metadata for administrative purposes."
---
