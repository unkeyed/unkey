...
description: "Remove specific permissions from an API key using the Unkey CLI without affecting other roles or permissions. Revoke granular access rights."
---
