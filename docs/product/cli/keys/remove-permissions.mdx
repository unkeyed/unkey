...
description: "Use the remove-permissions command to revoke specific direct permissions from an API key while preserving all role-based and other permissions."
---
