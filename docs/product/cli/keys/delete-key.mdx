---
title: "delete-key"
description: "Use the delete-key command to permanently remove an API key, with options for soft deletion preserving audit records or full permanent erasure."
---
