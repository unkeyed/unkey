---
title: "delete-key"
description: "Permanently delete an API key by its unique ID using the Unkey CLI. Use this for user account cleanup or for immediate key revocation tasks."
---
