---
title: "get-api"
description: "Use the get-api command to retrieve information about an API namespace, including its unique identifier and human-readable name via the CLI."
---
