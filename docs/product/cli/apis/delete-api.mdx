---
title: "delete-api"
description: "Permanently delete an API namespace and all its associated keys using the Unkey CLI. This action invalidates every key and cannot be undone."
---
...
<Note>
See the [API reference](/api-reference/v2/apis/delete-api-namespace) for the full HTTP endpoint documentation.
</Note>
