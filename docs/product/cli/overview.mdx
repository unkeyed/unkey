---
title: CLI
description: "Install and use the Unkey CLI to manage API keys, rate limits, permissions, and identities directly from your terminal or CI/CD pipeline scripts."
---
