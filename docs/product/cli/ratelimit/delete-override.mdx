...
description: "Use the delete-override command to permanently remove a rate limit override, reverting affected identifiers to the namespace default limits."
---
