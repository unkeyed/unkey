---
title: "set-override"
description: "Create or update a custom rate limit override for a specific identifier using the Unkey CLI. Bypass namespace defaults for individual users."
---
