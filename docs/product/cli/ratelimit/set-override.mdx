---
title: "set-override"
description: "Create or update a custom rate limit for specific identifiers that bypasses the namespace default, using the Unkey CLI set-override command."
---
