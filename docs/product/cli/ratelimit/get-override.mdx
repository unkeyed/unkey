---
title: "get-override"
description: "Use the get-override command to inspect the configuration of a specific rate limit override, including its limit, duration, and identifier pattern."
---
