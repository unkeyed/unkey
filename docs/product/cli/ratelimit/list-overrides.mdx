...
description: "Retrieve a paginated list of all rate limit overrides configured in a namespace using the Unkey CLI. Review custom limits for each identifier."
---
...
<Note>
See the [API reference](/api-reference/v2/ratelimit/list-ratelimit-overrides) for the full HTTP endpoint documentation.
</Note>
