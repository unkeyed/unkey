...
description: "Use the list-overrides command to retrieve a paginated list of all rate limit overrides configured within a specific namespace for auditing."
---
