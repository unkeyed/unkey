---
title: "multi-limit"
description: "Use the multi-limit command to check and enforce multiple independent rate limits across different namespaces in a single efficient CLI request."
---
