---
title: Express
description: Add Unkey API key authentication to your Express server with a protected route that rejects requests without valid keys in about 5 minutes.
---
