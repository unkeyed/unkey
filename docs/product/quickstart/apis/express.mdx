---
title: Express API key quickstart
description: Protect your Express API routes with Unkey API key verification. Add authentication middleware in minutes with the @unkey/api SDK.
---
