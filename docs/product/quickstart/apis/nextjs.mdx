---
title: Next.js
description: Protect your Next.js API routes with Unkey key verification so that invalid or missing API keys are rejected with a 401 unauthorized response.
---
