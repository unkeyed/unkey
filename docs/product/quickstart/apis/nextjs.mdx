---
title: Next.js API key quickstart
description: Protect your Next.js API routes with Unkey API key verification. Add authentication to App Router or Pages Router endpoints quickly.
---
