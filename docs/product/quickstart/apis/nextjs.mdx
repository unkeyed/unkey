---
title: Authenticate API keys in Next.js
description: "Add API key authentication to your Next.js API routes using Unkey. Verify keys in route handlers to protect your server-side endpoints."
---
...
Get a root key from _Settings → Root Keys_ and add it to your environment:
