---
title: Authenticate API keys in Bun
description: "Add API key authentication to your Bun server with Unkey. Verify keys on each request to protect your endpoints in a few lines of code."
---
...
<Card
  ...
  icon="github"
  href="https://github.com/unkeyed/examples/tree/main/bun-server"
>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="gauge-high"
    href="/quickstart/ratelimiting/bun"
  >
