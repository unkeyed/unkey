---
title: Bun
description: Build a Bun HTTP server with Unkey API key verification in about 3 minutes, rejecting invalid or missing keys with a 401 unauthorized response.
---
