---
title: Bun API key quickstart
description: "Protect your Bun HTTP server with Unkey API key authentication in minutes. Verify keys on every request with a few lines of TypeScript code."
---
