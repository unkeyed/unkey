---
title: Authenticate API keys in Hono
description: "Add API key authentication to your Hono application using Unkey middleware. Protect routes with automatic key verification on requests."
---
