---
title: Hono
description: Set up Unkey API key authentication in a Hono app using the @unkey/hono middleware to protect all routes or specific endpoints in about 5 minutes.
---
