---
title: Hono API key quickstart
description: "Protect your Hono API routes with Unkey middleware for API key verification. Add request authentication with the @unkey/hono middleware package."
---
...
<Card
  ...
  icon="github"
  href="https://github.com/unkeyed/examples/tree/main/hono"
>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="gauge-high"
    href="/platform/apis/features/ratelimiting/overview"
  >
  ...
  <Card
    ...
    icon="user-shield"
    href="/platform/apis/features/authorization/introduction"
  >
...
<Accordion title="Environment variables not loading?">
  ...
  <Accordion title="Deploying to Cloudflare Workers?">
    Use wrangler secrets for your root key: ```bash npx wrangler secret put
    UNKEY_ROOT_KEY ``` Then access it from your Hono bindings. Add
    `UNKEY_ROOT_KEY` to your `Bindings` type and read it via
    `ctx.env.UNKEY_ROOT_KEY` or `env.UNKEY_ROOT_KEY` in your handlers.
  </Accordion>
</AccordionGroup>
