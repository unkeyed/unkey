...
description: "Give your end users a white-labeled self-service portal for API key management and docs, with a Stripe-style session auth flow."
hidden: true
noindex: true
---
...
The Customer Portal is a white-labeled web app you can offer to your end users. They get key management and API documentation, without you building any UI.
