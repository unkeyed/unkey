...
// data.id   — the session's identifier (not a credential)
// data.url  — portal URL carrying a single-use code, valid 15 minutes
```
...
|-------|--------|----------|-------|
| Session id | `ps_` | — | Not a credential; identifies the session |
