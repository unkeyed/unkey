...
description: "Deploy your first app on Unkey by creating a project, connecting a GitHub repository, configuring build settings, and getting a live URL in minutes."
---
