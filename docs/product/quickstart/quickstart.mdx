---
title: "Get Started with API Key Verification"
description: "Create and verify your first Unkey API key in under 5 minutes with this step-by-step guide. Includes cURL, TypeScript, Python, and Go examples."
---
...
Root keys authenticate _your_ requests to the Unkey API (for creating and managing keys).
