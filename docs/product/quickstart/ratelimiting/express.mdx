---
title: Rate limiting with Express
description: "Add serverless rate limiting to your Express API routes using Unkey. Configure per-route limits and protect endpoints without Redis."
---
