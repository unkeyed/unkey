---
title: Express
description: Add global rate limiting to Express API endpoints using the @unkey/ratelimit library, returning 429 responses when users exceed request limits.
---
