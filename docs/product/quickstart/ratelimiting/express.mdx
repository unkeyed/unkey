---
title: Express
description: "Add rate limiting to your Express API routes using Unkey middleware. Configure per-route limits and protect endpoints from abuse without running Redis."
---
