---
title: Rate limit a Bun server
description: "Add serverless rate limiting to your Bun server using Unkey. Protect endpoints from abuse with configurable limits and no Redis required."
---
