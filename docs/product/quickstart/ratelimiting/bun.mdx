---
title: Bun rate limiting quickstart
description: Add serverless rate limiting to your Bun HTTP server with the @unkey/ratelimit SDK. Protect endpoints without Redis or infrastructure.
---
