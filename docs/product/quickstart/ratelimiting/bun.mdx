---
title: Bun
description: "Add rate limiting to your Bun HTTP server using the Unkey SDK. Protect endpoints from abuse with configurable per-route limits and no Redis required."
---
