---
title: Hono rate limiting quickstart
description: Add serverless rate limiting to your Hono API routes with the @unkey/ratelimit SDK. Protect endpoints without Redis or infrastructure.
---
