---
title: Rate limit a Hono application
description: "Add serverless rate limiting to your Hono application using Unkey. Protect API routes from abuse with configurable limits, no Redis needed."
---
