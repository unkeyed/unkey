---
title: Hono
description: "Add rate limiting to your Hono application with Unkey middleware. Protect API routes from abuse using configurable per-route limits with no Redis required."
---
