---
title: Next.js rate limiting quickstart
description: Add serverless rate limiting to your Next.js API routes with the @unkey/ratelimit SDK. Protect endpoints without Redis infrastructure.
---
...
The identifier determines _who_ gets rate limited. Common choices:
