---
title: Rate limiting with Next.js
description: "Add serverless rate limiting to your Next.js API routes using Unkey. Protect endpoints from abuse with configurable limits, no Redis needed."
---
