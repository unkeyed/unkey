---
title: Next.js
description: "Add rate limiting to your Next.js API routes and route handlers using Unkey. Protect endpoints from abuse with configurable limits and no Redis required."
---
