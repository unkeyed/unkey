---
title: Shared rate limits quickstart
description: "Create your first identity to share rate limits across multiple API keys. Link keys to a single user and enforce a unified usage quota."
---
