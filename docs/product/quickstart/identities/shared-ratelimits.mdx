...
description: Step-by-step guide to creating an identity with shared rate limits, linking API keys to it, and verifying that all keys share a single request quota.
---
