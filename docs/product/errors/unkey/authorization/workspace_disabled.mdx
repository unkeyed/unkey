...
description: "Error workspace_disabled (HTTP 403) means all API keys in the workspace are blocked. Causes include billing issues or policy violations. Learn to fix it."
---
