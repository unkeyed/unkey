...
description: "The workspace_disabled error means your workspace has been deactivated. Contact support or check billing status to restore workspace access."
---
