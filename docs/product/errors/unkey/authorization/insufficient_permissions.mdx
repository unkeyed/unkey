...
description: "Error insufficient_permissions (HTTP 403) means your API key lacks required permissions for the operation. Learn how to check and assign correct roles."
---
