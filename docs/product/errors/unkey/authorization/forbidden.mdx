---
title: "forbidden"
description: "Authorization error forbidden (HTTP 403) means the operation is blocked by platform policy regardless of your permissions. Learn why and find alternatives."
---
