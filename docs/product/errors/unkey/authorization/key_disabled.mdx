---
title: "key_disabled"
description: "Error code key_disabled (HTTP 403) occurs when your Unkey API key has been deactivated. Learn why keys get disabled and how to re-enable or replace them."
---
