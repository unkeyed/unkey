...
description: "A precondition check failed before the operation could proceed. Learn common causes like conflicting state or unmet resource requirements."
---
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/errors/unkey/application/precondition_failed"
  }
}
```
