---
title: "invalid_input"
description: "Error invalid_input (HTTP 400) triggers when request data fails validation. Understand common causes like missing fields or range violations and fixes."
---
