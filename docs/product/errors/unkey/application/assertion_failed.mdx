...
description: "A runtime assertion or invariant check failed in Unkey. Learn what causes this internal error and how to report it if you encounter it."
---

<Danger>`err:unkey:application:assertion_failed`</Danger>
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/errors/unkey/application/assertion_failed"
  }
}
```
