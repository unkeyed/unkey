---
title: "deployment_already_stopping"
...
<Danger>`err:unkey:application:deployment_already_stopping`</Danger>
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/errors/unkey/application/deployment_already_stopping"
  }
}
```
