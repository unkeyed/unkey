...
description: "An unhandled or unexpected error occurred in Unkey. Learn how to report this issue and what information to include for faster resolution."
---
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/errors/unkey/application/unexpected_error"
  }
}
```
