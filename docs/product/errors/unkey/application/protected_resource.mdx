...
description: "Error protected_resource (HTTP 403) occurs when you try to modify or delete a system-protected resource. Learn why it is protected and find workarounds."
---
