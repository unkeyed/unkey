...
description: "You attempted to modify or delete a resource with delete protection enabled. Disable protection in the dashboard before retrying the operation."
---
