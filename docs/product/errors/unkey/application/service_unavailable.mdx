...
description: "An Unkey service is temporarily unavailable. Learn about automatic retries, backoff strategies, and how to check Unkey's system status page."
---
...
```json Example
{
  ...
  "error": {
    ...
    "type": "https://unkey.com/docs/errors/unkey/application/service_unavailable"
  }
}
```
