...
description: "Error permission_already_exists (HTTP 409) means a permission with this slug already exists. Use a unique name or update the existing permission instead."
---
