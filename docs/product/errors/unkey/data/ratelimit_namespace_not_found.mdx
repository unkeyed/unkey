...
description: "Error ratelimit_namespace_not_found (HTTP 404) means the rate limit namespace does not exist. Check for typos, verify the name, or create a new namespace."
---
