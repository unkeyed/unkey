...
description: "The requested rate limit namespace was not found in Unkey. Verify the namespace ID or name is correct and the namespace has not been deleted."
---

<Danger>err:unkey:data:ratelimit_namespace_not_found</Danger>
...
```json Example
{
  ...
  "error": {
    ...
    "status": 404,
    "title": "Not Found",
    "type": "https://unkey.com/docs/errors/unkey/data/ratelimit_namespace_not_found"
  }
}
```
