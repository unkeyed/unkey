---
title: "api_not_found"
description: "Error api_not_found (HTTP 404) occurs when the specified API ID does not exist in your workspace. Verify the ID, check for deletions, or create a new API."
---
