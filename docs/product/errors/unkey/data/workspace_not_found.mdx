...
description: "Error workspace_not_found (HTTP 404) means the workspace ID or name does not match any existing workspace. Check your dashboard for valid identifiers."
---

<Danger>err:unkey:data:workspace_not_found</Danger>
