...
description: "The workspace_not_found error means the specified workspace does not exist or you lack access. Verify the workspace ID and your permissions."
---
