...
description: "The requested workspace was not found in Unkey. Verify the workspace ID is correct in your root key and that your workspace has not been deleted."
---
