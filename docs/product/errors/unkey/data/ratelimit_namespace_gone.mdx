...
description: "The rate limit namespace has been deleted and can no longer be used. Create a new namespace or check that you are referencing the correct one."
---
