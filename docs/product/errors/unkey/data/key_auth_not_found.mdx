...
description: "Error key_auth_not_found (HTTP 404) means the key authentication record does not exist. Verify the key auth ID and check if the associated key was deleted."
---

<Danger>err:unkey:data:key_auth_not_found</Danger>
