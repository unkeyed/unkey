---
title: "Data error: key_not_found"
description: "The requested API key was not found in Unkey. Verify the key ID is correct, the key has not been deleted, and it belongs to your workspace."
---

<Danger>err:unkey:data:key_not_found</Danger>
