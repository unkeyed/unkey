---
title: "key_not_found"
description: "Data error key_not_found (HTTP 404) occurs when an API key ID does not match any existing key. Verify the ID, check for deletion, or list workspace keys."
---
