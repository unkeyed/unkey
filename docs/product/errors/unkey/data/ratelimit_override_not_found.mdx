...
description: "Error ratelimit_override_not_found (HTTP 404) means no rate limit override exists for that identifier. List overrides in the namespace or create a new one."
---
