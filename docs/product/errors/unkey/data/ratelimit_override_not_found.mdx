...
description: "The ratelimit_override_not_found error means no override exists for this identifier. Create an override or check the identifier and namespace."
---
