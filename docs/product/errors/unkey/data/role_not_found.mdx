...
description: "Error role_not_found (HTTP 404) means the specified role ID or name does not exist in your workspace. List available roles to find valid IDs or create one."
---

<Danger>err:unkey:data:role_not_found</Danger>
