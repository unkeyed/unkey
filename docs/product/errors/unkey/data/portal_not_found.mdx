...
description: "No portal matched the provided slug for your workspace. Verify the slug or contact Unkey to provision a portal."
---
...
This error occurs when you call `POST /v2/portal.createSession` with a `slug` that does not match a portal in your workspace.
...
- [err:unkey:authentication:portal_token_missing](../authentication/portal_token_missing) - When a portal access token is required but not provided
