...
description: "Error role_already_exists (HTTP 409) means a role with this name already exists in your workspace. Use a unique name or retrieve the existing role instead."
---
