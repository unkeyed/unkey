...
description: "A role with this name already exists in the project. Use the existing role or choose a different name."
---
...
This error occurs when you create a role with a name that already exists in the target project. Role names must be unique within each project. The same name can exist in a different project.
