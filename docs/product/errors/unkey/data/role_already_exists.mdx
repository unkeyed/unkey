...
description: "A role with this name already exists in your Unkey workspace. Use the existing role or choose a different unique name when creating a new one."
---
