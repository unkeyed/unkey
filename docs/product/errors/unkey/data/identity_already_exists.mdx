...
description: "Error identity_already_exists (HTTP 409) means an identity with this external ID already exists. Use the update endpoint or get-or-create pattern instead."
---

<Danger>err:unkey:data:identity_already_exists</Danger>
