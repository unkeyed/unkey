...
description: "Error identity_not_found (HTTP 404) means the specified identity or external ID does not exist. Verify the identifier or create a new identity resource."
---

<Danger>err:unkey:data:identity_not_found</Danger>
