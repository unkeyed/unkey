...
description: "The requested permission was not found in Unkey. Verify the permission ID is correct and it exists within your workspace's RBAC configuration."
---

<Danger>err:unkey:data:permission_not_found</Danger>
...
```json Example
{
  ...
  "error": {
    ...
    "status": 404,
    "title": "Not Found",
    "type": "https://unkey.com/docs/errors/unkey/data/permission_not_found"
  }
}
```
