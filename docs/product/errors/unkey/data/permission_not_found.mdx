...
description: "Error permission_not_found (HTTP 404) means the specified permission ID or name does not exist. List workspace permissions to find valid IDs or create one."
---
