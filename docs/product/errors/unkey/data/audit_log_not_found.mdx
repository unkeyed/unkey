...
description: "The requested audit log entry was not found in Unkey. Verify the audit log ID is correct, and that the entry exists within your retention period."
---

<Danger>err:unkey:data:audit_log_not_found</Danger>
...
```json Example
{
  ...
  "error": {
    ...
    "status": 404,
    "title": "Not Found",
    "type": "https://unkey.com/docs/errors/unkey/data/audit_log_not_found"
  }
}
```
