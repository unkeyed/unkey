...
description: "Error audit_log_not_found (HTTP 404) means the specified audit log entry does not exist or has expired. Check the log ID and workspace retention period."
---
