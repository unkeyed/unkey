---
title: "missing"
description: "Authentication error missing (HTTP 401) means no API key was included in the Authorization header. Learn how to add the required Bearer token to requests."
---
