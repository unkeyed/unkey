---
title: "malformed"
description: "Authentication error malformed (HTTP 401) means your API key format is invalid. Fix issues like a missing Bearer prefix or truncated credentials."
---
