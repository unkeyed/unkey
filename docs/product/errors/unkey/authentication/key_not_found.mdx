---
title: "key_not_found"
description: "The authentication key was not found in the Unkey database. This occurs when a key has been deleted, expired, or was never created. Verify the key."
---
...
```json Example
{
  ...
  "error": {
    ...
    "status": 401,
    "title": "Unauthorized",
    "type": "https://unkey.com/docs/errors/unkey/authentication/key_not_found"
  }
}
```
