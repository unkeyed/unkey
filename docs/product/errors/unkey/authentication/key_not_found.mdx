---
title: "key_not_found"
description: "Authentication error key_not_found (HTTP 401) occurs when the provided API key does not exist. Common causes include deleted or mistyped keys."
---
