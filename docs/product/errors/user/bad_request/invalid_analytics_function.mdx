...
description: "The invalid_analytics_function error means your query uses a disallowed SQL function. Use only the supported aggregate and scalar functions."
---
