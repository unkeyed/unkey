...
description: "Error invalid_analytics_function (HTTP 400) means your query uses a blocked function like file() or url(). See which functions are allowed in analytics."
---
