...
description: "Error query_range_exceeds_retention (HTTP 400) means your query accesses data beyond the retention period. Narrow the time range or upgrade retention."
---
