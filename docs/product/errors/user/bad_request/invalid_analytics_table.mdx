...
| `analytics.getGatewayRequests` | `gateway_requests_per_minute_v1` | Minute-level aggregates |
| `analytics.getGatewayRequests` | `gateway_requests_per_hour_v1` | Hour-level aggregates |
| `analytics.getGatewayRequests` | `gateway_requests_per_day_v1` | Day-level aggregates |
