...
description: "Error invalid_analytics_table (HTTP 400) means your query references a nonexistent or blocked table. See the list of allowed analytics tables and names."
---
