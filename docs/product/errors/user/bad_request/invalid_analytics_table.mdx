...
description: "The invalid_analytics_table error means your query references a nonexistent or disallowed table. Check the schema reference for valid tables."
---
