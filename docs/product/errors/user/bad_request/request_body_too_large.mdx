...
description: "Error request_body_too_large (HTTP 413) means your request payload exceeds the size limit. Trim metadata, store large data externally, and send references."
---
