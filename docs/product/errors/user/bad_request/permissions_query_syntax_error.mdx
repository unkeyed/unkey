...
description: "Your verifyKey permissions query contains invalid syntax or unsupported characters. Review the permissions query format and fix the expression."
---
