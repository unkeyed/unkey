...
description: "Error permissions_query_syntax_error (HTTP 400) means the verifyKey permissions query has invalid syntax. Fix unmatched parentheses or misplaced operators."
---
