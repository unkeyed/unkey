...
description: "Error request_body_unreadable (HTTP 400) means the server could not read the request body due to malformed data or a dropped connection. Check formatting."
---
