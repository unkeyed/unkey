...
description: "Error invalid_analytics_query_type (HTTP 400) means you used a non-SELECT query like INSERT or DELETE. Analytics only supports read-only SELECT queries."
---
