...
description: "Error query_quota_exceeded (HTTP 429) means your workspace hit the hourly analytics query limit. Cache results, batch queries, or wait for the reset."
---
