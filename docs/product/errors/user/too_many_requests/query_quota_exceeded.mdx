...
description: "You have exceeded your workspace's analytics query quota for the current time window in Unkey. Wait for the quota to reset or upgrade your plan."
---
...
If you're making multiple queries, try to combine them into a single query with subqueries or a `UNION`.
