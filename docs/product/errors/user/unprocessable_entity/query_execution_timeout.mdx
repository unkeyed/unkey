...
description: "Error query_execution_timeout (HTTP 422) means your analytics query exceeded the 30s limit. Use smaller time ranges, add filters, or use aggregated tables."
---
