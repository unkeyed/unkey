...
description: "Error query_memory_limit_exceeded (HTTP 422) means your analytics query surpassed the 2GB memory cap. Use aggregations, add filters, or limit result size."
---
