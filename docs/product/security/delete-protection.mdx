...
description: "Enable delete protection on Unkey resources to prevent accidental deletion. Protected resources require you to disable protection before removal."
---
...
<Frame caption="Delete Protection">
  <img
    src="/images/delete-protection.png"
    alt="Delete Protection confirmation dialog showing the Enable Keyspace Delete Protection button"
  />
</Frame>
