...
description: Enable delete protection on APIs and other resources to prevent accidental deletion through the dashboard or API, requiring explicit confirmation.
---
...
<Frame caption="Delete Protection">
  <img
    ...
    alt="Delete Protection confirmation dialog showing the Enable API Delete Protection button"
  />
</Frame>
