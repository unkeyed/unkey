---
title: Overview
description: "Learn how Unkey protects your API keys and data with encryption at rest, secure key hashing, workspace isolation, and access controls."
---
...
We're have SOC 2 Type II certification. If you have specific compliance requirements, [contact us](mailto:support@unkey.com) to discuss.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="user-shield"
    href="/platform/root-keys/overview"
  >
  ...
  <Card
    ...
    icon="filter"
    href="/platform/apis/features/whitelist"
  >
  ...
  <Card
    ...
    icon="trash-can"
    href="/security/delete-protection"
  >
