---
title: Security Architecture and Key Storage
description: "Learn how Unkey secures your API keys with SHA-256 hashing, TLS 1.3 transport encryption, and audit logging. Review infrastructure security and compliance."
---
