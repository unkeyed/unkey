...
description: "Unkey partners with GitHub Secret Scanning to automatically detect leaked root keys in repositories, commits, PRs, issues, gists, and npm packages."
---
