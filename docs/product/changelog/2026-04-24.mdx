---
title: "April 24, 2026"
description: "New unkey.com, our $4.5M seed round, Deploy enters public beta, redesigned roles and permissions tables, and a Dockerfile AI prompt."
noindex: true
---

Unkey's brand new website launched this week at [unkey.com](https://www.unkey.com), built by the team at [Pixel Point](https://pixelpoint.io/). We also announced our [$4.5M seed round](https://www.unkey.com/blog/unkey-raises-seed) led by Uncork Capital, with Essence VC, Sunflower Capital, and others joining. It funds the bet behind everything below: making Unkey the fastest path from code to a production API.
