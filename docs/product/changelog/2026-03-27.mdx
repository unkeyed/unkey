---
title: "March 27, 2026"
description: "New full-featured CLI for managing API keys and rate limits from the terminal, improved keys overview table with sorting, and onboarding fixes."
---
