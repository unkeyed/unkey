---
title: "Glossary"
description: "Definitions of key terms and concepts used throughout the Unkey platform including workspaces, APIs, keys, identities, rate limiting, and root keys."
---
