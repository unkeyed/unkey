---
title: "Unkey Glossary of Terms and Concepts"
description: "Definitions of Unkey concepts including workspaces, API keys, root keys, rate limits, permissions, roles, identities, and verification codes."
---
