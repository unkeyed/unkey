...
You **must** update your root key to include the `api.<API_ID>.verify_key` permission to verify keys in v2.

[Learn more](/api-reference/v1/migration/keys#understanding-v2-root-key-permissions-for-key-verification)
</Danger>

The Unkey API uses HTTP RPC-style methods and generally follows the schema:
