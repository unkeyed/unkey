...
description: "Apply different rate limits based on user subscription tiers using Unkey. Give free, pro, and enterprise users separate request quotas."
---
...
Instead of managing limits in your code, use [Unkey overrides](/platform/ratelimiting/overrides) to set per-user limits dynamically:
