...
description: "Apply different rate limits per user based on subscription tier, role, or plan using Unkey, without hardcoding limits in your application code."
---
