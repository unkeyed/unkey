...
description: "Protect Next.js App Router and Pages Router API routes with Unkey authentication using the @unkey/nextjs wrapper or manual key verification."
---
...
<Warning>
  Never expose `UNKEY_ROOT_KEY` to the client. It should only be used in
  server-side code.
</Warning>
