...
description: "Configure different rate limits per API endpoint using Unkey, with path-based matching for expensive routes like AI generation and data exports."
---
