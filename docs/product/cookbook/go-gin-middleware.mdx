...
description: "Build production-ready API key authentication middleware for the Go Gin framework using Unkey. Verify keys with automatic error handling."
---
    ...
    api.Use(UnkeyAuth())
    {
        api.GET("/data", func(c *gin.Context) {
            ...
            if result.Identity != nil {
                identityExternalID = result.Identity.ExternalID
            }
