---
title: "Cookbook: Recipes and Integration Guides"
description: "Production-ready, copy-paste recipes for Unkey API key authentication, rate limiting, and usage-based billing across popular frameworks."
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="react"
    href="/cookbook/nextjs-api-routes"
  >
  ...
  <Card
    ...
    icon="node-js"
    href="/cookbook/express-middleware"
  >
  ...
  <Card
    ...
    icon="python"
    href="/cookbook/python-flask-auth"
  >
  ...
  <Card
    ...
    icon="code"
    href="/cookbook/go-stdlib-middleware"
  >
  ...
  <Card
    ...
    icon="code"
    href="/cookbook/go-gin-middleware"
  >
  ...
  <Card
    ...
    icon="code"
    href="/cookbook/go-echo-middleware"
  >
  ...
  <Card
    ...
    icon="cloud"
    href="/cookbook/cloudflare-workers"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="user"
    href="/cookbook/per-user-ratelimit"
  >
  ...
  <Card
    ...
    icon="route"
    href="/cookbook/endpoint-ratelimit"
  >
  ...
  <Card
    ...
    icon="python"
    href="/cookbook/python-fastapi-ratelimit"
  >
