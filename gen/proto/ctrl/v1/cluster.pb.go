...
func (x *ReportSentinelStatusRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_ctrl_v1_cluster_proto_rawDesc = "" +
	...
	"\x06change\" \n" +
	"\x1eReportDeploymentStatusResponse\"\x85\x01\n" +
	"\x1bReportSentinelStatusRequest\x12\x0e\n" +
	...
	"\n" +
	"memory_mib\x18\b \x01(\x03R\tmemoryMib\"1\n" +
