...
// 	protoc        (unknown)
// source: frontline/policies/v1/jwtauth.proto
...
func (x *JWTAuth) Reset() {
	*x = JWTAuth{}
	mi := &file_frontline_policies_v1_jwtauth_proto_msgTypes[0]
...
func (*JWTAuth) Descriptor() ([]byte, []int) {
	return file_frontline_policies_v1_jwtauth_proto_rawDescGZIP(), []int{0}
}
...
var File_frontline_policies_v1_jwtauth_proto protoreflect.FileDescriptor

const file_frontline_policies_v1_jwtauth_proto_rawDesc = "" +
	"\n" +
	"#frontline/policies/v1/jwtauth.proto\x12\ffrontline.v1\"\xec\x02\n" +
	"\aJWTAuth\x12\x1b\n" +
	...
	"\vjwks_sourceB\xae\x01\n" +
	"\x10com.frontline.v1B\fJwtauthProtoP\x01Z;github.com/unkeyed/unkey/gen/proto/frontline/v1;frontlinev1\xa2\x02\x03FXX\xaa\x02\fFrontline.V1\xca\x02\fFrontline\\V1\xe2\x02\x18Frontline\\V1\\GPBMetadata\xea\x02\rFrontline::V1b\x06proto3"

var (
	file_frontline_policies_v1_jwtauth_proto_rawDescOnce sync.Once
	file_frontline_policies_v1_jwtauth_proto_rawDescData []byte
)

func file_frontline_policies_v1_jwtauth_proto_rawDescGZIP() []byte {
	file_frontline_policies_v1_jwtauth_proto_rawDescOnce.Do(func() {
		file_frontline_policies_v1_jwtauth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_frontline_policies_v1_jwtauth_proto_rawDesc), len(file_frontline_policies_v1_jwtauth_proto_rawDesc)))
	})
	return file_frontline_policies_v1_jwtauth_proto_rawDescData
}

var file_frontline_policies_v1_jwtauth_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_frontline_policies_v1_jwtauth_proto_goTypes = []any{
	(*JWTAuth)(nil), // 0: frontline.v1.JWTAuth
}
var file_frontline_policies_v1_jwtauth_proto_depIdxs = []int32{
...
func init() { file_frontline_policies_v1_jwtauth_proto_init() }
func file_frontline_policies_v1_jwtauth_proto_init() {
	if File_frontline_policies_v1_jwtauth_proto != nil {
		return
	}
	file_frontline_policies_v1_jwtauth_proto_msgTypes[0].OneofWrappers = []any{
		(*JWTAuth_JwksUri)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_frontline_policies_v1_jwtauth_proto_rawDesc), len(file_frontline_policies_v1_jwtauth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_frontline_policies_v1_jwtauth_proto_goTypes,
		DependencyIndexes: file_frontline_policies_v1_jwtauth_proto_depIdxs,
		MessageInfos:      file_frontline_policies_v1_jwtauth_proto_msgTypes,
	}.Build()
	File_frontline_policies_v1_jwtauth_proto = out.File
	file_frontline_policies_v1_jwtauth_proto_goTypes = nil
	file_frontline_policies_v1_jwtauth_proto_depIdxs = nil
}
