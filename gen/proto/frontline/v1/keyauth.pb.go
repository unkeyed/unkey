...
// 	protoc        (unknown)
// source: frontline/policies/v1/keyauth.proto
...
func (x *KeyAuth) Reset() {
	*x = KeyAuth{}
	mi := &file_frontline_policies_v1_keyauth_proto_msgTypes[0]
...
func (*KeyAuth) Descriptor() ([]byte, []int) {
	return file_frontline_policies_v1_keyauth_proto_rawDescGZIP(), []int{0}
}
...
var File_frontline_policies_v1_keyauth_proto protoreflect.FileDescriptor
...
const file_frontline_policies_v1_keyauth_proto_rawDesc = "" +
	...
	"\vquery_param\x18\x03 \x01(\v2#.frontline.v1.QueryParamKeyLocationH\x00R\n" +
	"queryParamB\n" +
	"\n" +
	"\blocation\"\x15\n" +
	...
	"\x04name\x18\x01 \x01(\tR\x04nameB\xae\x01\n" +
	"\x10com.frontline.v1B\fKeyauthProtoP\x01Z;github.com/unkeyed/unkey/gen/proto/frontline/v1;frontlinev1\xa2\x02\x03FXX\xaa\x02\fFrontline.V1\xca\x02\fFrontline\\V1\xe2\x02\x18Frontline\\V1\\GPBMetadata\xea\x02\rFrontline::V1b\x06proto3"

var (
	file_frontline_policies_v1_keyauth_proto_rawDescOnce sync.Once
	file_frontline_policies_v1_keyauth_proto_rawDescData []byte
)

func file_frontline_policies_v1_keyauth_proto_rawDescGZIP() []byte {
	file_frontline_policies_v1_keyauth_proto_rawDescOnce.Do(func() {
		file_frontline_policies_v1_keyauth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_frontline_policies_v1_keyauth_proto_rawDesc), len(file_frontline_policies_v1_keyauth_proto_rawDesc)))
	})
...
func file_frontline_policies_v1_keyauth_proto_init() {
	if File_frontline_policies_v1_keyauth_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_frontline_policies_v1_keyauth_proto_goTypes,
		DependencyIndexes: file_frontline_policies_v1_keyauth_proto_depIdxs,
		MessageInfos:      file_frontline_policies_v1_keyauth_proto_msgTypes,
	}.Build()
	File_frontline_policies_v1_keyauth_proto = out.File
	file_frontline_policies_v1_keyauth_proto_goTypes = nil
	file_frontline_policies_v1_keyauth_proto_depIdxs = nil
}
