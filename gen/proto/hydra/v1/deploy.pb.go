...
type GitSource struct {
	...
	// SCM provider: "github" (default when empty) or "gitlab". Selects the clone
	// host and how clone credentials are obtained. For gitlab, installation_id
	// holds the GitLab project id.
...
func (x *GitSource) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
const file_hydra_v1_deploy_proto_rawDesc = "" +
	...
	"\x05image\x18\x01 \x01(\tR\x05image\"\xde\x02\n" +
	"\tGitSource\x12'\n" +
	...
	"\rbuild_command\x18\t \x01(\tR\fbuildCommand\x12\x1a\n" +
	"\bprovider\x18\n" +
	" \x01(\tR\bprovider\"\xf2\x01\n" +
	"\rDeployRequest\x12#\n" +
