CREATE TABLE `portal_sessions` (
	...
	`exchange_code_hash` varchar(44) COLLATE utf8mb4_0900_as_cs,
	`exchange_code_expires_at` bigint NOT NULL,
	`access_token_hash` varchar(44) COLLATE utf8mb4_0900_as_cs,
	...
	CONSTRAINT `exchange_code_hash_idx` UNIQUE(`exchange_code_hash`),
	CONSTRAINT `access_token_hash_idx` UNIQUE(`access_token_hash`)
);
