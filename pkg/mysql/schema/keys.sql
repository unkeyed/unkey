CREATE TABLE `keys` (
	...
	`start` varchar(256) COLLATE utf8mb4_0900_as_cs NOT NULL,
	`workspace_id` varchar(256) COLLATE utf8mb4_0900_as_cs NOT NULL,
	`for_workspace_id` varchar(256) COLLATE utf8mb4_0900_as_cs,
	...
	`environment` varchar(256) COLLATE utf8mb4_0900_as_cs,
	`last_used_at` bigint unsigned NOT NULL DEFAULT 0,
	`pending_migration_id` varchar(256) COLLATE utf8mb4_0900_as_cs,
