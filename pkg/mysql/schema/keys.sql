CREATE TABLE `keys` (
	...
	`key_auth_id` varchar(37) COLLATE utf8mb4_0900_as_cs NOT NULL,
	...
	`for_workspace_id` varchar(36) COLLATE utf8mb4_0900_as_cs,
	`name` varchar(256),
	`owner_id` varchar(256) COLLATE utf8mb4_0900_as_cs,
	`identity_id` varchar(36) COLLATE utf8mb4_0900_as_cs,
	`meta` text,
	`expires` datetime(3),
	...
	`pending_migration_id` varchar(36) COLLATE utf8mb4_0900_as_cs,
