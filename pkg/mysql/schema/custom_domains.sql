CREATE TABLE `custom_domains` (
	...
	`domain` varchar(256) COLLATE utf8mb4_0900_as_cs NOT NULL,
	...
	`target_cname` varchar(256) COLLATE utf8mb4_0900_as_cs NOT NULL,
	`last_checked_at` bigint,
	`check_attempts` int NOT NULL DEFAULT 0,
	`verification_error` varchar(512) COLLATE utf8mb4_0900_as_cs,
	`domain_connect_provider` varchar(256) COLLATE utf8mb4_0900_as_cs,
	`domain_connect_url` varchar(2048) COLLATE utf8mb4_0900_as_cs,
