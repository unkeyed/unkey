...
func (r *Runner) RegisterHealth(mux *http.ServeMux) {
	mux.HandleFunc("GET /health/live", r.handleLive)
	mux.HandleFunc("GET /health/ready", r.handleReady)
	mux.HandleFunc("GET /health/startup", r.handleStartup)
}
