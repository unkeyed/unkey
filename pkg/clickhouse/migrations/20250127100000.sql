...
PRIMARY KEY (`workspace_id`, `key_space_id`, `key_id`, `time`) ORDER BY (`workspace_id`, `key_space_id`, `key_id`, `time`) TTL toDateTime(fromUnixTimestamp64Milli(time)) + toIntervalDay(90) SETTINGS index_granularity = 8192;
