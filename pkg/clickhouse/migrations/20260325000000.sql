...
CREATE TABLE IF NOT EXISTS default.container_resource_snapshots_v1
(
    `time` DateTime,
    `workspace_id` String,
    `project_id` String,
...
SELECT
    ...
    workspace_id, project_id, app_id, environment_id, deployment_id, instance_id,
...
FROM default.container_resource_snapshots_v1
GROUP BY time, workspace_id, project_id, app_id, environment_id, deployment_id, instance_id;
