-- Create "keys_last_used_v2" table with AggregatingMergeTree for pre-aggregated data
...
-- Create "keys_last_used_mv_v2" materialized view that pre-aggregates per key
