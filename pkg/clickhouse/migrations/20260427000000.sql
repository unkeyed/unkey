...
(
    ...
    -- the schema stable as we add new context fields without ALTER. ctrl
    -- serializes the proto map<string,string> into a JSON string before
    -- insert; an empty map becomes "{}", which the column parses.
