-- Per-month rollup of instance_checkpoints_v1 (DASHBOARDS ONLY).
--
...
-- the long retention here is for long-range trend dashboards and audit
-- read-out, not for invoice math.
--
