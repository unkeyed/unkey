...
func TestResourceCatalogHelpers(t *testing.T) {
	...
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/keyspaces/ks_123", workspace.Project("proj_123").Keyspace("ks_123").String())
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/keyspaces/ks_123/keys/key_123", workspace.Project("proj_123").Keyspace("ks_123").Key("key_123").String())
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/ratelimits/namespaces/ns_123", workspace.Project("proj_123").RatelimitNamespace("ns_123").String())
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/ratelimits/namespaces/ns_123/overrides/ov_123", workspace.Project("proj_123").RatelimitNamespace("ns_123").Override("ov_123").String())
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/rbac/roles/role_123", workspace.Project("proj_123").RBAC().Role("role_123").String())
	require.Equal(t, "unkey:v1:ws_123:projects/proj_123/rbac/permissions/perm_123", workspace.Project("proj_123").RBAC().Permission("perm_123").String())
