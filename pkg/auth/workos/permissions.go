...
var permissionMappings = map[string]permissionMapping{
	...
	"deployments:start": {
		...
		permissions: []permissionGrant{
			{resource: "projects/*/apps/*/environments/*", action: action(rbacpermissions.StartDeployment{})},
		},
	},
	"deployments:rollback": {
		...
		permissions: []permissionGrant{
			{resource: "projects/*/apps/*/environments/*", action: action(rbacpermissions.RollbackDeployment{})},
		},
	},
	"deployments:create": {
		...
		permissions: []permissionGrant{
			{resource: "projects/*/apps/*/environments/*", action: action(rbacpermissions.CreateDeployment{})},
		},
	},
	"deployments:promote": {
		...
		permissions: []permissionGrant{
			{resource: "projects/*/apps/*/environments/*", action: action(rbacpermissions.PromoteDeployment{})},
		},
	},
	"identities:create": {
