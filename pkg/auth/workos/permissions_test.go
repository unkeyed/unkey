...
func TestTranslatePermissions(t *testing.T) {
	...
	require.Equal(t, []string{
		...
		"unkey:v1:ws_123:projects/*/keyspaces/**#encrypt_key",
...
func TestTranslatePermissionsKnownMappings(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "key encrypt",
			in:   "keys:encrypt",
			want: "unkey:v1:ws_123:projects/*/keyspaces/**#encrypt_key",
		},
		{
		...
		},
		{
			...
			want: "unkey:v1:ws_123:projects/*/apps/*/environments/*/deployments/*#rollback_deployment",
		},
		{
