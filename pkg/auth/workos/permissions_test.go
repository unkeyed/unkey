...
func TestTranslatePermissions(t *testing.T) {
	...
	require.Equal(t, []string{
		...
		"unkey:v1:ws_123:projects/*/keyspaces/*/keys/*#encrypt_key",
		"unkey:v1:ws_123:projects/*/keyspaces/*/keys/*#delete_key",
		"unkey:v1:ws_123:projects/*#create_identity",
...
func TestTranslatePermissionsKnownMappings(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "key encrypt",
			in:   "keys:encrypt",
			want: "unkey:v1:ws_123:projects/*/keyspaces/*/keys/*#encrypt_key",
		},
		{
			name: "key read",
			in:   "keys:read",
		...
		},
		{
			name: "key update",
			in:   "keys:update",
			want: "unkey:v1:ws_123:projects/*/keyspaces/*/keys/*#update_key",
		},
		{
			name: "key verify",
			in:   "keys:verify",
		...
		},
		{
			...
			want: "unkey:v1:ws_123:projects/*#create_identity",
		},
		{
			name: "identity read",
			in:   "identities:read",
