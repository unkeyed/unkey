...
type Querier interface {
	...
	//
	//  SELECT
	//      a.pk, a.id, a.workspace_id, a.project_id, a.environment_id, a.name, a.slug, a.live_deployment_id, a.depot_project_id, a.delete_protection, a.created_at, a.updated_at,
