...
type BulkQuerier interface {
	...
	StripeConnectedAccountInsert(ctx context.Context, db DBTX, args []StripeConnectedAccountInsertParams) error
	PricingModelInsert(ctx context.Context, db DBTX, args []PricingModelInsertParams) error
	BillingEndUserInsert(ctx context.Context, db DBTX, args []BillingEndUserInsertParams) error
	BillingInvoiceInsert(ctx context.Context, db DBTX, args []BillingInvoiceInsertParams) error
	BillingTransactionInsert(ctx context.Context, db DBTX, args []BillingTransactionInsertParams) error
