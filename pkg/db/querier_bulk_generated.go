...
type BulkQuerier interface {
	...
	InsertSentinelSubscriptions(ctx context.Context, db DBTX, args []InsertSentinelSubscriptionParams) error
	InsertSentinelTiers(ctx context.Context, db DBTX, args []InsertSentinelTierParams) error
