...
const bulkInsertPortalConfig = `INSERT INTO portal_configurations ( id, workspace_id, slug, display_name, app_id, key_auth_id, enabled, return_url, created_at, updated_at ) VALUES %s`
