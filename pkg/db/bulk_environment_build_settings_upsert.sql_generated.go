...
const bulkUpsertEnvironmentBuildSettings = `INSERT INTO environment_build_settings ( id, workspace_id, environment_id, dockerfile, docker_context, created_at ) VALUES %s ON DUPLICATE KEY UPDATE
