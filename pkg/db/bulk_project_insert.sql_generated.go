...
const bulkInsertProject = `INSERT INTO projects ( id, workspace_id, name, slug, git_repository_url, default_branch, cname_target, delete_protection, created_at, updated_at ) VALUES %s`
...
func (q *BulkQueries) InsertProjects(ctx context.Context, db DBTX, args []InsertProjectParams) error {
	...
	for _, arg := range args {
		...
		allArgs = append(allArgs, arg.CnameTarget)
