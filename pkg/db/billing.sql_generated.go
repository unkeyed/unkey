...
SELECT id, workspace_id, end_user_id, stripe_invoice_id, billing_period_start, billing_period_end, verification_count, ratelimit_count, total_amount, currency, status, created_at_m, updated_at_m, deleted_at_m FROM billing_invoices
WHERE id = ?
LIMIT 1
`
...
SELECT id, workspace_id, name, currency, verification_unit_price, ratelimit_unit_price, tiered_pricing, version, active, created_at_m, updated_at_m, deleted_at_m FROM pricing_models
WHERE id = ? AND deleted_at_m IS NULL
LIMIT 1
`
