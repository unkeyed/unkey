...
const bulkInsertPortal = `INSERT INTO portals ( id, workspace_id, slug, app_id, keyspace_id, enabled, return_url, logo_url, primary_color, created_at, updated_at ) VALUES %s`
