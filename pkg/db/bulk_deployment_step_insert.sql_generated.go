...
const bulkInsertDeploymentStep = `INSERT INTO ` + "`" + `deployment_steps` + "`" + ` ( workspace_id, project_id, environment_id, deployment_id, step, started_at ) VALUES %s ON DUPLICATE KEY UPDATE
