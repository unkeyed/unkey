...
const bulkUpsertInstance = `INSERT INTO instances ( id, deployment_id, workspace_id, project_id, app_id, region_id, k8s_name, address, cpu_millicores, memory_mib, status ) VALUES %s ON DUPLICATE KEY UPDATE
	address = ?,
	cpu_millicores = ?,
	memory_mib = ?,
	status = ?`
