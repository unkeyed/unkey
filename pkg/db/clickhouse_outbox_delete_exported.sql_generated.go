...
//	WHERE deleted_at < ?
//	LIMIT ?
func (q *Queries) DeleteExportedClickhouseOutbox(ctx context.Context, db DBTX, arg DeleteExportedClickhouseOutboxParams) (int64, error) {
	result, err := db.ExecContext(ctx, deleteExportedClickhouseOutbox, arg.Cutoff, arg.Limit)
	if err != nil {
		return 0, err
	}
