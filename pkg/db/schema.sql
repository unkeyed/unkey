...
CREATE INDEX `idx_desired_state_region` ON `sentinels` (`desired_state`,`region`);
CREATE INDEX `idx_region` ON `instances` (`region`);
CREATE INDEX `idx_deployment_status_region` ON `instances` (`deployment_id`,`status`,`region`);
