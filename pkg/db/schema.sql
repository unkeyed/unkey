...
CREATE TABLE `deployment_topology` (
	...
	`autoscaling_replicas_min` int NOT NULL DEFAULT 1,
	`autoscaling_replicas_max` int NOT NULL DEFAULT 1,
	`autoscaling_threshold_cpu` tinyint,
	`autoscaling_threshold_memory` tinyint,
