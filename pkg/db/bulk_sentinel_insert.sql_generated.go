...
const bulkInsertSentinel = `INSERT INTO sentinels ( id, workspace_id, environment_id, project_id, k8s_address, k8s_name, region_id, image, health, desired_replicas, available_replicas, cpu_millicores, memory_mib, version, created_at ) VALUES %s`
