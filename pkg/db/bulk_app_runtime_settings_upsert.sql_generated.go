...
const bulkUpsertAppRuntimeSettings = `INSERT INTO app_runtime_settings ( workspace_id, app_id, environment_id, port, command, healthcheck, shutdown_signal, sentinel_config, created_at, updated_at ) VALUES %s ON DUPLICATE KEY UPDATE
    port = VALUES(port),
