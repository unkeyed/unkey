...
//	)
//	ON DUPLICATE KEY UPDATE workspace_id = workspace_id
func (q *Queries) InsertWorkspaceBilling(ctx context.Context, db DBTX, arg InsertWorkspaceBillingParams) error {
	_, err := db.ExecContext(ctx, insertWorkspaceBilling, arg.WorkspaceID, arg.CreatedAt)
	return err
}
