...
const bulkInsertApp = `INSERT INTO apps ( id, workspace_id, project_id, environment_id, name, slug, live_deployment_id, depot_project_id, delete_protection, created_at, updated_at ) VALUES %s`
