...
func TestActions_BuildDataPermissions(t *testing.T) {
	...
	requirePermission(t, portal, permissions.Read, "unkey:v1:ws_123:projects/proj_123/portals/pc_123#read")
	requirePermission(t, portal, permissions.Write, "unkey:v1:ws_123:projects/proj_123/portals/pc_123#write")
	requirePermission(t, portal, permissions.Delete, "unkey:v1:ws_123:projects/proj_123/portals/pc_123#delete")
	requirePermission(t, portal.Session("ps_123"), permissions.Write, "unkey:v1:ws_123:projects/proj_123/portals/pc_123/sessions/ps_123#write")
