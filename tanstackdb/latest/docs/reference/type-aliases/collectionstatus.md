# CollectionStatus | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageType Alias: CollectionStatusExamples# CollectionStatus

Copy Markdown[Type Alias: CollectionStatus](#type-alias-collectionstatus)ts
...
```[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/type-aliases/collectionstatus.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
