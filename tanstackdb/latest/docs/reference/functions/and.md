...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageFunction: and()Call SignatureParametersleftrightReturnsCall SignatureParametersleftrightrestReturns# and

Copy Markdown[Function: and()](#function-and)[Call Signature](#call-signature)ts
...
BasicExpression<boolean>[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/functions/and.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
