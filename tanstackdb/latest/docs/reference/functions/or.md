...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageFunction: or()Call SignatureParametersleftrightReturnsCall SignatureParametersleftrightrestReturns# or

Copy Markdown[Function: or()](#function-or)[Call Signature](#call-signature)ts
...
BasicExpression<boolean>[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/functions/or.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
