# QueryCollectionError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: QueryCollectionErrorExtendsExtended byConstructorsnew QueryCollectionError()ParametersmessageReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# QueryCollectionError

Copy Markdown[Class: QueryCollectionError](#class-querycollectionerror)
...
[Constructors](#constructors)[new QueryCollectionError()](#new-querycollectionerror)ts
...
```[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/query-db-collection/classes/querycollectionerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
