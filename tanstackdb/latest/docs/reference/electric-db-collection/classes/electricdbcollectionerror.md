# ElectricDBCollectionError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: ElectricDBCollectionErrorExtendsExtended byConstructorsnew ElectricDBCollectionError()ParametersmessageReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# ElectricDBCollectionError

Copy Markdown[Class: ElectricDBCollectionError](#class-electricdbcollectionerror)
...
[Constructors](#constructors)[new ElectricDBCollectionError()](#new-electricdbcollectionerror)ts
...
```[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/electric-db-collection/classes/electricdbcollectionerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
