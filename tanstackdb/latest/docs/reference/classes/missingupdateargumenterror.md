# MissingUpdateArgumentError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: MissingUpdateArgumentErrorExtendsConstructorsnew MissingUpdateArgumentError()ReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# MissingUpdateArgumentError

Copy Markdown[Class: MissingUpdateArgumentError](#class-missingupdateargumenterror)
...
[Constructors](#constructors)[new MissingUpdateArgumentError()](#new-missingupdateargumenterror)ts
