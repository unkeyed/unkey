# UnsupportedJoinSourceTypeError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: UnsupportedJoinSourceTypeErrorExtendsConstructorsnew UnsupportedJoinSourceTypeError()ParameterstypeReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# UnsupportedJoinSourceTypeError

Copy Markdown[Class: UnsupportedJoinSourceTypeError](#class-unsupportedjoinsourcetypeerror)
...
[Constructors](#constructors)[new UnsupportedJoinSourceTypeError()](#new-unsupportedjoinsourcetypeerror)ts
...
[JoinError](/db/latest/docs/reference/classes/joinerror).[captureStackTrace](/db/latest/docs/reference/classes/JoinError#capturestacktrace)[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/unsupportedjoinsourcetypeerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
