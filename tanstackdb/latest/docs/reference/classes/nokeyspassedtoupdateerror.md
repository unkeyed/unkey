# NoKeysPassedToUpdateError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: NoKeysPassedToUpdateErrorExtendsConstructorsnew NoKeysPassedToUpdateError()ReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# NoKeysPassedToUpdateError

Copy Markdown[Class: NoKeysPassedToUpdateError](#class-nokeyspassedtoupdateerror)
...
[Constructors](#constructors)[new NoKeysPassedToUpdateError()](#new-nokeyspassedtoupdateerror)ts
