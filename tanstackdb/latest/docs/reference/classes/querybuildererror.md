# QueryBuilderError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: QueryBuilderErrorExtendsExtended byConstructorsnew QueryBuilderError()ParametersmessageReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# QueryBuilderError

Copy Markdown[Class: QueryBuilderError](#class-querybuildererror)
...
[Constructors](#constructors)[new QueryBuilderError()](#new-querybuildererror)ts
...
[TanStackDBError](/db/latest/docs/reference/classes/tanstackdberror).[captureStackTrace](/db/latest/docs/reference/classes/TanStackDBError#capturestacktrace)[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/querybuildererror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
