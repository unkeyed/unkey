# UndefinedKeyError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: UndefinedKeyErrorExtendsConstructorsnew UndefinedKeyError()ParametersitemReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# UndefinedKeyError

Copy Markdown[Class: UndefinedKeyError](#class-undefinedkeyerror)
...
[Constructors](#constructors)[new UndefinedKeyError()](#new-undefinedkeyerror)ts
