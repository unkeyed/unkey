# NoPendingSyncTransactionCommitError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: NoPendingSyncTransactionCommitErrorExtendsConstructorsnew NoPendingSyncTransactionCommitError()ReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# NoPendingSyncTransactionCommitError

Copy Markdown[Class: NoPendingSyncTransactionCommitError](#class-nopendingsynctransactioncommiterror)
...
[Constructors](#constructors)[new NoPendingSyncTransactionCommitError()](#new-nopendingsynctransactioncommiterror)ts
