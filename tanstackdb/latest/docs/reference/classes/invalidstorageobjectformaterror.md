# InvalidStorageObjectFormatError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: InvalidStorageObjectFormatErrorExtendsConstructorsnew InvalidStorageObjectFormatError()ParametersstorageKeyReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# InvalidStorageObjectFormatError

Copy Markdown[Class: InvalidStorageObjectFormatError](#class-invalidstorageobjectformaterror)
...
[Constructors](#constructors)[new InvalidStorageObjectFormatError()](#new-invalidstorageobjectformaterror)ts
