# DuplicateKeySyncError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: DuplicateKeySyncErrorExtendsConstructorsnew DuplicateKeySyncError()ParameterskeycollectionIdReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# DuplicateKeySyncError

Copy Markdown[Class: DuplicateKeySyncError](#class-duplicatekeysyncerror)
...
[Constructors](#constructors)[new DuplicateKeySyncError()](#new-duplicatekeysyncerror)ts
