# DuplicateKeyError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: DuplicateKeyErrorExtendsConstructorsnew DuplicateKeyError()ParameterskeyReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# DuplicateKeyError

Copy Markdown[Class: DuplicateKeyError](#class-duplicatekeyerror)
...
[Constructors](#constructors)[new DuplicateKeyError()](#new-duplicatekeyerror)ts
