# NonAggregateExpressionNotInGroupByError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: NonAggregateExpressionNotInGroupByErrorExtendsConstructorsnew NonAggregateExpressionNotInGroupByError()ParametersaliasReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# NonAggregateExpressionNotInGroupByError

Copy Markdown[Class: NonAggregateExpressionNotInGroupByError](#class-nonaggregateexpressionnotingroupbyerror)
...
[Constructors](#constructors)[new NonAggregateExpressionNotInGroupByError()](#new-nonaggregateexpressionnotingroupbyerror)ts
...
[Parameters](#parameters)[alias](#alias)
