# SchemaValidationError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: SchemaValidationErrorExtendsConstructorsnew SchemaValidationError()Parameterstypeissuesmessage?ReturnsOverridesPropertiescause?Inherited fromissuesmessageInherited fromnameInherited fromstack?Inherited fromtypeprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# SchemaValidationError

Copy Markdown[Class: SchemaValidationError](#class-schemavalidationerror)
...
[Constructors](#constructors)[new SchemaValidationError()](#new-schemavalidationerror)ts
...
[TanStackDBError](/db/latest/docs/reference/classes/tanstackdberror).[captureStackTrace](/db/latest/docs/reference/classes/TanStackDBError#capturestacktrace)[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/schemavalidationerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
