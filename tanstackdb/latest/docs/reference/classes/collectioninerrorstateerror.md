# CollectionInErrorStateError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: CollectionInErrorStateErrorExtendsConstructorsnew CollectionInErrorStateError()ParametersoperationcollectionIdReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# CollectionInErrorStateError

Copy Markdown[Class: CollectionInErrorStateError](#class-collectioninerrorstateerror)
...
[Constructors](#constructors)[new CollectionInErrorStateError()](#new-collectioninerrorstateerror)ts
