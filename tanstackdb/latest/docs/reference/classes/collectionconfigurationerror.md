# CollectionConfigurationError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: CollectionConfigurationErrorExtendsExtended byConstructorsnew CollectionConfigurationError()ParametersmessageReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# CollectionConfigurationError

Copy Markdown[Class: CollectionConfigurationError](#class-collectionconfigurationerror)
...
[Constructors](#constructors)[new CollectionConfigurationError()](#new-collectionconfigurationerror)ts
