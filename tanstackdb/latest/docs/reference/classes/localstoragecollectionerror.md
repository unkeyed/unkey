# LocalStorageCollectionError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: LocalStorageCollectionErrorExtendsExtended byConstructorsnew LocalStorageCollectionError()ParametersmessageReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# LocalStorageCollectionError

Copy Markdown[Class: LocalStorageCollectionError](#class-localstoragecollectionerror)
...
[Constructors](#constructors)[new LocalStorageCollectionError()](#new-localstoragecollectionerror)ts
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[constructor](/db/latest/docs/reference/classes/StorageError#constructors)
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[cause](/db/latest/docs/reference/classes/StorageError#cause)
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[message](/db/latest/docs/reference/classes/StorageError#message-1)
[name](#name)ts
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[name](/db/latest/docs/reference/classes/StorageError#name)
[stack?](#stack)ts
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[stack](/db/latest/docs/reference/classes/StorageError#stack)
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[prepareStackTrace](/db/latest/docs/reference/classes/StorageError#preparestacktrace)
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[stackTraceLimit](/db/latest/docs/reference/classes/StorageError#stacktracelimit)
...
[StorageError](/db/latest/docs/reference/classes/storageerror).[captureStackTrace](/db/latest/docs/reference/classes/StorageError#capturestacktrace)[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/localstoragecollectionerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
