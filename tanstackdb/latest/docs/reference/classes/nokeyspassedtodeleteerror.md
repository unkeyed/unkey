# NoKeysPassedToDeleteError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: NoKeysPassedToDeleteErrorExtendsConstructorsnew NoKeysPassedToDeleteError()ReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# NoKeysPassedToDeleteError

Copy Markdown[Class: NoKeysPassedToDeleteError](#class-nokeyspassedtodeleteerror)
...
[Constructors](#constructors)[new NoKeysPassedToDeleteError()](#new-nokeyspassedtodeleteerror)ts
