# TanStackDBError | TanStack DB Docs
...
[Constructors](#constructors)[new TanStackDBError()](#new-tanstackdberror)ts
...
[Inherited from](#inherited-from-3)ts
...
[Inherited from](#inherited-from-4)ts
...
[Inherited from](#inherited-from-5)ts
...
void
[Inherited from](#inherited-from-6)ts
...
```[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/tanstackdberror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
