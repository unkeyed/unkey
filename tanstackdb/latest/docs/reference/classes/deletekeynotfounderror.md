# DeleteKeyNotFoundError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: DeleteKeyNotFoundErrorExtendsConstructorsnew DeleteKeyNotFoundError()ParameterskeyReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# DeleteKeyNotFoundError

Copy Markdown[Class: DeleteKeyNotFoundError](#class-deletekeynotfounderror)
...
[Constructors](#constructors)[new DeleteKeyNotFoundError()](#new-deletekeynotfounderror)ts
