# UnknownHavingExpressionTypeError | TanStack DB Docs
...
- [useLiveQueryreact](/db/latest/docs/framework/react/reference/functions/uselivequery)On this pageClass: UnknownHavingExpressionTypeErrorExtendsConstructorsnew UnknownHavingExpressionTypeError()ParameterstypeReturnsOverridesPropertiescause?Inherited frommessageInherited fromnameInherited fromstack?Inherited fromprepareStackTrace()?ParameterserrstackTracesReturnsSeeInherited fromstackTraceLimitInherited fromMethodscaptureStackTrace()ParameterstargetObjectconstructorOpt?ReturnsInherited from# UnknownHavingExpressionTypeError

Copy Markdown[Class: UnknownHavingExpressionTypeError](#class-unknownhavingexpressiontypeerror)
...
[Constructors](#constructors)[new UnknownHavingExpressionTypeError()](#new-unknownhavingexpressiontypeerror)ts
...
[GroupByError](/db/latest/docs/reference/classes/groupbyerror).[captureStackTrace](/db/latest/docs/reference/classes/GroupByError#capturestacktrace)[Edit on GitHub](https://github.com/tanstack/db/edit/main/docs/reference/classes/unknownhavingexpressiontypeerror.md)[Home](/db/latest)Our Partners###### Subscribe to Bytes
